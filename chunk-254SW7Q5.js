...
var ce = new B("cdk-input-modality-detector-options"), ae = { ignoreKeys: [18, 17, 224, 91, 16] }, H = 650, v = { passive: !0, capture: !0 }, ue = (() => {
    class n {
        _platform = u(d);
        _listenerCleanups;
        modalityDetected;
        ...
        constructor() {
            let e = u(j), t = u(P), o = u(ce, { optional: !0 });
            if (this._options = g(g({}, ae), o), this.modalityDetected = this._modality.pipe(ie(1)), this.modalityChanged = this.modalityDetected.pipe(se()), this._platform.isBrowser) {
    ...
    return n;
})(), b = (function (n) { return n[n.IMMEDIATE = 0] = "IMMEDIATE", n[n.EVENTUAL = 1] = "EVENTUAL", n; })(b || {}), le = new B("cdk-focus-monitor-default-options"), p = D({ passive: !0, capture: !0 }), de = (() => {
    class n {
        _ngZone = u(j);
        _platform = u(d);
        ...
        monitor(e, t = !1) {
            ...
            if (!this._platform.isBrowser || o.nodeType !== 1)
                return L();
            let s = N(o) || this._document, r = this._elementInfo.get(o);
            if (r)
                return t && (r.checkChildren = !0), r.subject;
            let l = { checkChildren: t, subject: new T, rootNode: s };
        ...
        _isLastInteractionFromInputLabel(e) {
            ...
            if (o !== "mouse" || !t || t === e || e.nodeName !== "INPUT" && e.nodeName !== "TEXTAREA" || e.disabled)
                return !1;
            let s = e.labels;
            if (s) {
    ...
    class n {
        ...
        isTabbable(e) {
            if (!this._platform.isBrowser)
                return !1;
            let t = me(Ce(e));
            if (t && (U(t) === -1 || !this.isVisible(t)))
                return !1;
            let o = e.nodeName.toLowerCase(), s = U(e);
            return e.hasAttribute("contenteditable") ? s !== -1 : o === "iframe" || o === "object" || this._platform.WEBKIT && this._platform.IOS && !ve(e) ? !1 : o === "audio" ? e.hasAttribute("controls") ? s !== -1 : !1 : o === "video" ? s === -1 ? !1 : s !== null ? !0 : this._platform.FIREFOX || e.hasAttribute("controls") : e.tabIndex >= 0;
        }
...
function q(n) {
    if (!n.hasAttribute("tabindex") || n.tabIndex === void 0)
        return !1;
...
var C = class {
    ...
    return n;
})(), Fe = new G("liveAnnouncerElement", { providedIn: "root", factory: we });
function we() { return null; }
var Le = new G("LIVE_ANNOUNCER_DEFAULT_OPTIONS"), ke = 0, Oe = (() => {
    class n {
        _ngZone = c(I);
        ...
        _createLiveElement() {
            let e = "cdk-live-announcer-element", t = this._document.getElementsByClassName(e), o = this._document.createElement("div");
            for (let s = 0; s < t.length; s++)
                t[s].remove();
            return o.classList.add(e), o.classList.add("cdk-visually-hidden"), o.setAttribute("aria-atomic", "true"), o.setAttribute("aria-live", "polite"), o.id = `cdk-live-announcer-${ke++}`, this._document.body.appendChild(o), o;
        }
    ...
    return n;
})(), h = (function (n) { return n[n.NONE = 0] = "NONE", n[n.BLACK_ON_WHITE = 1] = "BLACK_ON_WHITE", n[n.WHITE_ON_BLACK = 2] = "WHITE_ON_BLACK", n; })(h || {}), K = "cdk-high-contrast-black-on-white", Z = "cdk-high-contrast-white-on-black", y = "cdk-high-contrast-active", Ne = (() => {
    class n {
        _platform = c(d);
        ...
        getHighContrastMode() {
            ...
            let t = this._document.defaultView || window, o = t && t.getComputedStyle ? t.getComputedStyle(e) : null, s = (o && o.backgroundColor || "").replace(/ /g, "");
            switch (e.remove(), s) {
                case "rgb(0,0,0)":
                case "rgb(45,50,54)":
