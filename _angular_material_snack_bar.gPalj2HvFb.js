import { d as g, l as A } from "@nf-internal/chunk-MYXIVZKR";
...
import { i as l, w as y } from "@nf-internal/chunk-IR6MR6UK";
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class i extends L {
        ...
        _exposeToModals() {
            let t = this._liveElementId, e = this._document.querySelectorAll('body > .cdk-overlay-container [aria-modal="true"]');
        ...
        _screenReaderAnnounce() {
            this._announceTimeoutId || this._ngZone.runOutsideAngular(() => {
                this._announceTimeoutId = setTimeout(() => {
                    if (this._destroyed)
                        return;
                    let t = this._elementRef.nativeElement, e = t.querySelector("[aria-hidden]"), a = t.querySelector("[aria-live]");
                    if (e && a) {
                        let s = null;
        ...
        static \u0275fac = function (e) { return new (e || i); };
        static \u0275cmp = n.\u0275\u0275defineComponent({ type: i, selectors: [["mat-snack-bar-container"]], viewQuery: function (e, a) {
                if (e & 1 && (n.\u0275\u0275viewQuery(S, 7), n.\u0275\u0275viewQuery(G, 7)), e & 2) {
                    let s;
...
var it = new C("mat-snack-bar-default-options", { providedIn: "root", factory: at }), st = (() => {
    class i {
        _live = r(F);
        _injector = r(f);
        ...
        _attach(t, e) {
            let a = d(d(d({}, new u), this._defaultConfig), e), s = this._createOverlay(a), o = this._attachSnackBarContainer(s, a), c = new p(o, s);
            if (t instanceof P) {
