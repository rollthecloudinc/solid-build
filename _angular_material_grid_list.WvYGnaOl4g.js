...
var d = class {
    ...
    _nextRow() {
        ...
        for (let e = 0; e < this.tracker.length; e++)
            this.tracker[e] = Math.max(0, this.tracker[e] - 1);
    }
    _findGapEndIndex(e) {
        for (let t = e + 1; t < this.tracker.length; t++)
            if (this.tracker[t] != 0)
                return t;
        return this.tracker.length;
    }
    _markTilePosition(e, t) {
        for (let i = 0; i < t.colspan; i++)
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class r {
        ...
        static \u0275fac = function (i) { return new (i || r); };
        static \u0275cmp = o.\u0275\u0275defineComponent({ type: r, selectors: [["mat-grid-tile-header"], ["mat-grid-tile-footer"]], contentQueries: function (i, n, s) {
                if (i & 1 && o.\u0275\u0275contentQuery(s, v, 5), i & 2) {
                    let a;
...
var $ = "fit", et = (() => {
    class r {
        ...
        static \u0275fac = function (i) { return new (i || r); };
        static \u0275cmp = o.\u0275\u0275defineComponent({ type: r, selectors: [["mat-grid-list"]], contentQueries: function (i, n, s) {
                if (i & 1 && o.\u0275\u0275contentQuery(s, E, 5), i & 2) {
                    let a;
