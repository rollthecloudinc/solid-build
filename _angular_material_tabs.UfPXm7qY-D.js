import { e as j, f as y } from "@nf-internal/chunk-U56RZWEM";
...
import { g as T } from "@nf-internal/chunk-C2A5IV4Z";
import { I as W, b as h, d as N, i as g, j as O, n as Q, w as z } from "@nf-internal/chunk-IR6MR6UK";
...
var Qt = ["mat-tab-nav-bar", ""], zt = ["mat-tab-link", ""], Wt = new _("MatTabContent"), jt = (() => {
    class r {
        template = s(B);
        constructor() { }
    ...
    return r;
})(), Gt = new _("MatTabLabel"), st = new _("MAT_TAB"), $t = (() => {
    class r extends Rt {
    ...
    class r {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-tab"]], contentQueries: function (a, i, n) {
                if (a & 1 && (t.\u0275\u0275contentQuery(n, $t, 5), t.\u0275\u0275contentQuery(n, jt, 7, B)), a & 2) {
                    let o;
    ...
    return r;
})(), M = "mdc-tab-indicator--active", G = "mdc-tab-indicator--no-transition", x = class {
    _items;
    _currentItem;
    constructor(d) { this._items = d; }
    hide() { this._items.forEach(d => d.deactivateInkBar()), this._currentItem = void 0; }
    alignToElement(d) {
        let e = this._items.find(i => i.elementRef.nativeElement === d), a = this._currentItem;
        if (e !== a && (a?.deactivateInkBar(), e)) {
    ...
    class r {
        ...
        activateInkBar(e) {
            ...
            if (!e || !a.getBoundingClientRect || !this._inkBarContentElement) {
                a.classList.add(M);
                return;
            }
            let i = a.getBoundingClientRect(), n = e.width / i.width, o = e.left - i.left;
            a.classList.add(G), this._inkBarContentElement.style.setProperty("transform", `translateX(${o}px) scaleX(${n})`), a.getBoundingClientRect(), a.classList.remove(G), a.classList.add(M), this._inkBarContentElement.style.setProperty("transform", "");
        }
...
var Pe = new _("MatInkBarPositioner", { providedIn: "root", factory: Zt }), ct = (() => {
    class r extends dt {
        elementRef = s(u);
        disabled = !1;
    ...
    class r {
        ...
        _updateTabScrollPosition() {
            if (this.disablePagination)
                return;
            let e = this.scrollDistance, a = this._getLayoutDirection() === "ltr" ? -e : e;
        ...
        _scrollToLabel(e) {
            if (this.disablePagination)
                return;
            let a = this._items ? this._items.toArray()[e] : null;
            if (!a)
                return;
            let i = this._tabListContainer.nativeElement.offsetWidth, { offsetLeft: n, offsetWidth: o } = a.elementRef.nativeElement, l, b;
            this._getLayoutDirection() == "ltr" ? (l = n, b = l + o) : (b = this._tabListInner.nativeElement.offsetWidth - n, l = b - o);
            let I = this.scrollDistance, V = this.scrollDistance + i;
            l < I ? this.scrollDistance -= I - l : b > V && (this.scrollDistance += Math.min(b - V, l - I));
        }
        ...
        _scrollTo(e) {
            ...
            let a = this._getMaxScrollDistance();
            return this._scrollDistance = Math.max(0, Math.min(a, e)), this._scrollDistanceChanged = !0, this._checkScrollingControls(), { maxScrollDistance: a, distance: this._scrollDistance };
        }
        static \u0275fac = function (a) { return new (a || r); };
    ...
    class r extends mt {
        ...
        static \u0275fac = (() => { let e; return function (i) { return (e || (e = t.\u0275\u0275getInheritedFactory(r)))(i || r); }; })();
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-tab-header"]], contentQueries: function (a, i, n) {
                if (a & 1 && t.\u0275\u0275contentQuery(n, ct, 4), a & 2) {
                    let o;
                    t.\u0275\u0275queryRefresh(o = t.\u0275\u0275loadQuery()) && (i._items = o);
                }
            }, viewQuery: function (a, i) {
                if (a & 1 && (t.\u0275\u0275viewQuery(at, 7), t.\u0275\u0275viewQuery(it, 7), t.\u0275\u0275viewQuery(nt, 7), t.\u0275\u0275viewQuery(rt, 5), t.\u0275\u0275viewQuery(ot, 5)), a & 2) {
                    let n;
...
`], encapsulation: 2 });
    ...
    class r {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-tab-body"]], viewQuery: function (a, i) {
                if (a & 1 && (t.\u0275\u0275viewQuery(q, 5), t.\u0275\u0275viewQuery(Bt, 5)), a & 2) {
                    let n;
...
`], encapsulation: 2 });
    ...
    class r {
        ...
        _setTabBodyWrapperHeight(e) {
            ...
            a.style.height = this._tabBodyWrapperHeight + "px", this._tabBodyWrapper.nativeElement.offsetHeight && (a.style.height = e + "px");
        }
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-tab-group"]], contentQueries: function (a, i, n) {
                if (a & 1 && t.\u0275\u0275contentQuery(n, qt, 5), a & 2) {
                    let o;
                    t.\u0275\u0275queryRefresh(o = t.\u0275\u0275loadQuery()) && (i._allTabs = o);
                }
            }, viewQuery: function (a, i) {
                if (a & 1 && (t.\u0275\u0275viewQuery(Et, 5), t.\u0275\u0275viewQuery(St, 5), t.\u0275\u0275viewQuery(S, 5)), a & 2) {
                    let n;
...
`], encapsulation: 2 });
    ...
    class r extends mt {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["", "mat-tab-nav-bar", ""]], contentQueries: function (a, i, n) {
                if (a & 1 && t.\u0275\u0275contentQuery(n, Jt, 5), a & 2) {
                    let o;
                    t.\u0275\u0275queryRefresh(o = t.\u0275\u0275loadQuery()) && (i._items = o);
                }
            }, viewQuery: function (a, i) {
