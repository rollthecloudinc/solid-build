import { a as l, b as Q } from "@nf-internal/chunk-IDSRJFMW";
import { b as W, c as ee, d as v, e as te } from "@nf-internal/chunk-EMAF5KOL";
import "@nf-internal/chunk-XUYTQVBT";
import { a as k, b as L, c as x, d as P, e as Y, f as j, g as K, h as w, i as M, j as R, k as B, l as U, m as $, n as G, o as V, p as H, q as Z, r as q, s as X, t as z } from "@nf-internal/chunk-254SW7Q5";
import "@nf-internal/chunk-7I4L2ICP";
import "@nf-internal/chunk-W3ECCJWG";
...
import { i as p } from "@nf-internal/chunk-IR6MR6UK";
...
var Re = "cdk-describedby-message-container", O = "cdk-describedby-message", c = "cdk-describedby-host", f = 0, ve = (() => {
    class r {
        _platform = o(y);
        _document = o(T);
        ...
        describe(t, e, s) {
            if (!this._canBeDescribed(t, e))
                return;
            let n = u(e, s);
            typeof e != "string" ? (A(e, this._id), this._messageRegistry.set(n, { messageElement: e, referenceCount: 0 })) : this._messageRegistry.has(n) || this._createMessageElement(e, s), this._isElementDescribedByMessage(t, n) || this._addMessageReference(t, n);
        }
        removeDescription(t, e, s) {
            if (!e || !this._isElementNode(t))
                return;
            let n = u(e, s);
            if (this._isElementDescribedByMessage(t, n) && this._removeMessageReference(t, n), typeof e == "string") {
        ...
        ngOnDestroy() {
            let t = this._document.querySelectorAll(`[${c}="${this._id}"]`);
            for (let e = 0; e < t.length; e++)
                this._removeCdkDescribedByReferenceIds(t[e]), t[e].removeAttribute(c);
        ...
        _createMessagesContainer() {
            if (this._messagesContainer)
                return;
            let t = "cdk-describedby-message-container", e = this._document.querySelectorAll(`.${t}[platform="server"]`);
        ...
        _canBeDescribed(t, e) {
            ...
            if (e && typeof e == "object")
                return !0;
            let s = e == null ? "" : `${e}`.trim(), n = t.getAttribute("aria-label");
...
}, de = new re("FOCUS_TRAP_INERT_STRATEGY"), _e = (() => {
    class r {
        _focusTrapStack = [];
