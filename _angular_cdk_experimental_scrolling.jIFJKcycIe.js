...
import { d as p } from "@nf-internal/chunk-IR6MR6UK";
...
var _ = class {
    ...
    addSample(e, r) {
        let t = this._totalWeight + e.end - e.start;
        if (t) {
    ...
    updateBufferSize(e, r) {
        ...
        this._minBufferPx = e, this._maxBufferPx = r;
    }
    _updateRenderedContentAfterScroll() {
        let e = this._viewport, r = e.measureScrollOffset(), t = r - this._lastScrollOffset, n = Math.abs(t), i = e.getRenderedRange(), o = 0;
        if (t < 0) {
        ...
        let m = this._lastScrollOffset - this._lastRenderedContentOffset, v = this._lastRenderedContentOffset + this._lastRenderedContentSize - (this._lastScrollOffset + e.getViewportSize()), S = n + this._minBufferPx - (t < 0 ? m : v);
        if (S > 0)
            ...
            o && e.setRenderedContentOffset(this._lastRenderedContentOffset + o);
        this._lastScrollOffset = r;
    }
