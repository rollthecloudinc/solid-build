...
import { f as N } from "@nf-internal/chunk-U56RZWEM";
...
import { g } from "@nf-internal/chunk-C2A5IV4Z";
import { b as _, i as c, w as D } from "@nf-internal/chunk-IR6MR6UK";
import { a as I, b as L } from "@nf-internal/chunk-6MDQTQU3";
...
var F = new y("MAT_MENU_PANEL"), O = (() => {
    class s {
        ...
        getLabel() {
            let e = this._elementRef.nativeElement.cloneNode(!0), t = e.querySelectorAll("mat-icon, .material-icons");
...
var K = new y("MatMenuContent"), _t = (() => {
    ...
    return s;
})(), Le = new y("mat-menu-default-options", { providedIn: "root", factory: Ne });
...
var S = "_mat-menu-enter", f = "_mat-menu-exit", b = (() => {
    class s {
        ...
        removeItem(e) { }
        _handleKeydown(e) {
            let t = e.keyCode, i = this._keyManager;
            switch (t) {
                case ce:
        ...
        focusFirstItem(e = "program") {
            this._firstItemFocusRef?.destroy(), this._firstItemFocusRef = ie(() => {
        ...
        _setIsOpen(e) {
            if (this._panelAnimationState = e ? "enter" : "void", e) {
                ...
                this._animationsDisabled || (this._exitFallbackTimeout = setTimeout(() => this._onAnimationDone(f), 200));
            this._animationsDisabled && setTimeout(() => { this._onAnimationDone(e ? S : f); }), this._changeDetectorRef.markForCheck();
        }
        ...
        static \u0275fac = function (t) { return new (t || s); };
        static \u0275cmp = n.\u0275\u0275defineComponent({ type: s, selectors: [["mat-menu"]], contentQueries: function (t, i, o) {
                if (t & 1 && (n.\u0275\u0275contentQuery(o, K, 5), n.\u0275\u0275contentQuery(o, O, 5), n.\u0275\u0275contentQuery(o, O, 4)), t & 2) {
                    let r;
...
var Ye = { provide: q, deps: [], useFactory: He }, gt = 8, m = new WeakMap, Z = (() => {
    class s {
        _canHaveBackdrop;
        _element = a(E);
        _viewContainerRef = a(z);
        ...
        _openMenu(e) {
            ...
            let i = m.get(t);
            m.set(t, this), i && i !== this && i._closeMenu();
            let o = this._createOverlay(t), r = o.getConfig(), l = r.positionStrategy;
        ...
        _setPosition(e, t) {
            let [i, o] = e.xPosition === "before" ? ["end", "start"] : ["start", "end"], [r, l] = e.yPosition === "above" ? ["bottom", "top"] : ["top", "bottom"], [C, x] = [r, l], [w, k] = [i, o], u = 0;
            if (this._triggersSubmenu()) {
                ...
                e.overlapTrigger || (C = r === "top" ? "bottom" : "top", x = l === "top" ? "bottom" : "top");
            t.withPositions([{ originX: i, originY: C, overlayX: w, overlayY: r, offsetY: u }, { originX: o, originY: C, overlayX: k, overlayY: r, offsetY: u }, { originX: i, originY: x, overlayX: w, overlayY: l, offsetY: -u }, { originX: o, originY: x, overlayX: k, overlayY: l, offsetY: -u }]);
        }
    ...
    class s extends Z {
        ...
        _isWithinMenuOrTrigger(e) {
            if (!e)
                return !1;
            let t = this._element.nativeElement;
            if (e === t || t.contains(e))
                return !0;
            let i = this._overlayRef?.hostElement;
            return i === e || !!i?.contains(e);
        }
