...
var Se = (() => {
    class n {
        ...
        syncHTMLSteps() {
            this.htmlSteps = [];
            let t = 1, o = document.querySelector(".mat-stepper-vertical");
            o || (t = 2, o = document.querySelector(".mat-horizontal-stepper-header-container"));
            for (let i = 0; i < o.children.length; i += t)
        ...
        static {
            this.\u0275cmp = e.\u0275\u0275defineComponent({ type: n, selectors: [["responsive-stepper"]], contentQueries: function (o, i, r) {
                    if (o & 1 && e.\u0275\u0275contentQuery(r, B, 4), o & 2) {
                        let s;
                        e.\u0275\u0275queryRefresh(s = e.\u0275\u0275loadQuery()) && (i.steps = s);
                    }
                }, viewQuery: function (o, i) {
                    if (o & 1 && e.\u0275\u0275viewQuery(c, 5), o & 2) {
                        let r;
