...
import { g as l } from "@nf-internal/chunk-C2A5IV4Z";
import { j as u } from "@nf-internal/chunk-IR6MR6UK";
...
var J = (() => {
    ...
    class e extends x {
        _nodeOutlet = void 0;
        static \u0275fac = (() => { let t; return function (r) { return (t || (t = n.\u0275\u0275getInheritedFactory(e)))(r || e); }; })();
        static \u0275cmp = n.\u0275\u0275defineComponent({ type: e, selectors: [["mat-tree"]], viewQuery: function (i, r) {
                if (i & 1 && n.\u0275\u0275viewQuery(y, 7), i & 2) {
                    let d;
...
var te = (() => {
    ...
    _flattenNode(a, t, i, r) {
        let d = this.transformFunction(a, t);
        if (i.push(d), this.isExpandable(d)) {
    ...
    expandFlattenedNodes(a, t) {
        let i = [], r = [];
        return r[0] = !0, a.forEach(d => {
            let s = !0;
            for (let o = 0; o <= this.getLevel(d); o++)
                s = s && r[o];
            s && i.push(d), this.isExpandable(d) && (r[this.getLevel(d) + 1] = t.isExpanded(d));
        }), i;
    }
}, D = class extends C {
    _treeControl;
