...
import { i as c, n as _ } from "@nf-internal/chunk-IR6MR6UK";
    ...
    class i {
        ...
        monitor(e) {
            if (!this._platform.isBrowser)
                return _;
            this._styleLoader.load(x);
            let t = m(e), n = this._monitoredElements.get(t);
            if (n)
                return n.subject;
            let r = new c, a = "cdk-text-field-autofilled", d = l => { l.animationName === "cdk-text-field-autofill-start" && !t.classList.contains(a) ? (t.classList.add(a), this._ngZone.run(() => r.next({ target: l.target, isAutofilled: !0 }))) : l.animationName === "cdk-text-field-autofill-end" && t.classList.contains(a) && (t.classList.remove(a), this._ngZone.run(() => r.next({ target: l.target, isAutofilled: !1 }))); }, w = this._ngZone.runOutsideAngular(() => (t.classList.add("cdk-text-field-autofill-monitored"), this._renderer.listen(t, "animationstart", d, M)));
            return this._monitoredElements.set(t, { subject: r, unlisten: w }), r;
        }
