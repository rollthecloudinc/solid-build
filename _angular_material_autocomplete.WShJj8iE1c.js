import { a as T, b as E, c as j, d as k, e as R, f as F, g as L, h as y } from "@nf-internal/chunk-6QNXWVCH";
import "@nf-internal/chunk-HOKO2ONL";
import "@nf-internal/chunk-ARUHDGKS";
import { g as D } from "@nf-internal/chunk-5ZLKIHXA";
...
import { d as M, g as d } from "@nf-internal/chunk-C2A5IV4Z";
import { b as u, d as m, i as _, w as f } from "@nf-internal/chunk-IR6MR6UK";
...
var q = ["panel"], G = ["*"];
function Q(s, p) {
    if (s & 1 && (o.\u0275\u0275domElementStart(0, "div", 1, 0), o.\u0275\u0275projection(2), o.\u0275\u0275domElementEnd()), s & 2) {
...
var lt = (() => {
    class s {
        ...
        static \u0275cmp = o.\u0275\u0275defineComponent({ type: s, selectors: [["mat-autocomplete"]], contentQueries: function (t, i, n) {
                if (t & 1 && (o.\u0275\u0275contentQuery(n, R, 5), o.\u0275\u0275contentQuery(n, E, 5)), t & 2) {
                    let a;
                    o.\u0275\u0275queryRefresh(a = o.\u0275\u0275loadQuery()) && (i.options = a), o.\u0275\u0275queryRefresh(a = o.\u0275\u0275loadQuery()) && (i.optionGroups = a);
                }
            }, viewQuery: function (t, i) {
                if (t & 1 && (o.\u0275\u0275viewQuery(U, 7), o.\u0275\u0275viewQuery(q, 5)), t & 2) {
                    let n;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    return s;
})(), Me = { provide: be, useExisting: z(() => ke), multi: !0 };
...
var Ee = { provide: Y, deps: [], useFactory: Te }, ke = (() => {
    class s {
        ...
        _handleKeydown(e) {
            let t = e, i = t.keyCode, n = O(t);
            if (i === V && !n && t.preventDefault(), this._valueOnLastKeydown = this._element.nativeElement.value, this.activeOption && i === he && this.panelOpen && !n)
        ...
        _handleInput(e) {
            ...
            if (t.type === "number" && (i = i == "" ? null : parseFloat(i)), this._previousValue !== i) {
        ...
        _scrollToOption(e) {
            let t = this.autocomplete, i = F(e, t.options, t.optionGroups);
            if (e === 0 && i === 1)
                t._setScrollTop(0);
            else if (t.panel) {
        ...
        _applyModalPanelOwnership() {
            let e = this._element.nativeElement.closest('body > .cdk-overlay-container [aria-modal="true"]');
            if (!e)
                return;
            let t = this.autocomplete.id;
            this._trackedModal && b(this._trackedModal, "aria-owns", t), I(e, "aria-owns", t), this._trackedModal = e;
        }
        _clearFromModal() {
