...
import { g as p } from "@nf-internal/chunk-C2A5IV4Z";
import { i as c, k as m } from "@nf-internal/chunk-IR6MR6UK";
...
var y = new g("MAT_SORT_DEFAULT_OPTIONS"), P = (() => {
    class r {
        _defaultOptions;
        ...
        getNextSortDirection(t) {
            if (!t)
                return "";
            let o = t?.disableClear ?? this.disableClear ?? !!this._defaultOptions?.disableClear, i = T(t.start || this.start, o), a = i.indexOf(this.direction) + 1;
            return a >= i.length && (a = 0), i[a];
        }
