...
var F = (function () {
    function r(t) { this.initialTeardown = t, this.closed = !1, this._parentage = null, this._finalizers = null; }
...
var Q = { setTimeout: function (r, t) {
        for (var e = [], n = 2; n < arguments.length; n++)
            e[n - 2] = arguments[n];
        var o = Q.delegate;
        return o?.setTimeout ? o.setTimeout.apply(o, lt([r, t], mt(e))) : setTimeout.apply(void 0, lt([r, t], mt(e)));
    }, clearTimeout: function (r) { var t = Q.delegate; return (t?.clearTimeout || clearTimeout)(r); }, delegate: void 0 };
function sr(r) {
...
var cr = (function (r) {
    bt(t, r);
    function t(e) { var n = r.call(this) || this; return n.isStopped = !1, e ? (n.destination = e, lr(e) && e.add(n)) : n.destination = ye, n; }
    return t.create = function (e, n, o) { return new $(e, n, o); }, t.prototype.next = function (e) { this.isStopped ? qr(dt(e), this) : this._next(e); }, t.prototype.error = function (e) { this.isStopped ? qr(vt(e), this) : (this.isStopped = !0, this._error(e)); }, t.prototype.complete = function () { this.isStopped ? qr(st, this) : (this.isStopped = !0, this._complete()); }, t.prototype.unsubscribe = function () { this.closed || (this.isStopped = !0, r.prototype.unsubscribe.call(this), this.destination = null); }, t.prototype._next = function (e) { this.destination.next(e); }, t.prototype._error = function (e) {
        try {
...
var he = (function () {
    function r(t) { this.partialObserver = t; }
    ...
    function t(e, n, o) {
        ...
        return i.destination = new he(u), i;
    }
    return t;
})(cr);
...
var w = (function () {
    function r(t) { t && (this._subscribe = t); }
    return r.prototype.lift = function (t) { var e = new r; return e.source = this, e.operator = t, e; }, r.prototype.subscribe = function (t, e, n) { var o = this, i = Se(t) ? t : new $(t, e, n); return rr(function () { var u = o, f = u.operator, a = u.source; i.add(f ? f.call(i, a) : a ? o._subscribe(i) : o._trySubscribe(i)); }), i; }, r.prototype._trySubscribe = function (t) {
        try {
        ...
        var n = this;
        return e = yt(e), new e(function (o, i) {
            var u = new $({ next: function (f) {
                    try {
                        t(f);
                    }
                    catch (a) {
    ...
    }, r.prototype._subscribe = function (t) { var e; return (e = this.source) === null || e === void 0 ? void 0 : e.subscribe(t); }, r.prototype[tr] = function () { return this; }, r.prototype.pipe = function () {
        for (var t = [], e = 0; e < arguments.length; e++)
            t[e] = arguments[e];
        return zr(t)(this);
    }, r.prototype.toPromise = function (t) { var e = this; return t = yt(t), new t(function (n, o) { var i; e.subscribe(function (u) { return i = u; }, function (u) { return o(u); }, function () { return n(i); }); }); }, r.create = function (t) { return new r(t); }, r;
})();
...
var Kr = (function (r) {
    ge(t, r);
    function t(e, n, o, i, u, f) {
        var a = r.call(this, e) || this;
        return a.onFinalize = u, a.shouldUnsubscribe = f, a._next = n ? function (m) {
            try {
                n(m);
            }
            catch (l) {
        ...
        } : r.prototype._next, a._error = i ? function (m) {
            try {
                i(m);
            }
            catch (l) {
...
function xt() {
    return c(function (r, t) {
        var e = null;
        r._refCount++;
        var n = p(t, void 0, void 0, void 0, function () {
            if (!r || r._refCount <= 0 || 0 < --r._refCount) {
                e = null;
                return;
            }
            var o = r._connection, i = e;
            e = null, o && (!i || o === i) && o.unsubscribe(), t.unsubscribe();
        });
...
var E = (function (r) {
    wt(t, r);
    function t() { var e = r.call(this) || this; return e.closed = !1, e.currentObservers = null, e.observers = [], e.isStopped = !1, e.hasError = !1, e.thrownError = null, e; }
    return t.prototype.lift = function (e) { var n = new gt(this, this); return n.operator = e, n; }, t.prototype._throwIfClosed = function () {
        if (this.closed)
            throw new St;
...
var Et = (function (r) {
    Ee(t, r);
    function t(e) { var n = r.call(this) || this; return n._value = e, n; }
    return Object.defineProperty(t.prototype, "value", { get: function () { return this.getValue(); }, enumerable: !1, configurable: !0 }), t.prototype._subscribe = function (e) { var n = r.prototype._subscribe.call(this, e); return !n.closed && e.next(this._value), n; }, t.prototype.getValue = function () {
        var e = this, n = e.hasError, o = e.thrownError, i = e._value;
        if (n)
            throw o;
        return this._throwIfClosed(), i;
    }, t.prototype.next = function (e) { r.prototype.next.call(this, this._value = e); }, t;
})(E);
import { __extends as Oe } from "tslib";
var B = { now: function () { return (B.delegate || Date).now(); }, delegate: void 0 };
var hr = (function (r) {
    Oe(t, r);
    function t(e, n, o) { e === void 0 && (e = 1 / 0), n === void 0 && (n = 1 / 0), o === void 0 && (o = B); var i = r.call(this) || this; return i._bufferSize = e, i._windowTime = n, i._timestampProvider = o, i._buffer = [], i._infiniteTimeWindow = !0, i._infiniteTimeWindow = n === 1 / 0, i._bufferSize = Math.max(1, e), i._windowTime = Math.max(1, n), i; }
    return t.prototype.next = function (e) { var n = this, o = n.isStopped, i = n._buffer, u = n._infiniteTimeWindow, f = n._timestampProvider, a = n._windowTime; o || (i.push(e), !u && i.push(f.now() + a)), this._trimBuffer(), r.prototype.next.call(this, e); }, t.prototype._subscribe = function (e) {
        this._throwIfClosed(), this._trimBuffer();
        for (var n = this._innerSubscribe(e), o = this, i = o._infiniteTimeWindow, u = o._buffer, f = u.slice(), a = 0; a < f.length && !e.closed; a += i ? 1 : 2)
            e.next(f[a]);
        return this._checkFinalizedStatuses(e), n;
    }, t.prototype._trimBuffer = function () {
        var e = this, n = e._bufferSize, o = e._timestampProvider, i = e._buffer, u = e._infiniteTimeWindow, f = (u ? 1 : 2) * n;
        if (n < 1 / 0 && f < i.length && i.splice(0, i.length - f), !u) {
...
function I(r, t, e, n, o) {
    ...
    var i = t.schedule(function () { e(), o ? r.add(this.schedule(null, n)) : this.unsubscribe(); }, n);
    if (r.add(i), !o)
        return i;
}
...
function _r(r) {
    return _e(this, arguments, function () {
        var e, n, o, i;
    ...
    return new w(function (e) {
        ...
        return I(e, t, function () {
            n = r[Or](), I(e, t, function () {
                ...
                u ? e.complete() : e.next(i);
            }, 0, !0);
        }), function () { return y(n?.return) && n.return(); };
    });
}
function Tr(r, t) {
    if (!r)
        throw new Error("Iterable cannot be null");
    return new w(function (e) { I(e, t, function () { var n = r[Symbol.asyncIterator](); I(e, t, function () { n.next().then(function (o) { o.done ? e.complete() : e.next(o.value); }); }, 0, !0); }); });
}
...
var pr = { setInterval: function (r, t) {
        for (var e = [], n = 2; n < arguments.length; n++)
            e[n - 2] = arguments[n];
        var o = pr.delegate;
        return o?.setInterval ? o.setInterval.apply(o, kt([r, t], Pt(e))) : setInterval.apply(void 0, kt([r, t], Pt(e)));
    }, clearInterval: function (r) { var t = pr.delegate; return (t?.clearInterval || clearInterval)(r); }, delegate: void 0 };
var Mt = (function (r) {
    Ne(t, r);
    function t(e, n) { var o = r.call(this, e, n) || this; return o.scheduler = e, o.work = n, o.pending = !1, o; }
    return t.prototype.schedule = function (e, n) {
        ...
        return i != null && (this.id = this.recycleAsyncId(u, i, n)), this.pending = !0, this.delay = n, this.id = (o = this.id) !== null && o !== void 0 ? o : this.requestAsyncId(u, this.id, n), this;
    }, t.prototype.requestAsyncId = function (e, n, o) { return o === void 0 && (o = 0), pr.setInterval(e.flush.bind(e, this), o); }, t.prototype.recycleAsyncId = function (e, n, o) {
        if (o === void 0 && (o = 0), o != null && this.delay === o && this.pending === !1)
            return n;
        n != null && pr.clearInterval(n);
    }, t.prototype.execute = function (e, n) {
        if (this.closed)
            return new Error("executing a cancelled action");
        this.pending = !1;
        var o = this._execute(e, n);
        if (o)
            return o;
...
var Vt = (function (r) {
    We(t, r);
    function t(e, n) { n === void 0 && (n = Br.now); var o = r.call(this, e, n) || this; return o.actions = [], o._active = !1, o; }
...
function Lt(r, t) {
    var e = er(r) ? { first: r } : typeof r == "number" ? { each: r } : r, n = e.first, o = e.each, i = e.with, u = i === void 0 ? Ye : i, f = e.scheduler, a = f === void 0 ? t ?? T : f, m = e.meta, l = m === void 0 ? null : m;
    if (n == null && o == null)
        throw new TypeError("No timeout provided.");
    return c(function (s, v) {
        var S, d, b = null, h = 0, g = function (_) {
            d = I(v, a, function () {
                try {
        ...
        S = s.subscribe(p(v, function (_) { d?.unsubscribe(), h++, v.next(b = _), o > 0 && g(o); }, void 0, void 0, function () { d?.closed || d?.unsubscribe(), b = null; })), !h && g(n != null ? typeof n == "number" ? n : +n - a.now() : o);
    });
}
...
function Dt() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = j(r), n = D(r), o = Ut(r), i = o.args, u = o.keys;
    if (i.length === 0)
        return U([], e);
    var f = new w(Jr(i, e, u ? function (a) { return Nt(u, a); } : A));
    return n ? f.pipe(nr(n)) : f;
}
function Jr(r, t, e) {
    return e === void 0 && (e = A), function (n) {
        Wt(t, function () {
            for (var o = r.length, i = new Array(o), u = o, f = o, a = function (l) { Wt(t, function () { var s = U(r[l], t), v = !1; s.subscribe(p(n, function (S) { i[l] = S, v || (v = !0, f--), f || n.next(e(i.slice())); }, function () { --u || n.complete(); })); }, n); }, m = 0; m < o; m++)
                a(m);
        }, n);
    };
}
function Wt(r, t, e) { r ? I(e, r, t) : t(); }
function or(r, t, e, n, o, i, u, f) {
    var a = [], m = 0, l = 0, s = !1, v = function () { s && !a.length && !m && t.complete(); }, S = function (b) { return m < n ? d(b) : a.push(b); }, d = function (b) {
        i && t.next(b), m++;
        var h = !1;
        x(e(b, l++)).subscribe(p(t, function (g) { o?.(g), i ? S(g) : t.next(g); }, function () { h = !0; }, void 0, function () {
            if (h)
                try {
                    m--;
...
function qt(r) {
    return c(function (t, e) {
        var n = !1, o = null, i = null, u = !1, f = function () {
        ...
        t.subscribe(p(e, function (m) { n = !0, o = m, i || x(r(m)).subscribe(i = p(e, f, a)); }, function () { u = !0, (!n || !i || i.closed) && e.complete(); }));
    });
}
...
function ma(r, t) {
    return t === void 0 && (t = null), t = t ?? r, c(function (e, n) {
        var o = [], i = 0;
        e.subscribe(p(n, function (u) {
            var f, a, m, l, s = null;
            i++ % t === 0 && o.push([]);
            try {
...
function ga(r) {
    for (var t, e, n = [], o = 1; o < arguments.length; o++)
        n[o - 1] = arguments[o];
    var i = (t = j(n)) !== null && t !== void 0 ? t : T, u = (e = n[0]) !== null && e !== void 0 ? e : null, f = n[1] || 1 / 0;
    return c(function (a, m) {
        var l = [], s = !1, v = function (b) { var h = b.buffer, g = b.subs; g.unsubscribe(), C(l, b), m.next(h), s && S(); }, S = function () {
            if (l) {
                var b = new F;
                m.add(b);
        ...
        u !== null && u >= 0 ? I(m, i, S, u, !0) : s = !0, S();
        var d = p(m, function (b) {
            var h, g, _ = l.slice();
            try {
            ...
            for (; l?.length;)
                m.next(l.shift().buffer);
            d?.unsubscribe(), m.complete(), m.unsubscribe();
        }, void 0, function () { return l = null; });
        a.subscribe(d);
    });
}
...
function Ca(r, t) {
    return c(function (e, n) {
        var o = [];
        x(r).subscribe(p(n, function (i) { var u = []; o.push(u); var f = new F, a = function () { C(o, u), n.next(u), f.unsubscribe(); }; f.add(x(t(i)).subscribe(p(n, a, O))); }, O)), e.subscribe(p(n, function (i) {
            var u, f;
            try {
...
function Hr() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = D(r);
    return e ? dr(Hr.apply(void 0, Zt([], Kt(r))), nr(e)) : c(function (n, o) { Jr(Zt([n], Kt(ir(r))))(o); });
}
import { __read as nn, __spreadArray as on } from "tslib";
function xc() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return Hr.apply(void 0, on([], nn(r)));
}
...
function $t() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = j(r);
    return c(function (n, o) { Pr()(U(fn([n], un(r)), e)).subscribe(o); });
}
import { __read as an, __spreadArray as cn } from "tslib";
function Vc() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return $t.apply(void 0, cn([], an(r)));
}
...
function Hc(r) {
    return c(function (t, e) {
        var n = !1, o = null, i = null, u = function () {
            if (i?.unsubscribe(), i = null, n) {
                n = !1;
                var f = o;
                o = null, e.next(f);
...
function np(r, t) {
    return t === void 0 && (t = T), c(function (e, n) {
        var o = null, i = null, u = null, f = function () {
            if (o) {
        ...
        e.subscribe(p(n, function (m) { i = m, u = t.now(), o || (o = t.schedule(a, r), n.add(o)); }, function () { f(), n.complete(); }, void 0, function () { i = o = null; }));
    });
}
...
var Lr = (function () {
    function r(t, e, n) { this.kind = t, this.value = e, this.error = n, this.hasValue = t === "N"; }
    return r.prototype.observe = function (t) { return tt(this, t); }, r.prototype.do = function (t, e, n) { var o = this, i = o.kind, u = o.value, f = o.error; return i === "N" ? t?.(u) : i === "E" ? e?.(f) : n?.(); }, r.prototype.accept = function (t, e, n) { var o; return y((o = t) === null || o === void 0 ? void 0 : o.next) ? this.observe(t) : this.do(t, e, n); }, r.prototype.toObservable = function () {
        var t = this, e = t.kind, n = t.value, o = t.error, i = e === "N" ? Cr(n) : e === "E" ? Ht(function () { return o; }) : e === "C" ? N : 0;
        if (!i)
            throw new TypeError("Unexpected notification kind " + e);
        return i;
    }, r.createNext = function (t) { return new r("N", t); }, r.createError = function (t) { return new r("E", void 0, t); }, r.createComplete = function () { return r.completeNotification; }, r.completeNotification = new r("C"), r;
})();
function tt(r, t) {
    var e, n, o, i = r, u = i.kind, f = i.value, a = i.error;
    if (typeof u != "string")
        throw new TypeError('Invalid notification, missing "kind"');
    u === "N" ? (e = t.next) === null || e === void 0 || e.call(t, f) : u === "E" ? (n = t.error) === null || n === void 0 || n.call(t, a) : (o = t.complete) === null || o === void 0 || o.call(t);
}
...
function sm(r, t) {
    ...
    return function (n) { return n.pipe(Y(function (o, i) { return i === r; }), X(1), e ? ur(t) : fr(function () { return new et; })); };
}
import { __read as sn, __spreadArray as vn } from "tslib";
function ym() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return function (e) { return J(e, Cr.apply(void 0, vn([], sn(r)))); };
}
...
function cl(r, t, e, n) {
    return c(function (o, i) {
        var u;
        !t || typeof t == "function" ? u = t : (e = t.duration, u = t.element, n = t.connector);
        var f = new Map, a = function (d) { f.forEach(d), d(i); }, m = function (d) { return a(function (b) { return b.error(d); }); }, l = 0, s = !1, v = new Kr(i, function (d) {
            try {
                var b = r(d), h = f.get(b);
                if (!h) {
                    f.set(b, h = n ? n() : new E);
        ...
        }, function () { return a(function (d) { return d.complete(); }); }, m, function () { return f.clear(); }, function () { return s = !0, l === 0; });
        o.subscribe(v);
        function S(d, b) { var h = new w(function (g) { l++; var _ = b.subscribe(g); return function () { _.unsubscribe(), --l === 0 && s && v.unsubscribe(); }; }); return h.key = d, h; }
    });
}
...
function te(r) {
    return r <= 0 ? function () { return N; } : c(function (t, e) {
        var n = [];
        t.subscribe(p(e, function (o) { n.push(o), r < n.length && n.shift(); }, function () {
            var o, i;
            try {
...
function ee() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = j(r), n = jt(r, 1 / 0);
    return r = ir(r), c(function (o, i) { Rr(n)(U(bn([o], hn(r)), e)).subscribe(i); });
}
import { __read as yn, __spreadArray as xn } from "tslib";
function ns() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return ee.apply(void 0, xn([], yn(r)));
}
function fs(r) { return q(y(r) ? function (t, e) { return r(t, e) < 0 ? t : e; } : function (t, e) { return t < e ? t : e; }); }
import { __extends as Sn } from "tslib";
var ar = (function (r) {
    Sn(t, r);
    function t(e, n) { var o = r.call(this) || this; return o.source = e, o.subjectFactory = n, o._subject = null, o._refCount = 0, o._connection = null, Gr(e) && (o.lift = e.lift), o; }
    return t.prototype._subscribe = function (e) { return this.getSubject().subscribe(e); }, t.prototype.getSubject = function () { var e = this._subject; return (!e || e.isStopped) && (this._subject = this.subjectFactory()), this._subject; }, t.prototype._teardown = function () { this._refCount = 0; var e = this._connection; this._subject = this._connection = null, e?.unsubscribe(); }, t.prototype.connect = function () {
        ...
        return n;
    }, t.prototype.refCount = function () { return xt()(this); }, t;
})(w);
...
function oe(r) {
    return function (t) {
        for (var e = [], n = function (i) {
            e.push(x(r[i]).subscribe(p(t, function (u) {
                if (e) {
...
function tv() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return r.length ? c(function (e, n) { oe(En([e], wn(r)))(n); }) : A;
}
function av(r) {
    var t, e = 1 / 0, n;
    return r != null && (typeof r == "object" ? (t = r.count, e = t === void 0 ? 1 / 0 : t, n = r.delay) : e = r), e <= 0 ? function () { return N; } : c(function (o, i) {
        var u = 0, f, a = function () {
            if (f?.unsubscribe(), f = null, n != null) {
                var l = typeof n == "number" ? V(n) : x(n(u)), s = p(i, function () { s.unsubscribe(), m(); });
                l.subscribe(s);
            }
            else
                m();
        }, m = function () { var l = !1; f = o.subscribe(p(i, void 0, function () { ++u < e ? f ? a() : l = !0 : i.complete(); })), l && a(); };
        m();
    });
}
...
function Sv(r) {
    ...
    var e = t.count, n = e === void 0 ? 1 / 0 : e, o = t.delay, i = t.resetOnSuccess, u = i === void 0 ? !1 : i;
    return n <= 0 ? A : c(function (f, a) {
        var m = 0, l, s = function () {
            var v = !1;
            l = f.subscribe(p(a, function (S) { u && (m = 0), a.next(S); }, void 0, function (S) {
                if (m++ < n) {
...
function ie(r) {
    return c(function (t, e) {
        var n = !1, o = null;
        t.subscribe(p(e, function (i) { n = !0, o = i; })), r.subscribe(p(e, function () {
            if (n) {
                n = !1;
                var i = o;
                o = null, e.next(i);
...
function bd(r) {
    return r <= 0 ? A : c(function (t, e) {
        var n = new Array(r), o = 0;
        return t.subscribe(p(e, function (i) {
            var u = o++;
            if (u < r)
                n[u] = i;
            else {
...
function Rd() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = j(r);
    return c(function (n, o) { (e ? J(r, n, e) : J(r, n)).subscribe(o); });
}
...
function pe(r, t) {
    return t === void 0 && (t = ut), c(function (e, n) {
        var o = t.leading, i = t.trailing, u = !1, f = null, a = null, m = !1, l = function () { a?.unsubscribe(), a = null, i && (S(), m && n.complete()); }, s = function () { a = null, m && n.complete(); }, v = function (d) { return a = x(r(d)).subscribe(p(n, l, s)); }, S = function () {
            if (u) {
                u = !1;
                var d = f;
...
function Fh(r, t, e) {
    var n, o, i;
    if (e = e ?? jr, er(r) ? n = r : typeof r == "number" && (o = r), t)
        i = function () { return t; };
    else
        throw new TypeError("No observable provided to switch to");
    if (n == null && o == null)
        throw new TypeError("No timeout provided.");
    return Lt({ first: n, each: o, scheduler: e, with: i });
}
...
function Gh(r, t) {
    t === void 0 && (t = 0);
    var e = t > 0 ? t : r;
    return c(function (n, o) {
        var i = [new E], u = [], f = 0;
        o.next(i[0].asObservable()), n.subscribe(p(o, function (a) {
            var m, l;
            try {
            ...
            var d = f - r + 1;
            if (d >= 0 && d % e === 0 && i.shift().complete(), ++f % e === 0) {
                var b = new E;
...
function tb(r) {
    ...
    var i = (t = j(n)) !== null && t !== void 0 ? t : T, u = (e = n[0]) !== null && e !== void 0 ? e : null, f = n[1] || 1 / 0;
    return c(function (a, m) {
        var l = [], s = !1, v = function (h) { var g = h.window, _ = h.subs; g.complete(), _.unsubscribe(), C(l, h), s && S(); }, S = function () {
            if (l) {
                var h = new F;
                m.add(h);
        ...
        u !== null && u >= 0 ? I(m, i, S, u, !0) : s = !0, S();
        var d = function (h) { return l.slice().forEach(h); }, b = function (h) { d(function (g) { var _ = g.window; return h(_); }), h(m), m.unsubscribe(); };
        return a.subscribe(p(m, function (h) { d(function (g) { g.window.next(h), f <= ++g.seen && v(g); }); }, function () { return b(function (h) { return h.complete(); }); }, function (h) { return b(function (g) { return g.error(h); }); })), function () { l = null; };
    });
}
...
function mb(r, t) {
    return c(function (e, n) {
        ...
        x(r).subscribe(p(n, function (u) {
            var f = new E;
            o.push(f);
            var a = new F, m = function () { C(o, f), f.complete(), a.unsubscribe(); }, l;
            try {
                l = x(t(u));
            }
            catch (s) {
            ...
            n.next(f.asObservable()), a.add(l.subscribe(p(n, m, O, i)));
        }, O)), e.subscribe(p(n, function (u) {
            var f, a, m = o.slice();
            try {
...
function bb(r) {
    return c(function (t, e) {
        var n, o, i = function (f) { n.error(f), e.error(f); }, u = function () {
            o?.unsubscribe(), n?.complete(), n = new E, e.next(n.asObservable());
            var f;
            try {
                f = x(r());
            }
            ...
            f.subscribe(o = p(e, u, u, i));
        };
        u(), t.subscribe(p(e, function (f) { return n.next(f); }, function () { n.complete(), e.complete(); }, i, function () { o?.unsubscribe(), n = null; }));
    });
}
...
function _b() {
    ...
    var e = D(r);
    return c(function (n, o) {
        for (var i = r.length, u = new Array(i), f = r.map(function () { return !1; }), a = !1, m = function (s) { x(r[s]).subscribe(p(o, function (v) { u[s] = v, !a && !f[s] && (f[s] = !0, (a = f.every(A)) && (f = null)); }, O)); }, l = 0; l < i; l++)
            m(l);
        n.subscribe(p(o, function (s) {
            if (a) {
                var v = le([s], me(u));
...
function Nr() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    var e = D(r), n = ir(r);
    return n.length ? new w(function (o) {
        var i = n.map(function () { return []; }), u = n.map(function () { return !1; });
        o.add(function () { i = u = null; });
        for (var f = function (m) {
            x(n[m]).subscribe(p(o, function (l) {
                if (i[m].push(l), i.every(function (v) { return v.length; })) {
            ...
            }, function () { u[m] = !0, !i[m].length && o.complete(); }));
        }, a = 0; !o.closed && a < n.length; a++)
            f(a);
        return function () { i = u = null; };
    }) : N;
}
...
function se() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return c(function (e, n) { Nr.apply(void 0, Rn([e], jn(r))).subscribe(n); });
}
import { __read as Pn, __spreadArray as kn } from "tslib";
function Kb() {
    for (var r = [], t = 0; t < arguments.length; t++)
        r[t] = arguments[t];
    return se.apply(void 0, kn([], Pn(r)));
}
