...
import { a as v, e as S, f as g } from "@nf-internal/chunk-U56RZWEM";
...
import { i as y } from "@nf-internal/chunk-IR6MR6UK";
...
function $(a, _) {
    if (a & 1 && (e.\u0275\u0275elementStart(0, "div", 2, 1)(2, "div", 5)(3, "span", 6), e.\u0275\u0275text(4), e.\u0275\u0275elementEnd()()()), a & 2) {
...
function G(a, _) {
    if (a & 1 && e.\u0275\u0275repeaterCreate(0, Z, 1, 4, "div", 8, e.\u0275\u0275repeaterTrackByIndex), a & 2) {
        let t = e.\u0275\u0275nextContext(2);
        e.\u0275\u0275repeater(t._tickMarks);
    }
}
function Y(a, _) {
    if (a & 1 && (e.\u0275\u0275elementStart(0, "div", 6, 1), e.\u0275\u0275conditionalCreate(2, G, 2, 0), e.\u0275\u0275elementEnd()), a & 2) {
        let t = e.\u0275\u0275nextContext();
        e.\u0275\u0275advance(2), e.\u0275\u0275conditional(t._cachedWidth ? 2 : -1);
    }
}
function K(a, _) {
    if (a & 1 && e.\u0275\u0275element(0, "mat-slider-visual-thumb", 7), a & 2) {
        let t = e.\u0275\u0275nextContext();
    ...
    class a {
        ...
        _onPointerMove = t => {
            if (this._sliderInput._isFocused)
                return;
            let i = this._hostElement.getBoundingClientRect(), s = this._slider._isCursorOnSliderThumb(t, i);
            this._isHovered = s, s ? this._showHoverRipple() : this._hideRipple(this._hoverRippleRef);
        };
        ...
        _showRipple(t, i) {
            if (!this._slider.disabled && (this._showValueIndicator(), this._slider._isRange && this._slider._getThumb(this.thumbPosition === r.START ? r.END : r.START)._showValueIndicator(), !(this._slider._globalRippleOptions?.disabled && !i)))
        ...
        _hideRipple(t) {
            if (t?.fadeOut(), this._isShowingAnyRipple())
                return;
            this._slider._isRange || this._hideValueIndicator();
            let i = this._getSibling();
        ...
        static \u0275cmp = e.\u0275\u0275defineComponent({ type: a, selectors: [["mat-slider-visual-thumb"]], viewQuery: function (i, s) {
                if (i & 1 && (e.\u0275\u0275viewQuery(g, 5), e.\u0275\u0275viewQuery(H, 5), e.\u0275\u0275viewQuery(Q, 5)), i & 2) {
                    let n;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class a {
        ...
        _updateMinNonRange(t) {
            let i = this._getInput(r.END);
            if (i) {
                let s = i.value;
        ...
        _updateThumbUI(t) {
            if (this._skipUpdate())
                return;
            let i = this._getThumb(t.thumbPosition === r.END ? r.END : r.START);
            i._hostElement.style.transform = `translateX(${t.translateX}px)`;
        }
        _updateValueIndicatorUI(t) {
            if (this._skipUpdate())
                return;
            let i = this.displayWith(t.value);
            if (this._hasViewInitialized ? t._valuetext.set(i) : t._hostElement.setAttribute("aria-valuetext", i), this.discrete) {
        ...
        _updateTickMarkTrackUI() {
            if (!this.showTickMarks || this._skipUpdate())
                return;
            let t = this._step && this._step > 0 ? this._step : 1, s = (Math.floor(this.max / t) * t - this.min) / (this.max - this.min);
            this._tickMarkTrackWidth = (this._cachedWidth - 6) * s;
        }
        _updateTrackUI(t) { this._skipUpdate() || (this._isRange ? this._updateTrackUIRange(t) : this._updateTrackUINonRange(t)); }
        _updateTrackUIRange(t) {
            let i = t.getSibling();
            if (!i || !this._cachedWidth)
                return;
            let s = Math.abs(i.translateX - t.translateX) / this._cachedWidth;
            t._isLeftThumb && this._cachedWidth ? this._setTrackActiveStyles({ left: "auto", right: `${this._cachedWidth - i.translateX}px`, transformOrigin: "right", transform: `scaleX(${s})` }) : this._setTrackActiveStyles({ left: `${i.translateX}px`, right: "auto", transformOrigin: "left", transform: `scaleX(${s})` });
        }
        ...
        _updateTickMarkUI() {
            if (!this.showTickMarks || this.step === void 0 || this.min === void 0 || this.max === void 0)
                return;
            let t = this.step > 0 ? this.step : 1;
            this._isRange ? this._updateTickMarkUIRange(t) : this._updateTickMarkUINonRange(t);
        }
        ...
        static \u0275fac = function (i) { return new (i || a); };
        static \u0275cmp = e.\u0275\u0275defineComponent({ type: a, selectors: [["mat-slider"]], contentQueries: function (i, s, n) {
                if (i & 1 && (e.\u0275\u0275contentQuery(n, N, 5), e.\u0275\u0275contentQuery(n, P, 4)), i & 2) {
                    let l;
                    e.\u0275\u0275queryRefresh(l = e.\u0275\u0275loadQuery()) && (s._input = l.first), e.\u0275\u0275queryRefresh(l = e.\u0275\u0275loadQuery()) && (s._inputs = l);
                }
            }, viewQuery: function (i, s) {
                if (i & 1 && (e.\u0275\u0275viewQuery(j, 5), e.\u0275\u0275viewQuery(O, 5)), i & 2) {
                    let n;
...
var tt = { provide: D, useExisting: U(() => B), multi: !0 }, it = { provide: D, useExisting: U(() => et), multi: !0 }, B = (() => {
    class a {
        _ngZone = d(k);
        _elementRef = d(I);
        _cdr = d(f);
        ...
        set value(t) {
            t === null && (t = this._getDefaultValue()), t = isNaN(t) ? 0 : t;
            let i = t + "";
        ...
        _fixValue(t) {
            let i = t.clientX - this._slider._cachedLeft, s = this._slider._cachedWidth, n = this._slider.step === 0 ? 1 : this._slider.step, l = Math.floor((this._slider.max - this._slider.min) / n), o = this._slider._isRtl ? 1 - i / s : i / s, W = Math.round(o * l) / l * (this._slider.max - this._slider.min) + this._slider.min, R = Math.round(W / n) * n, X = this.value;
            if (R === X) {
    ...
    class a extends B {
        ...
        _updateWidthInactive() {
            let t = this.getSibling();
            if (!t)
                return;
            let i = this._slider._cachedWidth - this._tickMarkOffset * 2, s = this._isEndThumb ? this.value - (this.value - t.value) / 2 : this.value + (t.value - this.value) / 2, n = this._isEndThumb ? (this.max - s) / (this._slider.max - this._slider.min) : (s - this.min) / (this._slider.max - this._slider.min), l = this._slider.min < this._slider.max ? n : 1, o = this._slider._rippleRadius;
            l === 1 ? o = 48 : l === 0 && (o = 0);
            let m = i * l + o;
