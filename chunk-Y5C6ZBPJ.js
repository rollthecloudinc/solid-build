...
import { f as L, i as x, q as I } from "@nf-internal/chunk-RASHQLKI";
...
import { b as m, i as b } from "@nf-internal/chunk-IR6MR6UK";
import { a as tt } from "@nf-internal/chunk-SVIUGILY";
import { k as kt } from "@nf-internal/chunk-N26NRATF";
import { a as E, b as J } from "@nf-internal/chunk-6MDQTQU3";
...
var H = class {
    ...
    enable() {
        if (this._scrollSubscription)
            return;
        let t = this._scrollDispatcher.scrolled(0).pipe(Mt(e => !e || !this._overlayRef.overlayElement.contains(e.getElementRef().nativeElement)));
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class s {
        ...
        _createContainer() {
            ...
            if (this._platform.isBrowser || T()) {
                let o = this._document.querySelectorAll(`.${e}[platform="server"], .${e}[platform="test"]`);
                for (let n = 0; n < o.length; n++)
                    o[n].remove();
            }
            let i = this._document.createElement("div");
            i.classList.add(e), T() ? i.setAttribute("platform", "test") : this._platform.isBrowser || i.setAttribute("platform", "server"), this._document.body.appendChild(i), this._containerElement = i;
        }
    ...
    _updateElementSize() {
        ...
        t.width = p(this._config.width), t.height = p(this._config.height), t.minWidth = p(this._config.minWidth), t.minHeight = p(this._config.minHeight), t.maxWidth = p(this._config.maxWidth), t.maxHeight = p(this._config.maxHeight);
    }
...
var j = class {
    ...
    _pushOverlayOnScreen(t, e, i) {
        ...
        let o = pt(e), n = this._viewportRect, r = Math.max(t.x + o.width - n.width, 0), a = Math.max(t.y + o.height - n.height, 0), h = Math.max(n.top - i.top - t.y, 0), c = Math.max(n.left - i.left - t.x, 0), l = 0, _ = 0;
        return o.width <= n.width ? l = c || -r : l = t.x < this._viewportMargin ? n.left - i.left - t.x : 0, o.height <= n.height ? _ = h || -a : _ = t.y < this._viewportMargin ? n.top - i.top - t.y : 0, this._previousPushAmount = { x: l, y: _ }, { x: t.x + l, y: t.y + _ };
    }
    _applyPosition(t, e) {
    ...
    _calculateBoundingBoxRect(t, e) {
        ...
        let h = e.overlayX === "start" && !o || e.overlayX === "end" && o, c = e.overlayX === "end" && !o || e.overlayX === "start" && o, l, _, v;
        if (c)
    ...
    _setOverlayElementStyles(t, e) {
        ...
        if (o) {
            ...
            i.position = "static";
        let a = "", h = this._getOffset(e, "x"), c = this._getOffset(e, "y");
        h && (a += `translateX(${h}px) `), c && (a += `translateY(${c}px)`), i.transform = a.trim(), r.maxHeight && (o ? i.maxHeight = p(r.maxHeight) : n && (i.maxHeight = "")), r.maxWidth && (o ? i.maxWidth = p(r.maxWidth) : n && (i.maxWidth = "")), w(this._pane.style, i);
    }
...
var $ = class {
    ...
    apply() {
        if (!this._overlayRef || !this._overlayRef.hasAttached())
            return;
        let t = this._overlayRef.overlayElement.style, e = this._overlayRef.hostElement.style, i = this._overlayRef.getConfig(), { width: o, height: n, maxWidth: r, maxHeight: a } = i, h = (o === "100%" || o === "100vw") && (!r || r === "100%" || r === "100vw"), c = (n === "100%" || n === "100vh") && (!a || a === "100%" || a === "100vh"), l = this._xPosition, _ = this._xOffset, v = this._overlayRef.getConfig().direction === "rtl", u = "", g = "", y = "";
        h ? y = "flex-start" : l === "center" ? (y = "center", v ? g = _ : u = _) : v ? l === "left" || l === "end" ? (y = "flex-end", u = _) : (l === "right" || l === "start") && (y = "flex-start", g = _) : l === "left" || l === "start" ? (y = "flex-start", u = _) : (l === "right" || l === "end") && (y = "flex-end", g = _), t.position = this._cssPosition, t.marginLeft = h ? "0" : u, t.marginTop = c ? "0" : this._topOffset, t.marginBottom = this._bottomOffset, t.marginRight = h ? "0" : g, e.justifyContent = y, e.alignItems = c ? "flex-start" : this._alignItems;
    }
    dispose() {
...
var Nt = (() => {
    ...
    return s;
})(), zt = [{ originX: "start", originY: "bottom", overlayX: "start", overlayY: "top" }, { originX: "start", originY: "top", overlayX: "start", overlayY: "bottom" }, { originX: "end", originY: "top", overlayX: "end", overlayY: "bottom" }, { originX: "end", originY: "bottom", overlayX: "end", overlayY: "top" }], Ot = new Pt("cdk-connected-overlay-scroll-strategy", { providedIn: "root", factory: () => { let s = d(C); return () => q(s); } }), ut = (() => {
    class s {
        elementRef = d(G);
        constructor() { }
        static \u0275fac = function (i) { return new (i || s); };
...
var jt = { provide: Ot, useFactory: Zt }, Se = (() => {
    class s {
        static \u0275fac = function (i) { return new (i || s); };
