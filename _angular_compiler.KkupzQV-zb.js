import { a as S, b as ue } from "@nf-internal/chunk-6MDQTQU3";
var tu = new RegExp(`(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`, "g"), Jn = class n {
    ...
    notSelectors = [];
    static parse(e) {
        let t = [], s = (l, c) => { c.notSelectors.length > 0 && !c.element && c.classNames.length == 0 && c.attrs.length == 0 && (c.element = "*"), l.push(c); }, r = new n, i, a = r, o = !1;
        for (tu.lastIndex = 0; i = tu.exec(e);) {
            if (i[1]) {
                if (o)
    ...
    addSelectables(e, t) {
        let s = null;
        e.length > 1 && (s = new Ro(e), this._listContexts.push(s));
        for (let r = 0; r < e.length; r++)
            this._addSelectable(e[r], t, s);
    }
    _addSelectable(e, t, s) {
        let r = this, i = e.element, a = e.classNames, o = e.attrs, l = new Fo(e, t, s);
        if (i && (o.length === 0 && a.length === 0 ? this._addTerminal(r._elementMap, i, l) : r = this._addPartial(r._elementPartialMap, i)), a)
    ...
    match(e, t) {
        let s = !1, r = e.element, i = e.classNames, a = e.attrs;
    ...
    _matchTerminal(e, t, s, r) {
        if (!e || typeof t != "string")
            return !1;
        let i = e.get(t) || [], a = e.get("*");
        if (a && (i = i.concat(a)), i.length === 0)
            return !1;
        let o, l = !1;
        for (let c = 0; c < i.length; c++)
            o = i[c], l = o.finalize(s, r) || l;
        return l;
    }
...
function yd(n) {
    Gi ??= new TextEncoder;
    let e = [...Gi.encode(n)], t = _d(e, bc.Big), s = e.length * 8, r = new Uint32Array(80), i = 1732584193, a = 4023233417, o = 2562383102, l = 271733878, c = 3285377520;
    t[s >> 5] |= 128 << 24 - s % 32, t[(s + 64 >> 9 << 4) + 15] = s;
    for (let h = 0; h < t.length; h += 16) {
...
function su(n, e, t) {
    let s = 2654435769, r = 2654435769, i = 0, a = e - 12;
    for (; i <= a; i += 12) {
    ...
    let o = e - i;
    return t += e, o >= 4 ? (s += n.getUint32(i, !0), i += 4, o >= 8 ? (r += n.getUint32(i, !0), i += 4, o >= 9 && (t += n.getUint8(i++) << 8), o >= 10 && (t += n.getUint8(i++) << 16), o === 11 && (t += n.getUint8(i++) << 24)) : (o >= 5 && (r += n.getUint8(i++)), o >= 6 && (r += n.getUint8(i++) << 8), o === 7 && (r += n.getUint8(i++) << 16))) : (o >= 1 && (s += n.getUint8(i++)), o >= 2 && (s += n.getUint8(i++) << 8), o === 3 && (s += n.getUint8(i++) << 16)), ru(s, r, t)[2];
}
...
var IA = Object.freeze({ __proto__: null, ArrayType: qo, ArrowFunctionExpr: xn, BOOL_TYPE: ap, get BinaryOperator() { return x; }, BinaryOperatorExpr: W, BuiltinType: _t, get BuiltinTypeName() { return jt; }, CommaExpr: jo, ConditionalExpr: Tt, DYNAMIC_TYPE: He, DeclareFunctionStmt: An, DeclareVarStmt: ce, DynamicImportExpr: es, Expression: Y, ExpressionStatement: nt, ExpressionType: Je, ExternalExpr: tn, ExternalReference: Wo, FUNCTION_TYPE: bd, FnParam: J, FunctionExpr: Zt, INFERRED_TYPE: qe, INT_TYPE: Td, IfStmt: br, InstantiateExpr: Ls, InvokeFunctionExpr: Fe, JSDocComment: Tr, LeadingComment: kr, LiteralArrayExpr: dt, LiteralExpr: Ee, LiteralMapEntry: ts, LiteralMapExpr: bt, LiteralPiece: gn, LocalizedString: _r, MapType: Uo, NONE_TYPE: kt, NULL_EXPR: yn, NUMBER_TYPE: ro, NotExpr: Ms, ParenthesizedExpr: ft, PlaceholderPiece: zn, ReadKeyExpr: Ft, ReadPropExpr: We, ReadVarExpr: tt, RecursiveAstVisitor: Ld, ReturnStatement: xe, STRING_TYPE: io, Statement: Cn, get StmtModifier() { return le; }, TYPED_NULL_EXPR: cp, TaggedTemplateLiteralExpr: Ps, TemplateLiteralElementExpr: Ar, TemplateLiteralExpr: Bs, TransplantedType: Yi, Type: Sn, get TypeModifier() { return Ic; }, TypeofExpr: Kn, get UnaryOperator() { return Ds; }, UnaryOperatorExpr: nn, VoidExpr: Cr, WrappedNodeExpr: H, areAllEquivalent: Re, arrowFn: ie, expressionType: we, fn: sn, ifStmt: Si, importExpr: y, importType: Md, isNull: $d, jsDocComment: up, leadingComment: Bd, literal: d, literalArr: R, literalMap: he, localizedString: fp, not: hp, nullSafeIsEquivalent: op, taggedTemplate: pp, transplantedType: Rd, typeofExpr: Js, unary: Fd, variable: D }), Vd = "_c", cu = D("<unknown>"), qd = {}, Ud = 50, Qi = class n extends Y {
    ...
    getConstLiteral(e, t) {
        if (e instanceof Ee && !uu(e) || e instanceof Qi)
            return e;
        let s = ks.INSTANCE.keyOf(e), r = this.literals.get(s), i = !1;
        if (r || (r = new Qi(e), this.literals.set(s, r), i = !0), !i && !r.shared || i && t) {
    ...
    getSharedFunctionReference(e, t, s = !0) {
        let r = e instanceof xn;
        for (let a of this.statements)
        ...
        return this.statements.push(e instanceof Zt ? e.toDeclStmt(i, le.Final) : new ce(i, e, qe, le.Final, e.sourceSpan)), D(i);
    }
    _getLiteralFactory(e, t, s) {
        let r = this.literalFactories.get(e), i = t.filter(a => !a.isConstant());
        if (!r) {
...
var Zd = 3, Jd = "# sourceMappingURL=data:application/json;base64,", Go = class {
    ...
    toJSON() {
        if (!this.hasMappings)
            return null;
        let e = new Map, t = [], s = [];
        Array.from(this.sourcesContent.keys()).forEach((c, h) => { e.set(c, h), t.push(c), s.push(this.sourcesContent.get(c) || null); });
        let r = "", i = 0, a = 0, o = 0, l = 0;
        return this.lines.forEach(c => { i = 0, r += c.map(h => { let p = Ai(h.col0 - i); return i = h.col0, h.sourceUrl != null && (p += Ai(e.get(h.sourceUrl) - a), a = e.get(h.sourceUrl), p += Ai(h.sourceLine0 - o), o = h.sourceLine0, p += Ai(h.sourceCol0 - l), l = h.sourceCol0), p; }).join(","), r += ";"; }), r = r.slice(0, -1), { file: this.file || "", version: Zd, sourceRoot: "", sources: t, sourcesContent: s, mappings: r };
    }
...
`);
    ...
    toSourceMapGenerator(e, t = 0) {
        let s = new Go(e), r = !1, i = () => { r || (s.addSource(e, " ").addMapping(0, e, 0, 0), r = !0); };
        for (let a = 0; a < t; a++)
            s.addLine(), i();
        return this.sourceLines.forEach((a, o) => {
            s.addLine();
            let l = a.srcSpans, c = a.parts, h = a.indent * Xo.length, p = 0;
            for (; p < l.length && !l[p];)
                h += c[p].length, p++;
            for (p < l.length && o === 0 && h === 0 ? r = !0 : i(); p < l.length;) {
...
`).forEach(r => { t.println(e, `// ${r}`); });
    ...
    visitAllObjects(e, t, s, r) {
        ...
        for (let a = 0; a < t.length; a++)
            a > 0 && (s.lineLength() > 80 ? (s.print(null, r, !0), i || (s.incIndent(), s.incIndent(), i = !0)) : s.print(null, r, !1)), e(t[a]);
...
function xs({ expression: n, forwardRef: e }) {
    switch (e) {
        case 0:
        case 1: return n;
        case 2: return Dc(n);
...
function $n(n) {
    let e = D("__ngFactoryType__"), t = null, s = fu(n) ? e : new W(x.Or, e, n.type.value), r = null;
    n.deps !== null ? n.deps !== "invalid" && (r = new Ls(s, pu(n.deps, n.target))) : (t = D(`\u0275${n.name}_BaseFactory`), r = t.callFn([s]));
    let i = [], a = null;
    function o(c) { let h = D("__ngConditionalFactory__"); i.push(new ce(h.name, yn, qe)); let p = r !== null ? h.set(r).toStmt() : y(f.invalidFactory).callFn([]).toStmt(); return i.push(Si(e, [p], [h.set(c).toStmt()])), h; }
    if (fu(n)) {
        let c = pu(n.delegateDeps, n.target), h = new (n.delegateType === Ki.Class ? Ls : Fe)(n.delegate, c);
        a = o(h);
    }
    else
        cm(n) ? a = o(n.expression) : a = r;
    if (a === null)
        ...
        i.push(new xe(a));
    let l = sn([new J(e.name, He)], i, qe, void 0, `${n.name}_Factory`);
    return t !== null && (l = ie([], [new ce(t.name), new xe(l)]).callFn([], void 0, !0)), { expression: l, statements: [], type: wp(n) };
}
...
var oo = class {
    ...
    static fromParsedEvent(e) {
        let t = e.type === Be.Regular ? e.targetOrPhase : null, s = e.type === Be.LegacyAnimation ? e.targetOrPhase : null;
        if (e.keySpan === void 0)
...
<!ELEMENT ex (#PCDATA)>`, hl = class extends Us {
    ...
    visitTagPlaceholder(e, t) {
        let s = new Q(`<${e.tag}>`), r = new M(Fn, {}, [s]), i = new M(Rn, { name: e.startName }, [r, s]);
        if (e.isVoid)
            return [i];
        let a = new Q(`</${e.tag}>`), o = new M(Fn, {}, [a]), l = new M(Rn, { name: e.closeName }, [o, a]);
...
function yi(n, e = !0) {
    ...
    return s.length && (i += s.map(a => a.charAt(0).toUpperCase() + a.slice(1).toLowerCase()).join("")), r ? `${i}_${r}` : i;
}
...
function dl(n, e) {
    ...
    return t.length === 0 ? null : he(t.map(s => {
        let r = n[s], i, a, o, l;
        if (typeof r == "string")
            i = s, o = s, a = r, l = Me(a);
        else {
...
function gu(n, e) {
    let t = null, s = { name: n.name, type: n.type, typeArgumentCount: n.typeArgumentCount, deps: [], target: Bt.Injectable };
    if (n.useClass !== void 0) {
        ...
        n.useFactory !== void 0 ? n.deps !== void 0 ? t = $n(ue(S({}, s), { delegate: n.useFactory, delegateDeps: n.deps || [], delegateType: Ki.Function })) : t = { statements: [], expression: ie([], n.useFactory.callFn([])) } : n.useValue !== void 0 ? t = $n(ue(S({}, s), { expression: n.useValue.expression })) : n.useExisting !== void 0 ? t = $n(ue(S({}, s), { expression: y(f.inject).callFn([n.useExisting.expression]) })) : t = { statements: [], expression: vu(n.type.value, n.type.value, e) };
    let r = n.type.value, i = new ae;
    return i.set("token", r), i.set("factory", t.expression), n.providedIn.expression.value !== null && i.set("providedIn", xs(n.providedIn)), { expression: y(f.\u0275\u0275defineInjectable).callFn([i.toLiteralMap()], void 0, !0), type: kp(n), statements: t.statements };
}
...
var os = class n {
    ...
    moveBy(e) {
        let t = this.file.content, s = t.length, r = this.offset, i = this.line, a = this.col;
        for (; r > 0 && e < 0;)
...
function Vm(n) {
    ...
    let t = mp(e);
    return t.indexOf("(") >= 0 ? (t = `anonymous_${Om++}`, e.__anonymousType = t) : t = On(t), t;
}
...
var Cu = '(this&&this.__makeTemplateObject||function(e,t){return Object.defineProperty?Object.defineProperty(e,"raw",{value:t}):e.raw=t,e})', vl = class extends Qo {
    ...
    visitLocalizedString(e, t) {
        t.print(e, `$localize(${Cu}(`);
        let s = [e.serializeI18nHead()];
        for (let r = 1; r < e.messageParts.length; r++)
            s.push(e.serializeI18nTemplatePart(r));
        return t.print(e, `[${s.map(r => qn(r.cooked, !1)).join(", ")}], `), t.print(e, `[${s.map(r => qn(r.raw, !1)).join(", ")}])`), e.expressions.forEach(r => { t.print(e, ", "), r.visitExpression(this, t); }), t.print(e, ")"), null;
    }
...
function Wm(n) {
    let e = [], t = new ae;
    if (t.set("type", n.type.value), n.kind === Yt.Global && n.bootstrap.length > 0 && t.set("bootstrap", Ct(n.bootstrap, n.containsForwardDecls)), n.selectorScopeMode === Sa.Inline)
    ...
    let s = y(f.defineNgModule).callFn([t.toLiteralMap()], void 0, !0), r = Up(n);
...
function Up(n) {
    if (n.kind === Yt.Local)
        return new Je(n.type.value);
    let { type: e, declarations: t, exports: s, imports: r, includeImportTypes: i, publicDeclarationTypes: a } = n;
    return new Je(y(f.NgModuleDeclaration, [new Je(e.type), a === null ? go(t) : Gm(a), i ? go(r) : kt, go(s)]));
}
function zm(n) {
    let e = new ae;
    if (n.kind === Yt.Global ? n.declarations.length > 0 && e.set("declarations", Ct(n.declarations, n.containsForwardDecls)) : n.declarationsExpression && e.set("declarations", n.declarationsExpression), n.kind === Yt.Global ? n.imports.length > 0 && e.set("imports", Ct(n.imports, n.containsForwardDecls)) : n.importsExpression && e.set("imports", n.importsExpression), n.kind === Yt.Global ? n.exports.length > 0 && e.set("exports", Ct(n.exports, n.containsForwardDecls)) : n.exportsExpression && e.set("exports", n.exportsExpression), n.kind === Yt.Local && n.bootstrapExpression && e.set("bootstrap", n.bootstrapExpression), Object.keys(e.values).length === 0)
        return null;
    let t = new Fe(y(f.setNgModuleScope), [n.type.value, e.toLiteralMap()]), s = im(t), r = new Zt([], [s.toStmt()]);
    return new Fe(r, []).toStmt();
}
...
`;
    ...
    _applySelectorScope({ selector: e, scopeSelector: t, hostSelector: s, isParentSelector: r }) {
        ...
        let E = e.substring(h);
        return c += l(E), this._safeSelector.restore(c);
    }
...
var K = class extends Y {
    ...
    transformInternalExpressions(e, t) {
        this.body !== null ? this.body = k(this.body, e, t | X.InChildOperation) : this.fn !== null && (this.fn = k(this.fn, e, t));
    ...
    isConstant() { return !1; }
    transformInternalExpressions(e, t) {
        this.receiver = k(this.receiver, e, t);
        for (let s = 0; s < this.args.length; s++)
            this.args[s] = k(this.args[s], e, t);
    }
    ...
    class n {
        ...
        *reversed() {
        ...
        static replaceWithMany(t, s) {
            ...
            t.debugListId = null;
            for (let h of s)
                n.assertIsNotEnd(h), n.assertIsUnowned(h);
            let { prev: i, next: a } = t;
            t.prev = null, t.next = null;
            let o = i;
            for (let h of s)
                n.assertIsUnowned(h), h.debugListId = r, o.next = h, h.prev = o, h.next = null, o = h;
            let l = s[0], c = o;
            i !== null && (i.next = l, l.prev = i), a !== null && (a.prev = c, c.next = a);
        }
...
function xo(n, e, t, s, r) {
    if (t === null && n !== Wn.Attr)
        throw new Error("AssertionError: i18nBlock must be provided for non-attribute contexts.");
    return S({ kind: u.I18nContext, contextKind: n, xref: e, i18nBlock: t, message: s, sourceSpan: r, params: new Map, postprocessingParams: new Map }, B);
}
...
function ev(n) {
    if (n instanceof Fe && n.fn instanceof Ae && n.fn.name === "$any") {
        if (n.args.length !== 1)
...
function zc(n) {
    ...
    for (let t of n.create)
        nr(t) && (e.set(t.xref, t), t.kind === u.RepeaterCreate && t.emptyView !== null && e.set(t.emptyView, t));
    return e;
}
function iv(n) {
    for (let e of n.units) {
...
function av(n, e, t) {
    if (e.expression instanceof oe)
        return;
    let s = e.isTextAttribute || e.expression.isConstant();
    if (n.job.compatibility === st.TemplateDefinitionBuilder && (s &&= e.isTextAttribute), s) {
...
var ds = Object.freeze([]), Tl = class {
    ...
    add(e, t, s, r, i) {
        if (!(this.compatibility === st.TemplateDefinitionBuilder && (e === T.Attribute || e === T.ClassName || e === T.StyleProperty)) && this.isKnown(e, t))
            return;
        if (t === "ngProjectAs") {
        ...
        let o = this.arrayFor(e);
        if (o.push(...vv(r, t)), e === T.Attribute || e === T.StyleProperty) {
            if (s === null)
...
function bl({ attributes: n, bindings: e, classes: t, i18n: s, projectAs: r, styles: i, template: a }) {
    let o = [...n];
    if (r !== null) {
        let l = so(r)[0];
        o.push(d(5), Xs(l));
...
function Pv(n, e, t) {
    return k(n, s => {
        if (s instanceof Wt && e.has(s.xref)) {
            let r = new In(s.xref);
...
function ms(n, e, t) {
    ...
    if (ze(n)) {
        ...
        s = [n, n.clone()], Pv(s[1], Dv(s[0]), t);
    return new Gs(s[0], e(s[1]));
}
...
function Mv(n) {
    if (pf(n) && n.receiver instanceof Gs) {
        let e = n.receiver;
...
function Gv(n) {
    ...
    let e = n.expressionPlaceholders.map(As);
...
function Xv(n) {
    if (n.length === 0)
        return null;
    let e = n.map(t => As(t));
    return e.length === 1 ? e[0] : `${Uv}${e.join(Wv)}${Hv}`;
}
function As(n) {
    if (n.flags & te.ElementTag && n.flags & te.TemplateTag) {
    ...
    if (n.flags & te.OpenTag && n.flags & te.CloseTag)
        return `${As(ue(S({}, n), { flags: n.flags & ~te.CloseTag }))}${As(ue(S({}, n), { flags: n.flags & ~te.OpenTag }))}`;
    if (n.flags === te.None)
        return `${n.value}`;
    let e = "", t = "";
    n.flags & te.ElementTag ? e = $v : n.flags & te.TemplateTag && (e = Ov), e !== "" && (t = n.flags & te.CloseTag ? Vv : "");
    let s = n.subTemplateIndex === null ? "" : `${qv}${n.subTemplateIndex}`;
    return `${Fu}${t}${e}${n.value}${s}${Fu}`;
}
function Yv(n) {
    for (let e of n.units) {
        let t = new Map;
...
function Zv(n) {
    let e = n.compatibility === st.TemplateDefinitionBuilder, t = [], s = 0;
    for (let r of n.units)
        for (let i of r.create)
...
function Hi(n, e, t) {
    let s = [];
    e.view !== n.xref && s.push(dn(n.job.allocateXrefId(), e.viewContextVariable, new Aa, lt.None));
    let r = n.job.views.get(e.view);
    for (let [i, a] of r.contextVariables) {
    ...
    for (let i of r.aliases)
        s.push(dn(n.job.allocateXrefId(), i, i.expression.clone(), lt.AlwaysInline));
    for (let i of e.references)
        s.push(dn(n.job.allocateXrefId(), i.variable, new Ca(i.targetId, i.targetSlot, i.offset), lt.None));
    if (e.view !== n.xref || t)
        for (let i of e.letDeclarations)
            s.push(dn(n.job.allocateXrefId(), i.variable, new ii(i.targetId, i.targetSlot), lt.None));
    return e.parent !== null && s.push(...Hi(n, e.parent, !1)), s;
}
function ew(n) {
    for (let e of n.units)
        for (let t of e.ops())
...
var Dl = (function (n) { return n.HEX = "hexadecimal", n.DEC = "decimal", n; })(Dl || {}), cw = ["@if", "@else", "@for", "@switch", "@case", "@default", "@empty", "@defer", "@placeholder", "@loading", "@error"], Pl = class {
    ...
    constructor(e, t, s) {
        ...
        this._cursor = s.escapedString ? new Ll(e, r) : new Fa(e, r), this._preserveLineEndings = s.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = s.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = s.tokenizeBlocks ?? !0, this._tokenizeLet = s.tokenizeLet ?? !0, this._selectorlessEnabled = s.selectorlessEnabled ?? !1;
        try {
            this._cursor.init();
        }
        catch (i) {
...
`);
    ...
    _consumeBlockStart(e) {
        this._requireCharCode(fs), this._beginToken(24, e);
        let t = this._endToken([this._getBlockName()]);
        if (this._cursor.peek() === At)
    ...
    _consumeBlockParameters() {
        for (this._attemptCharCodeUntilFn(zu); this._cursor.peek() !== Pe && this._cursor.peek() !== _e;) {
            this._beginToken(27);
    ...
    _consumeLetDeclaration(e) {
        if (this._requireStr("@let"), this._beginToken(29, e), Kr(this._cursor.peek()))
            this._attemptCharCodeUntilFn(re);
        else {
    ...
    _consumeLetDeclarationValue() {
        let e = this._cursor.clone();
        for (this._beginToken(30, e); this._cursor.peek() !== _e;) {
    ...
    _tokenizeExpansionForm() {
        ...
        if (fw(this._cursor.peek()) && this._isInExpansionForm())
            return this._consumeExpansionCaseStart(), !0;
        if (this._cursor.peek() === Le) {
    ...
    _endToken(e, t) {
        if (this._currentTokenStart === null)
            throw new N(this._cursor.getSpan(t), "Programming error - attempted to end a token when there was no start to the token");
        if (this._currentTokenType === null)
            throw new N(this._cursor.getSpan(this._currentTokenStart), "Programming error - attempted to end a token which has no token type");
    ...
    handleError(e) {
        if (e instanceof pi && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof N)
            this.errors.push(e);
        else
            throw e;
    }
    ...
    _consumeEntity(e) {
        this._beginToken(9);
        let t = this._cursor.clone();
        if (this._cursor.advance(), this._attemptCharCode(Dp)) {
    ...
    _consumePrefixAndName(e) {
        ...
        for (; this._cursor.peek() !== Gt && !uw(this._cursor.peek());)
            this._cursor.advance();
        let r;
        this._cursor.peek() === Gt ? (s = this._cursor.getChars(t), this._cursor.advance(), r = this._cursor.clone()) : r = t, this._requireCharCodeUntilFn(e, s === "" ? 0 : 1);
        let i = this._cursor.getChars(r);
        return [s, i];
    }
    _consumeTagOpen(e) {
        ...
        let a = this._getTagDefinition(t).getContentType(s);
        a === Mt.RAW_TEXT ? this._consumeRawTextWithTagClose(i, r, !1) : a === Mt.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(i, r, !0);
    }
    ...
    _consumeComponentName() {
        ...
        return this._cursor.peek() === Gt && (this._cursor.advance(), [s, r] = this._consumePrefixAndName(Mn)), [t, s, r];
    }
    ...
    _consumeAttributeName() {
        ...
        if (e === Jr || e === Zr)
            throw this._createError(gs(e), this._cursor.getSpan());
        this._beginToken(14);
        let t;
    ...
    _consumeAttributeValue() {
        if (this._cursor.peek() === Jr || this._cursor.peek() === Zr) {
            let e = this._cursor.peek();
    ...
    _consumeTagClose(e) {
        ...
        let t = this._consumePrefixAndName(Mn);
        this._attemptCharCodeUntilFn(re), this._requireCharCode(it), this._endToken(t);
    }
    _consumeExpansionFormStart() {
        this._beginToken(19), this._requireCharCode(yt), this._endToken([]), this._expansionCaseStack.push(19), this._beginToken(7);
        let e = this._readUntil(ht), t = this._processCarriageReturns(e);
        ...
        this._requireCharCode(ht), this._attemptCharCodeUntilFn(re), this._beginToken(7);
        let s = this._readUntil(ht);
        this._endToken([s]), this._requireCharCode(ht), this._attemptCharCodeUntilFn(re);
    }
    ...
    _consumeInterpolation(e, t, s) {
        ...
        for (; this._cursor.peek() !== _e && (s === null || !s());) {
    ...
    _consumeDirective(e, t) {
        for (this._requireCharCode(fs), this._cursor.advance(); Gu(this._cursor.peek());)
            this._cursor.advance();
        this._beginToken(38, e);
        let s = this._cursor.getChars(t);
        if (this._endToken([s]), this._attemptCharCodeUntilFn(re), this._cursor.peek() === At) {
...
var Fa = class n {
    ...
    getSpan(e, t) {
        ...
        let r = this.locationFromCursor(e), i = this.locationFromCursor(this), a = s !== e ? this.locationFromCursor(s) : r;
        return new L(r, i, a);
    }
    ...
    advanceState(e) {
        if (e.offset >= this.end)
            throw this.state = e, new pi('Unexpected character "EOF"', this);
        let t = this.charAt(e.offset);
        t === Xn ? (e.line++, e.column = 0) : Ea(t) || e.column++, e.offset++, this.updatePeek(e);
    }
    ...
    decodeHexDigits(e, t) {
        ...
        if (isNaN(r))
            throw e.state = e.internalState, new pi("Invalid hexadecimal escape sequence", e);
        return r;
    }
    ...
    _consumeExpansion(e) {
        ...
        let i = new L(e.sourceSpan.start, this._peek.sourceSpan.end, e.sourceSpan.fullStart);
        this._addToParent(new wn(t.parts[0], s.parts[0], r, i, t.sourceSpan)), this._advance();
    }
    _parseExpansionCase() {
        let e = this._advance();
        if (this._peek.type !== 21)
            return this.errors.push(pe.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null;
        ...
        let a = new L(e.sourceSpan.start, r.sourceSpan.end, e.sourceSpan.fullStart), o = new L(t.sourceSpan.start, r.sourceSpan.end, t.sourceSpan.fullStart);
        return new ui(e.parts[0], i.rootNodes, a, e.sourceSpan, o);
    }
...
`) {
    ...
    _consumeComponentEndTag(e) {
        ...
        if (!this._popContainer(t, Ce, e.sourceSpan)) {
    ...
    _consumeAttr(e) {
        let t = Ui(e.parts[0], e.parts[1]), s = e.sourceSpan.end;
        ...
        let c = a && o && new L(a.start, o, a.fullStart);
        return new En(t, r, new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), e.sourceSpan, c, i.length > 0 ? i : void 0, void 0);
    }
    _consumeDirective(e) {
        ...
        let i = new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), a = new L(i.start, r === null ? e.sourceSpan.end : r.end, i.fullStart);
        return new Ba(e.parts[0], t, a, i, r);
    }
    _consumeBlockOpen(e) {
        let t = [];
        ...
        let s = this._peek.sourceSpan.fullStart, r = new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), i = new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), a = new at(e.parts[0], t, [], r, e.sourceSpan, i);
    ...
    _consumeIncompleteBlock(e) {
        ...
        let s = this._peek.sourceSpan.fullStart, r = new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), i = new L(e.sourceSpan.start, s, e.sourceSpan.fullStart), a = new at(e.parts[0], t, [], r, e.sourceSpan, i);
        this._pushContainer(a, !1), this._popContainer(null, at, null), this.errors.push(pe.create(e.parts[0], r, `Incomplete block "${e.parts[0]}". If you meant to write the @ character, you should use the "&#64;" HTML entity instead.`));
    }
    _consumeLet(e) {
        let t = e.parts[0], s, r;
        ...
        if (this._peek.type !== 31) {
            ...
            r = this._advance();
        let i = r.sourceSpan.fullStart, a = new L(e.sourceSpan.start, i, e.sourceSpan.fullStart), o = e.sourceSpan.toString().lastIndexOf(t), l = e.sourceSpan.start.moveBy(o), c = new L(l, e.sourceSpan.end), h = new Ra(t, s.parts[0], a, c, s.sourceSpan);
        this._addToParent(h);
    }
...
var fi = class {
    ...
    visitElement(e, t) {
        ...
        let s = new De(e.name, e.attrs, e.directives, wt(this, e.children), e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.isVoid, e.i18n);
        return this.originalNodeMap?.set(s, e), s;
    }
    visitAttribute(e, t) { return e.name !== gf ? e : null; }
    visitText(e, t) {
        let s = e.value.match(vw), r = t && (t.prev instanceof wn || t.next instanceof wn);
    ...
    visitComponent(e, t) {
        if (e.tagName && Zu.has(e.tagName) || Ju(e.attrs)) {
        ...
        let s = new Ce(e.componentName, e.tagName, e.fullName, e.attrs, e.directives, wt(this, e.children), e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.i18n);
        return this.originalNodeMap?.set(s, e), s;
    }
...
var bi = new Nt(-1, -1, O.Character, 0, ""), Ml = class {
    ...
    scanIdentifier() {
        let e = this.index;
        for (this.advance(); eh(this.peek);)
            this.advance();
        let t = this.input.substring(e, this.index);
        return Cw.indexOf(t) > -1 ? kw(e, this.index, t) : Aw(e, this.index, t);
    }
    scanPrivateIdentifier() {
        let e = this.index;
        if (this.advance(), !Ku(this.peek))
            return this.error("Invalid character [#]", -1);
        for (; eh(this.peek);)
            this.advance();
        let t = this.input.substring(e, this.index);
        return _w(e, this.index, t);
    }
    scanNumber(e) {
        ...
        s && (r = r.replace(/_/g, ""));
        let i = t ? Pw(r) : parseFloat(r);
        return Tw(e, this.index, i);
    }
    scanString() {
        ...
        return this.advance(), new Er(e, this.index, s + a, Yn.Plain);
    }
    ...
    scanTemplateLiteralPart(e) {
        ...
        return this.advance(), new Er(e, this.index, t + r, Yn.TemplateLiteralEnd);
    }
...
var $a = class {
    ...
    parseInterpolation(e, t, s, r, i = ot) {
        let a = [], { strings: o, expressions: l, offsets: c } = this.splitInterpolation(e, t, a, r, i);
        if (l.length === 0)
            return null;
        let h = [];
    ...
    splitInterpolation(e, t, s, r, i = ot) {
        let a = [], o = [], l = [], c = r ? Lw(r) : null, h = 0, p = !1, g = !1, { start: v, end: E } = i;
        for (; h < e.length;)
            if (p) {
        ...
        if (!p)
            if (g) {
                ...
                a.push({ text: e.substring(h), start: h, end: e.length });
        return new Rl(a, o, l);
    }
    ...
    _checkNoInterpolation(e, t, s, { start: r, end: i }) {
        ...
        for (let l of this._forEachUnquotedChar(t, 0))
            if (a === -1)
                ...
                break;
        a > -1 && o > -1 && e.push(_s(`Got interpolation (${r}${i}) where expression was expected`, t, `at column ${a} in`, s));
    }
    ...
    *_forEachUnquotedChar(e, t) {
    ...
    parseRelational() {
        ...
        for (; this.next.type == O.Operator || this.next.isKeywordIn;) {
            let s = this.next.strValue;
            switch (s) {
                case "<":
                case ">":
    ...
    parseExponentiation() {
        ...
        for (; this.next.type == O.Operator && this.next.strValue === "**";) {
    ...
    parsePrimary() {
        ...
        if (this.consumeOptionalCharacter(At)) {
    ...
    parseExpressionList(e) {
        ...
        do
            if (!this.next.isCharacter(e))
                ...
                break;
        while (this.consumeOptionalCharacter(ht));
        return t;
    }
    parseLiteralMap() {
        let e = [], t = [], s = this.inputIndex;
        if (this.expectCharacter(yt), !this.consumeOptionalCharacter(Le)) {
    ...
    parseAccessMember(e, t, s) {
        let r = this.inputIndex, i = this.withContext(dr.Writable, () => { let o = this.expectIdentifierOrKeyword() ?? ""; return o.length === 0 && this.error("Expected identifier for property access", e.span.end), o; }), a = this.sourceSpan(r);
        if (s)
            return this.isAssignmentOperator(this.next) ? (this.advance(), this.error("The '?.' operator cannot be used in the assignment"), new $e(this.span(t), this.sourceSpan(t))) : new Dr(this.span(t), this.sourceSpan(t), a, e, i);
    ...
    expectTemplateBindingKey() {
        ...
        while (t);
        return { source: e, span: new Ze(s, s + e.length) };
    }
    ...
    parseKeyedReadOrWrite(e, t, s) {
        return this.withContext(dr.Writable, () => {
            this.rbracketsExpected++;
            let r = this.parsePipe();
            if (r instanceof $e && this.error("Key access cannot be empty"), this.rbracketsExpected--, this.expectCharacter(Hn), this.isAssignmentOperator(this.next)) {
                ...
                return s ? new Pr(this.span(t), this.sourceSpan(t), e, r) : new rs(this.span(t), this.sourceSpan(t), e, r);
    ...
    getDirectiveBoundTarget() {
        if (this.next === bi || this.peekKeywordAs() || this.peekKeywordLet())
            return null;
        let e = this.parsePipe(), { start: t, end: s } = e.span, r = this.input.substring(t, s);
        return new Xe(e, r, fn(this.parseSourceSpan), this.absoluteOffset + t, this.errors);
    }
    parseAsBinding(e) {
        ...
        this.consumeStatementTerminator();
        let s = new Ze(e.span.start, this.currentAbsoluteOffset);
        return new Vr(s, t, e);
    }
    parseLetBinding() {
        ...
        let r = new Ze(e, this.currentAbsoluteOffset);
        return new Vr(r, t, s);
    }
    ...
    skip() {
        let e = this.next;
        for (; this.index < this.tokens.length && !e.isCharacter(Ye) && !e.isOperator("|") && (this.rparensExpected <= 0 || !e.isCharacter(Pe)) && (this.rbracesExpected <= 0 || !e.isCharacter(Le)) && (this.rbracketsExpected <= 0 || !e.isCharacter(Hn)) && (!(this.context & dr.Writable) || !this.isAssignmentOperator(e));)
...
var Vl = class {
    ...
    constructor() {
        super(), Hw.forEach(e => {
            let t = new Map, s = new Set, [r, i] = e.split("|"), a = i.split(","), [o, l] = r.split("^");
            o.split(",").forEach(h => { this._schema.set(h.toLowerCase(), t), this._eventSchema.set(h.toLowerCase(), s); });
...
If '${e}' is a directive input, make sure the directive is imported by the current module.` } : { error: !1 };
    ...
    normalizeAnimationStyleValue(e, t, s) {
        let r = "", i = s.toString().trim(), a = null;
        if (jw(e) && s !== 0 && s !== "0")
            if (typeof s == "number")
                r = "px";
            else {
...
var sh = { A: "LINK", B: "BOLD_TEXT", BR: "LINE_BREAK", EM: "EMPHASISED_TEXT", H1: "HEADING_LEVEL1", H2: "HEADING_LEVEL2", H3: "HEADING_LEVEL3", H4: "HEADING_LEVEL4", H5: "HEADING_LEVEL5", H6: "HEADING_LEVEL6", HR: "HORIZONTAL_RULE", I: "ITALIC_TEXT", LI: "LIST_ITEM", LINK: "MEDIA_LINK", OL: "ORDERED_LIST", P: "PARAGRAPH", Q: "QUOTATION", S: "STRIKETHROUGH_TEXT", SMALL: "SMALL_TEXT", SUB: "SUBSTRIPT", SUP: "SUPERSCRIPT", TBODY: "TABLE_BODY", TD: "TABLE_CELL", TFOOT: "TABLE_FOOTER", TH: "TABLE_HEADER_CELL", THEAD: "TABLE_HEADER", TR: "TABLE_ROW", TT: "MONOSPACED_TEXT", U: "UNDERLINED_TEXT", UL: "UNORDERED_LIST" }, Ul = class {
    ...
    getStartTagPlaceholderName(e, t, s) {
        ...
        let i = e.toUpperCase(), a = sh[i] || `TAG_${i}`, o = this._generateUniqueName(s ? a : `START_${a}`);
        return this._signatureToName[r] = o, o;
    }
    getCloseTagPlaceholderName(e) {
        let t = this._hashClosingTag(e);
        if (this._signatureToName[t])
            return this._signatureToName[t];
        let s = e.toUpperCase(), r = sh[s] || `TAG_${s}`, i = this._generateUniqueName(`CLOSE_${r}`);
...
var Hl = class {
    ...
    visitExpansion(e, t) {
        t.icuDepth++;
        let s = {}, r = new kn(e.switchValue, e.type, s, e.sourceSpan);
        if (e.cases.forEach(o => { s[o.value] = new et(o.expression.map(l => l.visit(this, t)), o.expSourceSpan); }), t.icuDepth--, t.isIcu || t.icuDepth > 0) {
        ...
        let a = new Tn(r, i, e.sourceSpan);
        return t.visitNodeFn(e, a);
    }
    visitExpansionCase(e, t) { throw new Error("Unreachable code"); }
    visitBlock(e, t) {
        let s = P(this, e.children, t);
        if (this._containerBlocks.has(e.name))
            return new et(s, e.sourceSpan);
        let r = e.parameters.map(l => l.expression), i = t.placeholderRegistry.getStartBlockPlaceholderName(e.name, r), a = t.placeholderRegistry.getCloseBlockPlaceholderName(e.name);
        t.placeholderToContent[i] = { text: e.startSourceSpan.toString(), sourceSpan: e.startSourceSpan }, t.placeholderToContent[a] = { text: e.endSourceSpan ? e.endSourceSpan.toString() : "}", sourceSpan: e.endSourceSpan ?? e.sourceSpan };
        let o = new Ut(e.name, r, i, a, s, e.sourceSpan, e.startSourceSpan, e.endSourceSpan);
...
function Xw(n, e) {
    if (e instanceof Ie && (Yw(e), e = e.nodes[0]), e instanceof et) {
        Qw(e.children, n);
        for (let t = 0; t < n.length; t++)
...
var Kw = n => (e, t) => { let s = n.get(e) ?? e; return s instanceof an && (t instanceof Tn && s.i18n instanceof Ie && (t.previousMessage = s.i18n), s.i18n = t), t; }, Oa = class {
    ...
    visitExpansion(e, t) {
        let s, r = e.i18n;
        if (this.hasI18nMeta = !0, r instanceof Tn) {
            let i = r.name;
...
var jl = class {
    ...
    visitText(e) {
        if (this.pieces[this.pieces.length - 1] instanceof gn)
...
function hE(n) {
    let e = [], t = [];
    n[0] instanceof zn && e.push(Co(n[0].sourceSpan.start));
    for (let s = 0; s < n.length; s++) {
        let r = n[s];
...
function Cf(n, e, t, s) {
    ...
    vE(s, i), s.params = new Map([...s.params.entries()].sort());
    let a = D(n.pool.uniqueName(pE)), o = SE(n.pool, s.message.id, e, n.i18nUseExternalIds), l;
...
function _E(n) {
    let e = [], t = 0, s = 0, r = 0, i = 0, a = 0, o = null;
    for (; t < n.length;)
...
function mr(n, e, t, s) {
    n.fnName === null && (n.fnName = n.job.pool.uniqueName(On(`${e}_${n.job.fnSuffix}`), !1));
    let r = new Map;
    for (let i of n.ops())
        switch (i.kind) {
            case u.Property:
    ...
    for (let i of n.ops())
        ye(i, a => {
            if (!(!(a instanceof en) || a.name !== null)) {
                if (!r.has(a.xref))
...
function QE(n) {
    for (let e of n.units)
        for (let t of e.ops())
            ye(t, s => {
                if (!(s instanceof cs) || s.body === null)
                    return;
                let r = new zl(s.args.length);
...
var zl = class extends ks {
    ...
    toSharedConstantDeclaration(e, t) {
        ...
        for (let i = 0; i < this.numArgs; i++)
            s.push(new J("a" + i));
        let r = k(t, i => i instanceof Ws ? D("a" + i.index) : i, X.None);
        return new ce(e, new xn(s, r), void 0, le.Final);
    }
};
function ZE(n) {
    for (let e of n.units)
...
function kf(n, e, t, s, r, i, a, o, l) {
    let c = [d(e), t, d(s), d(r), d(i), d(a)];
    for (o !== null && (c.push(d(o)), c.push(y(f.templateRefExtractor))); c[c.length - 1].isEquivalent(yn);)
        c.pop();
    return $(n, c, l);
}
...
function yS(n, e, t, s, r, i, a, o, l, c, h) {
    let p = [d(n), d(e), t ?? d(null), d(s), d(r), d(i), a ?? d(null), o ?? d(null), l ? y(f.deferEnableTimerScheduling) : d(null), d(h)], g;
    for (; (g = p[p.length - 1]) !== null && g instanceof Ee && g.value === null;)
        p.pop();
    return $(f.defer, p, c);
}
...
function bS(n, e, t, s, r, i, a, o) {
    let l = [d(n), e, d(t), d(s), d(r), d(i)];
    for (a !== null && (l.push(d(a)), l.push(y(f.templateRefExtractor))); l[l.length - 1].isEquivalent(yn);)
        l.pop();
    return $(f.conditionalCreate, l, o);
}
function IS(n, e, t, s, r, i, a, o) {
    let l = [d(n), e, d(t), d(s), d(r), d(i)];
    for (a !== null && (l.push(d(a)), l.push(y(f.templateRefExtractor))); l[l.length - 1].isEquivalent(yn);)
        l.pop();
    return $(f.conditionalBranchCreate, l, o);
}
...
function t2(n, e, t) {
    if (t.length < 1 || t.length > mh.length)
...
var d2 = { constant: [f.textInterpolate, f.textInterpolate1, f.textInterpolate2, f.textInterpolate3, f.textInterpolate4, f.textInterpolate5, f.textInterpolate6, f.textInterpolate7, f.textInterpolate8], variable: f.textInterpolateV, mapping: n => {
        if (n % 2 === 0)
            throw new Error("Expected odd number of arguments");
        return (n - 1) / 2;
    } }, m2 = { constant: [f.interpolate, f.interpolate1, f.interpolate2, f.interpolate3, f.interpolate4, f.interpolate5, f.interpolate6, f.interpolate7, f.interpolate8], variable: f.interpolateV, mapping: n => {
        if (n % 2 === 0)
            throw new Error("Expected odd number of arguments");
        return (n - 1) / 2;
    } }, g2 = { constant: [f.pureFunction0, f.pureFunction1, f.pureFunction2, f.pureFunction3, f.pureFunction4, f.pureFunction5, f.pureFunction6, f.pureFunction7, f.pureFunction8], variable: f.pureFunctionV, mapping: n => n };
function Xc(n, e, t, s, r) {
    let i = n.mapping(t.length), a = t.at(-1);
    if (s.length === 0 && t.length > 1 && a instanceof Ee && a.value === "" && t.pop(), i < n.constant.length)
    ...
    for (let t of e)
        switch (fe(t, bf, X.None), t.kind) {
            ...
            case u.RepeaterCreate:
                ...
                break;
            case u.SourceLocation:
                let ee = R(t.locations.map(({ targetSlot: V, offset: de, line: rr, column: dd }) => {
                    if (V.slot === null)
                        throw new Error("No slot was assigned for source location");
                    return R([d(V.slot), d(de), d(rr), d(dd)]);
                }));
...
function Di(n, e, t, s) {
    ...
    let i = [];
    return s && i.push(new J("$event")), sn(i, r, void 0, void 0, e);
}
function C2(n, e) {
    if (e.trackByFn !== null)
        return e.trackByFn;
    let t = [new J("$index"), new J("$item")], s;
...
function qa(n, e) {
    ...
    n === n.job.root && t.set(n.xref, D("ctx"));
    for (let s of e)
        fe(s, r => {
            if (r instanceof bn) {
                if (!t.has(r.view))
...
function Dt(n, e, t, s, r) {
    let i = null, a = new Map;
    for (let o of e.create)
        switch (o.kind) {
            case u.I18nStart:
                if (!o.context)
...
function P2(n) {
    ...
    let r = new Map, i = a => a.usage === er.I18nText ? a.i18nOwner : a.context;
    for (let a of n.units)
...
function Ua(n, e, t) {
    ...
    for (let i of e)
        i.kind == u.Listener || i.kind === u.TwoWayListener || i.kind === u.Animation || i.kind === u.AnimationListener || fe(i, a => {
            if (a instanceof Ae)
                return r.has(a.name) ? new en(r.get(a.name)) : s.has(a.name) ? new en(s.get(a.name)) : new We(new bn(n.job.root.xref), a.name);
            if (a instanceof _a && typeof a.view == "number") {
...
function V2(n, e) {
    e.handlerOps.prepend([dn(n.job.allocateXrefId(), { kind: Se.Context, name: null, view: n.xref }, new _a(n.xref), lt.None)]);
    for (let t of e.handlerOps)
...
function U2(n) {
    ...
    for (let s of n.units)
        for (let r of s.ops())
            r.kind === u.DeclareLet && t.set(r.xref, r), ye(r, i => { i instanceof ii && e.add(i.target); });
    for (let s of n.units)
        ...
        for (let t of e.create)
            if (t.kind === u.RepeaterCreate)
                if (t.track instanceof tt && t.track.name === "$index")
                    ...
                    t.track = k(t.track, r => {
                        if (r instanceof us || r instanceof ai)
                            throw new Error("Illegal State: Pipes are not allowed in this context");
                        return r instanceof bn ? (t.usesComponentInstance = !0, new Cl(r.view)) : r;
                    }, X.None);
                    let s = new w;
...
function Z2(n, e) {
    if (!(e instanceof Fe) || e.args.length === 0 || e.args.length > 2 || !(e.receiver instanceof We && e.receiver.receiver instanceof bn) || e.receiver.receiver.view !== n)
        return !1;
    let [t, s] = e.args;
    return !(t instanceof tt) || t.name !== "$index" ? !1 : e.args.length === 1 ? !0 : !(!(s instanceof tt) || s.name !== "$item");
}
function J2(n) {
    for (let e of n.units)
        for (let t of e.create)
            t.kind === u.RepeaterCreate && (t.track = k(t.track, s => {
                if (s instanceof Ae) {
    ...
    for (let e of n.units)
        for (let t of e.create)
            t.kind === u.TwoWayListener && fe(t, s => {
                ...
                if (r instanceof We || r instanceof Ft)
                    return dh(r, i).or(r.set(i));
                if (r instanceof en)
                    return dh(r, i);
...
function Bi(n) {
    let e = new Map;
    for (let t of n)
        t.kind === u.Variable && t.flags & lt.AlwaysInline && (ye(t, s => {
            if (Ht(s) && Qc(s) !== ve.None)
                throw new Error("AssertionError: A context-sensitive variable was marked AlwaysInline");
        }), e.set(t.xref, t)), fe(t, s => s instanceof en && e.has(s.xref) ? e.get(s.xref).initializer.clone() : s, X.None);
...
function ix(n, e, t) {
    ye(n, (s, r) => {
        if (!Ht(s) || s.kind !== I.ReadVariable)
            return;
        let i = e.get(s.xref);
        i !== void 0 && (e.set(s.xref, i + 1), r & X.InChildOperation && t.add(s.xref));
    });
}
function ax(n, e) {
    ye(n, t => {
        if (!Ht(t) || t.kind !== I.ReadVariable)
            return;
        let s = e.get(t.xref);
        if (s !== void 0) {
            if (s === 0)
...
function ox(n, e, t, s) {
    ...
    return fe(t, (a, o) => {
        if (!Ht(a) || r || !i)
            return a;
        if (o & X.InChildOperation && s & ve.ViewContextRead)
            return a;
        switch (a.kind) {
            case I.ReadVariable:
                if (a.xref === n)
...
function Lf(n) {
    ...
    let s = Wa(1, e), r = Wa(2, t);
    return sn([new J("rf"), new J("ctx")], [...s, ...r], void 0, void 0, n.fnName);
}
...
function px(n) {
    ...
    if (e.length === 0 && t.length === 0)
        return null;
    let s = Wa(1, e), r = Wa(2, t);
    return sn([new J("rf"), new J("ctx")], [...s, ...r], void 0, void 0, n.root.fnName);
}
...
function gx(n, e, t) {
    let s = new Pa(n.componentName, t, Bf, Oe.DomOnly);
...
function Sx(n, e) {
    if (e.i18n !== void 0 && !(e.i18n instanceof Ie || e.i18n instanceof qt))
        throw Error(`Unhandled i18n metadata type for element: ${e.i18n.constructor.name}`);
    let t = n.job.allocateXrefId(), [s, r] = It(e.name), i = Mg(r, t, hf(s), e.i18n instanceof qt ? e.i18n : void 0, e.startSourceSpan, e.sourceSpan);
    n.create.push(i), Px(n, i, e), Of(i, e);
    let a = null;
    e.i18n instanceof Ie && (a = n.job.allocateXrefId(), n.create.push(ho(a, e.i18n, void 0, e.startSourceSpan))), ln(n, e.children);
    let o = Fg(t, e.endSourceSpan ?? e.startSourceSpan);
    n.create.push(o), a !== null && w.insertBefore(po(a, e.endSourceSpan ?? e.startSourceSpan), o);
}
function xx(n, e) {
    if (e.i18n !== void 0 && !(e.i18n instanceof Ie || e.i18n instanceof qt))
    ...
    e.tagName && ([r, s] = It(e.tagName));
    let i = e.i18n instanceof qt ? e.i18n : void 0, a = hf(r), o = s === null ? "" : mv(s, a), l = Dx(e) ? Ue.NgTemplate : Ue.Structural, c = ef(t.xref, l, s, o, a, i, e.startSourceSpan, e.sourceSpan);
    n.create.push(c), Lx(n, c, e, l), Of(c, e), ln(t, e.children);
    for (let { name: h, value: p } of e.variables)
        t.contextVariables.set(h, p !== "" ? p : "$implicit");
    if (l === Ue.NgTemplate && e.i18n instanceof Ie) {
...
function yx(n, e) {
    if (e.i18n !== void 0 && !(e.i18n instanceof qt))
        throw Error(`Unhandled i18n metadata type for element: ${e.i18n.constructor.name}`);
    let t = null;
    e.children.some(i => !(i instanceof oo) && (!(i instanceof Un) || i.value.trim().length > 0)) && (t = n.job.allocateView(n.xref), ln(t, e.children));
    let s = n.job.allocateXrefId(), r = Wg(s, e.selector, e.i18n, t?.xref ?? null, e.sourceSpan);
...
function Rf(n, e, t) {
    ...
    n.create.push(sf(i, "", t, e.sourceSpan));
    let a = n.job.compatibility ? null : e.sourceSpan;
    n.update.push(yg(i, new oe(s.strings, s.expressions.map(o => U(o, n.job, a)), r), e.sourceSpan));
}
function Cx(n, e) {
    let t = null, s = [];
...
function Ri(n, e, t, s, r) {
    if (t !== void 0 && !(t instanceof Ut))
        throw Error("Unhandled i18n metadata type for defer block");
    if (s === void 0)
        return null;
    let i = n.job.allocateView(n.xref);
    ln(i, s);
    let a = ef(i.xref, Ue.Block, null, `Defer${e}`, be.HTML, t, r, r);
    return n.create.push(a), a;
}
function _x(n, e) {
    let t = null;
    ...
    l.placeholderView = i?.xref ?? null, l.placeholderSlot = i?.handle ?? null, l.loadingSlot = r?.handle ?? null, l.errorSlot = a?.handle ?? null, l.placeholderMinimumTime = e.placeholder?.minimumTime ?? null, l.loadingMinimumTime = e.loading?.minimumTime ?? null, l.loadingAfterTime = e.loading?.afterTime ?? null, l.flags = kx(e), n.create.push(l);
    let c = [], h = [];
    Ao("hydrate", e.hydrateTriggers, c, h, n, o), Ao("none", e.triggers, c, h, n, o), Ao("prefetch", e.prefetchTriggers, c, h, n, o), c.some(g => g.modifier === "none") || h.some(g => g.modifier === "none") || c.push(hn(o, { kind: Z.Idle }, "none", null)), n.create.push(c), n.update.push(h);
}
function kx(n) { return Object.keys(n.hydrateTriggers).length > 0 ? 1 : null; }
function Ao(n, e, t, s, r, i) {
    if (e.idle !== void 0) {
...
function Tx(n, e) {
    if (e.i18n instanceof Ie && dx(e.i18n)) {
        let t = n.job.allocateXrefId();
...
function bx(n, e) {
    ...
    for (let A of e.contextVariables)
        A.value === "$index" && i.add(A.name), A.name === "$index" ? t.contextVariables.set("$index", A.value).set(s, A.value) : A.name === "$count" ? t.contextVariables.set("$count", A.value).set(r, A.value) : t.aliases.add({ kind: Se.Alias, name: null, identifier: A.name, expression: Ix(A, s, r) });
    let a = me(e.trackBy.span, e.sourceSpan), o = U(e.trackBy, n.job, a);
    ln(t, e.children);
    let l = null, c = null;
    e.empty !== null && (l = n.job.allocateView(n.xref), ln(l, e.empty.children), c = ja(n, l.xref, e.empty));
    let h = { $index: i, $implicit: e.item.name };
    if (e.i18n !== void 0 && !(e.i18n instanceof Ut))
        throw Error("AssertionError: Unhandled i18n metadata type or @for");
    if (e.empty?.i18n !== void 0 && !(e.empty.i18n instanceof Ut))
        throw Error("AssertionError: Unhandled i18n metadata type or @empty");
    let p = e.i18n, g = e.empty?.i18n, v = ja(n, t.xref, e), E = Rg(t.xref, l?.xref ?? null, v, o, h, c, p, g, e.startSourceSpan, e.sourceSpan);
    n.create.push(E);
    let C = U(e.expression, n.job, me(e.expression.span, e.sourceSpan)), b = Ng(E.xref, E.handle, C, e.sourceSpan);
    n.update.push(b);
}
function Ix(n, e, t) {
    switch (n.value) {
...
function U(n, e, t) {
    if (n instanceof Xe)
        return U(n.ast, e, t);
    if (n instanceof Jt)
        return n.receiver instanceof $t && !(n.receiver instanceof ss) ? new Ae(n.name) : new We(U(n.receiver, e, t), n.name, null, me(n.span, t));
    if (n instanceof Fs) {
...
function Lx(n, e, t, s) {
    ...
    for (let i of t.templateAttrs)
        if (i instanceof Os) {
            ...
            r.push(Fi(n, e.xref, i.type, i.name, gi(i.value), i.unit, i.securityContext, !0, s, Qt(i.i18n), i.sourceSpan));
    for (let i of t.attributes) {
        let a = Qn.securityContext(Zn, i.name, !0);
        r.push(Fi(n, e.xref, G.Attribute, i.name, i.value, null, a, !1, s, Qt(i.i18n), i.sourceSpan));
    }
    for (let i of t.inputs)
        r.push(Fi(n, e.xref, i.type, i.name, gi(i.value), i.unit, i.securityContext, !1, s, Qt(i.i18n), i.sourceSpan));
...
function Fi(n, e, t, s, r, i, a, o, l, c, h) {
    let p = typeof r == "string";
    if (l === Ue.Structural) {
        if (!o)
            switch (t) {
                case G.Property:
    ...
    let g = Ff.get(t);
    return l === Ue.NgTemplate && (t === G.Class || t === G.Style || t === G.Attribute && !p) && (g = T.Property), ls(e, g, s, Gl(n.job, r, c), i, a, p, o, l, c, h);
}
function mi(n, e, t) {
    e = gi(e);
    let s = new Array, r = e instanceof Rs ? e.expressions : [e];
    if (r.length === 0)
        throw new Error("Expected listener to have non-empty expression list.");
    let i = r.map(o => U(o, n.job, t)), a = i.pop();
    return s.push(...i.map(o => gt(new nt(o, o.sourceSpan)))), s.push(gt(new xe(a, a.sourceSpan))), s;
}
function $f(n, e, t) {
    e = gi(e);
    let s = new Array;
    ...
    let r = U(e, n.job, t), i = new Ae("$event"), a = new ka(r, i);
    return s.push(gt(new nt(a))), s.push(gt(new xe(i))), s;
}
...
function $x(n, e, t) {
    let s = [], r = [], i = _p(o => r.push(o), Fc);
    n.forEach(o => {
        let l = qf(o, e, { signalBased: f.viewQuerySignal, nonSignal: f.viewQuery });
        if (s.push(l.toStmt()), o.isSignal) {
            r.push(Zc);
            return;
        }
        let c = i(), h = y(f.loadQuery).callFn([]), p = y(f.queryRefresh).callFn([c.set(h)]), g = D(Qr).prop(o.propertyName).set(o.first ? c.prop("first") : c);
        r.push(p.and(g).toStmt());
    });
    let a = t ? `${t}_Query` : null;
    return sn([new J($c, ro), new J(Qr, null)], [za(1, s), za(2, Uf(r))], qe, null, a);
}
function Ox(n, e, t) {
    let s = [], r = [], i = _p(o => r.push(o), Fc);
    for (let o of n) {
    ...
    let a = t ? `${t}_ContentQueries` : null;
    return sn([new J($c, ro), new J(Qr, null), new J("dirIndex", null)], [za(1, s), za(2, Uf(r))], qe, null, a);
}
var Ga = class extends mf {
    ...
    parseInlineTemplateBinding(e, t, s, r, i, a, o, l) {
        let c = s.start.offset + Hx.length, h = this._parseTemplateBindings(e, t, s, c, r);
        for (let p of h) {
    ...
    createBoundElementProperty(e, t, s = !1, r = !0) {
        if (t.isLegacyAnimation)
            return new oa(t.name, G.LegacyAnimation, ne.NONE, t.expression, null, t.sourceSpan, t.keySpan, t.valueSpan);
        let i = null, a, o = null, l = t.name.split($i), c;
        if (l.length > 1)
            if (l[0] == Vx) {
                ...
                l[0] == qx ? (o = l[1], a = G.Class, c = [ne.NONE]) : l[0] == Ux ? (i = l.length > 2 ? l[2] : null, o = l[1], a = G.Style, c = [ne.STYLE]) : l[0] == _o && (o = t.name, a = G.Animation, c = [ne.NONE]);
        if (o === null) {
...
function oy(n, e, t, s) {
    let r = fy(e), i = [], a = bh(n, r, s);
    a !== null && i.push(new Gn(a.expression, P(t, n.children, n.children), a.expressionAlias, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.nameSpan, n.i18n));
    for (let p of e)
        if (fo.test(p.name)) {
            let g = bh(p, r, s);
            if (g !== null) {
    ...
    let o = i.length > 0 ? i[0].startSourceSpan : n.startSourceSpan, l = i.length > 0 ? i[i.length - 1].endSourceSpan : n.endSourceSpan, c = n.sourceSpan, h = i[i.length - 1];
    return h !== void 0 && (c = new L(o.start, h.sourceSpan.end)), { node: new fa(i, c, n.startSourceSpan, l, n.nameSpan), errors: r };
}
function ly(n, e, t, s) {
    let r = [], i = uy(n, r, s), a = null, o = null;
    for (let l of e)
        l.name === "empty" ? o !== null ? r.push(new N(l.sourceSpan, "@for loop can only have one @empty block")) : l.parameters.length > 0 ? r.push(new N(l.sourceSpan, "@empty block cannot have parameters")) : o = new zr(P(t, l.children, l.children), l.sourceSpan, l.startSourceSpan, l.endSourceSpan, l.nameSpan, l.i18n) : r.push(new N(l.sourceSpan, `Unrecognized @for loop block "${l.name}"`));
    if (i !== null)
        if (i.trackBy === null)
...
function cy(n, e, t) {
    let s = dy(n), r = n.parameters.length > 0 ? vi(n.parameters[0], t) : t.parseBinding("", !1, n.sourceSpan, 0), i = [], a = [], o = null;
...
function uy(n, e, t) {
    if (n.parameters.length === 0)
        return e.push(new N(n.startSourceSpan, "@for loop does not have an expression")), null;
    let [s, ...r] = n.parameters, i = my(s, e)?.match(ny);
    if (!i || i[2].trim().length === 0)
        return e.push(new N(s.sourceSpan, 'Cannot parse expression. @for loop expression must match the pattern "<identifier> of <expression>"')), null;
    let [, a, o] = i;
    xr.has(a) && e.push(new N(s.sourceSpan, `@for loop item name cannot be one of ${Array.from(xr).join(", ")}.`));
    let l = s.expression.split(" ")[0], c = new L(s.sourceSpan.start, s.sourceSpan.start.moveBy(l.length)), h = { itemName: new _n(a, "$implicit", c, c), trackBy: null, expression: vi(s, t, o), context: Array.from(xr, p => { let g = new L(n.startSourceSpan.end, n.startSourceSpan.end); return new _n(p, p, g, g); }) };
    for (let p of r) {
...
function py(n, e, t, s, r, i) {
    let a = e.split(","), o = t.start;
    for (let l of a) {
...
function dy(n) {
    ...
    if (n.parameters.length !== 1)
        return e.push(new N(n.startSourceSpan, "@switch block must have exactly one parameter")), e;
...
function bh(n, e, t) {
    if (n.parameters.length === 0)
        return e.push(new N(n.startSourceSpan, "Conditional block does not have an expression")), null;
    let s = vi(n.parameters[0], t), r = null;
...
function my(n, e) {
    let t = n.expression, s = /^\s$/, r = 0, i = 0, a = t.length - 1;
...
function Io({ expression: n, sourceSpan: e }, t, s, r) {
    let i = n.indexOf("when"), a = new L(e.start.moveBy(i), e.start.moveBy(i + 4)), o = Jc(n, e), l = Kc(n, e);
    if (i === -1)
...
function No({ expression: n, sourceSpan: e }, t, s, r) {
    let i = n.indexOf("on"), a = new L(e.start.moveBy(i), e.start.moveBy(i + 2)), o = Jc(n, e), l = Kc(n, e);
    if (i === -1)
...
var Jl = class {
    ...
    consumeTrigger(e, t) {
        let s = this.span.start.moveBy(this.start + e.index - this.tokens[0].index), r = new L(s, s.moveBy(e.strValue.length)), i = s.moveBy(this.token().end - e.index), a = e.index === 0, o = a ? this.onSourceSpan : null, l = a ? this.prefetchSpan : null, c = a ? this.hydrateSpan : null, h = new L(a ? this.span.start : s, i);
        try {
            switch (e.toString()) {
                case Ve.IDLE:
...
function Ey(n, e, t, s, r, i) {
    if (n.length > 0)
        throw new Error(`"${Ve.IDLE}" trigger cannot have parameters`);
    return new rl(e, t, s, r, i);
}
function Sy(n, e, t, s, r, i) {
    if (n.length !== 1)
        throw new Error(`"${Ve.TIMER}" trigger must have exactly one parameter`);
    let a = Xa(n[0]);
    if (a === null)
        throw new Error(`Could not parse time value of trigger "${Ve.TIMER}"`);
    return new al(a, e, t, s, r, i);
}
function xy(n, e, t, s, r, i) {
    if (n.length > 0)
        throw new Error(`"${Ve.IMMEDIATE}" trigger cannot have parameters`);
    return new il(e, t, s, r, i);
}
...
function My(n, e, t, s) {
    let r = [], { placeholder: i, loading: a, error: o } = Ry(e, r, t), { triggers: l, prefetchTriggers: c, hydrateTriggers: h } = Vy(n, s, r, i), p = n.endSourceSpan, g = n.sourceSpan.end;
    if (e.length > 0) {
        let C = e[e.length - 1];
        p = C.endSourceSpan, g = C.sourceSpan.end;
    }
    let v = new L(n.sourceSpan.start, g);
    return { node: new is(P(t, n.children, n.children), l, c, h, i, a, o, n.nameSpan, v, n.sourceSpan, n.startSourceSpan, p, n.i18n), errors: r };
}
function Ry(n, e, t) {
...
function Fy(n, e) {
    ...
    return new Ur(P(e, n.children, n.children), t, n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n);
}
function $y(n, e) {
    let t = null, s = null;
    ...
    return new Hr(P(e, n.children, n.children), t, s, n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n);
}
function Oy(n, e) {
    if (n.parameters.length > 0)
        throw new Error("@error block cannot have parameters");
    return new Wr(P(e, n.children, n.children), n.nameSpan, n.sourceSpan, n.startSourceSpan, n.endSourceSpan, n.i18n);
}
function Vy(n, e, t, s) {
    let r = {}, i = {}, a = {};
    for (let o of n.parameters)
        Ly.test(o.expression) ? Io(o, e, r, t) : By.test(o.expression) ? No(o, r, t, s) : Ty.test(o.expression) ? Io(o, e, i, t) : by.test(o.expression) ? No(o, i, t, s) : Iy.test(o.expression) ? Io(o, e, a, t) : Ny.test(o.expression) ? No(o, a, t, s) : Dy.test(o.expression) ? wy(o, a, t) : t.push(new N(o.sourceSpan, "Unrecognized trigger"));
    return a.never && Object.keys(a).length > 1 && t.push(new N(n.startSourceSpan, "Cannot specify additional `hydrate` triggers if `hydrate never` is present")), { triggers: r, prefetchTriggers: i, hydrateTriggers: a };
}
...
var ec = class {
    ...
    visitElement(e) {
        ...
        let r = hm(e.name), { attributes: i, boundEvents: a, references: o, variables: l, templateVariables: c, elementHasInlineTemplate: h, parsedProperties: p, templateParsedProperties: g, i18nAttrsMeta: v } = this.prepareAttributes(e.attrs, r), E = this.extractDirectives(e), C;
        s.nonBindable ? C = P(Mh, e.children).flat(1 / 0) : C = P(this, e.children, e.children);
        let b;
        if (s.type === Qe.NG_CONTENT) {
    ...
    visitExpansion(e) {
        ...
        return Object.keys(t.placeholders).forEach(i => {
            let a = t.placeholders[i];
            if (i.startsWith(ym)) {
                let o = i.trim(), l = this.bindingParser.parseInterpolationExpression(a.text, a.sourceSpan);
                s[o] = new $s(l, a.sourceSpan);
            }
            else
                r[i] = this._visitTextWithInterpolation(a.text, a.sourceSpan, null);
        }), new Sp(s, r, e.sourceSpan, t);
    }
    ...
    visitComponent(e) {
        let t = ji(e.i18n);
        if (t && (this.inI18nBlock && this.reportError("Cannot mark a component as translatable inside of a translatable section. Please remove the nested i18n marker.", e.sourceSpan), this.inI18nBlock = !0), e.tagName !== null && Hy.has(e.tagName))
            return this.reportError(`Tag name "${e.tagName}" cannot be used as a component tag`, e.startSourceSpan), null;
        let { attributes: s, boundEvents: r, references: i, templateVariables: a, elementHasInlineTemplate: o, parsedProperties: l, templateParsedProperties: c, i18nAttrsMeta: h } = this.prepareAttributes(e.attrs, !1);
        this.validateSelectorlessReferences(i);
        let p = this.extractDirectives(e), g;
        e.attrs.find(C => C.name === "ngNonBindable") ? g = P(Mh, e.children).flat(1 / 0) : g = P(this, e.children, e.children);
        let v = this.categorizePropertyAttributes(e.tagName, l, h), E = new vr(e.componentName, e.tagName, e.fullName, s, v.bound, r, p, g, i, e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.i18n);
        return o && (E = this.wrapInTemplate(E, c, a, h, !1, t)), t && (this.inI18nBlock = !1), E;
    }
    ...
    parseAttribute(e, t, s, r, i, a, o) {
        let l = Rh(t.name), c = t.value, h = t.sourceSpan, p = t.valueSpan ? t.valueSpan.fullStart.offset : h.fullStart.offset;
        function g(A, F, ee) { let V = t.name.length - l.length, de = A.start.moveBy(F.length + V), rr = de.moveBy(ee.length); return new L(de, rr, de, ee); }
        let v = l.match(qy);
        if (v) {
            if (v[Nh] != null) {
        ...
        let E = null;
        if (l.startsWith(un.BANANA_BOX.start) ? E = un.BANANA_BOX : l.startsWith(un.PROPERTY.start) ? E = un.PROPERTY : l.startsWith(un.EVENT.start) && (E = un.EVENT), E !== null && l.endsWith(E.end) && l.length > E.start.length + E.end.length) {
        ...
        let C = g(h, "", l);
        return this.bindingParser.parsePropertyInterpolation(l, c, h, t.valueSpan, s, r, C, t.valueTokens ?? null);
    }
    extractDirectives(e) {
        let t = e instanceof Ce ? e.tagName : e.name, s = [], r = new Set;
    ...
    visitElement(e) {
        let t = Hf(e);
        if (t.type === Qe.SCRIPT || t.type === Qe.STYLE || t.type === Qe.STYLESHEET)
            return null;
        let s = P(this, e.children, null);
        return new Ot(e.name, P(this, e.attrs), [], [], [], s, [], e.isSelfClosing, e.sourceSpan, e.startSourceSpan, e.endSourceSpan, e.isVoid);
    }
...
`, "\r", "	"];
function jf(n, e, t = {}) {
    let { interpolationConfig: s, preserveWhitespaces: r, enableI18nLegacyMessageIdFormat: i } = t, a = t.enableSelectorless ?? !1, o = Ya(s, a), c = new Ga().parse(n, e, ue(S({ leadingTriviaChars: Gy }, t), { tokenizeExpansionForms: !0, tokenizeBlocks: t.enableBlockSyntax ?? !0, tokenizeLet: t.enableLetSyntax ?? !0, selectorlessEnabled: a }));
    ...
    let h = c.rootNodes, p = !(t.preserveSignificantWhitespace ?? !0), g = new Oa(s, !r, i, void 0, t.preserveSignificantWhitespace, p), v = g.visitAllWithErrors(h);
    ...
    h = v.rootNodes, r || (h = P(new fi(!0, void 0, !1), h), g.hasI18nMeta && (h = P(new Oa(s, !1, void 0, void 0, !0, p), h)));
    let { nodes: E, errors: C, styleUrls: b, styles: A, ngContentSelectors: F, commentNodes: ee } = jy(h, o, { collectCommentNodes: !!t.collectCommentNodes });
    C.push(...c.errors, ...v.errors);
    let V = { interpolationConfig: s, preserveWhitespaces: r, errors: C.length > 0 ? C : null, nodes: E, styleUrls: b, styles: A, ngContentSelectors: F };
    return t.collectCommentNodes && (V.commentNodes = ee), V;
}
var Xy = new Qs;
...
function Qy(n, e, t) {
    let s = zf(n, e, t);
    Gf(s, n);
    let r = n.selector && Jn.parse(n.selector), i = r && r[0];
    if (i) {
        let E = i.getAttrs();
    ...
    let l = n.isStandalone && !n.hasDirectiveDependencies ? Oe.DomOnly : Oe.Full, c = mx(n.name, n.template.nodes, e, l, n.relativeContextFilePath, n.i18nUseExternalIds, n.defer, o, n.relativeTemplatePath, Mx());
    Df(c, _.Tmpl);
    let h = hx(c, e);
    ...
    n.encapsulation === null && (n.encapsulation = xt.Emulated);
    let p = !!n.externalStyles?.length;
    ...
    let g = y(f.defineComponent).callFn([s.toLiteralMap()], void 0, !0), v = Xf(n);
    return { expression: g, type: v, statements: [] };
}
...
function QA(n, e) {
    ...
    let s = jf(n, ""), i = new Ja(t).bind({ template: s.nodes }), a = i.getEagerlyUsedDirectives().map(c => c.selector), o = i.getUsedDirectives().map(c => c.selector), l = i.getEagerlyUsedPipes();
    return { directives: { regular: a, deferCandidates: Fh(o, a) }, pipes: { regular: l, deferCandidates: Fh(i.getUsedPipes(), l) } };
}
var Ja = class {
    directiveMatcher;
    ...
    bind(e) {
        ...
        let t = new Map, s = [], r = new Set, i = new Map, a = new Map, o = new Map, l = new Map, c = new Map, h = new Map, p = new Set, g = new Set, v = [];
        if (e.template) {
    ...
    visitComponent(e) {
        if (this.directiveMatcher instanceof zi) {
    ...
    visitElementOrTemplate(e) {
        if (this.directiveMatcher instanceof yr) {
            let t = [], s = Am(e);
    ...
    trackSelectorlessMatchesAndDirectives(e, t) {
        ...
        let s = (r, i, a) => { r[a].hasBindingPropertyName(i.name) && this.bindings.set(i, r); };
        for (let r of t)
    ...
    trackSelectorBasedBindingsAndDirectives(e, t) {
        ...
        let s = (r, i) => { let a = t.find(l => l[i].hasBindingPropertyName(r.name)), o = a !== void 0 ? a : e; this.bindings.set(r, o); };
        e.inputs.forEach(r => s(r, "inputs")), e.attributes.forEach(r => s(r, "inputs")), e instanceof Ke && e.templateAttrs.forEach(r => s(r, "inputs")), e.outputs.forEach(r => s(r, "outputs"));
    }
    visitVariable(e) { }
    visitReference(e) { }
    visitTextAttribute(e) { }
    ...
    maybeMap(e, t) {
        if (!(e.receiver instanceof $t) || e.receiver instanceof ss)
            return;
    ...
    getDeferredTriggerTarget(e, t) {
        if (!(t instanceof ua) && !(t instanceof ha) && !(t instanceof ca))
            return null;
        let s = t.reference;
        if (s === null) {
            let i = null;
        ...
        if (r instanceof Gr && this.getDefinitionNodeOfSymbol(r) !== e) {
...
function aC(n, e) {
    ...
    function s(i) {
        ...
        let a = i.namedEntities, o;
        return i.parentScope !== null ? o = new Map([...s(i.parentScope), ...a]) : o = new Map(a), t.set(i.rootNode, o), o;
    }
    let r = [n];
    for (; r.length > 0;) {
        let i = r.pop();
...
function Vh(n) {
    let e = yC(n.inputs || []), t = Bo(n.outputs || []), s = n.propMetadata, r = {}, i = {};
    for (let o in s)
        s.hasOwnProperty(o) && s[o].forEach(l => { wC(l) ? r[o] = { bindingPropertyName: l.alias || o, classPropertyName: o, required: l.required || !1, isSignal: !!l.isSignal, transformFunction: l.transform != null ? new H(l.transform) : null } : EC(l) && (i[o] = l.alias || o); });
    let a = n.hostDirectives?.length ? n.hostDirectives.map(o => typeof o == "function" ? { directive: ge(o), inputs: null, outputs: null, isForwardReference: !1 } : { directive: ge(o.directive), isForwardReference: !1, inputs: o.inputs ? Bo(o.inputs) : null, outputs: o.outputs ? Bo(o.outputs) : null }) : null;
    return ue(S({}, n), { typeArgumentCount: 0, typeSourceSpan: n.typeSourceSpan, type: ge(n.type), deps: null, host: S({}, mC(n.propMetadata, n.typeSourceSpan, n.host)), inputs: S(S({}, e), r), outputs: S(S({}, t), i), queries: n.queries.map($h), providers: n.providers != null ? new H(n.providers) : null, viewQueries: n.viewQueries.map($h), fullInheritance: !1, hostDirectives: a });
}
...
function cC(n, e, t) {
    let { template: s, interpolation: r, defer: i } = ed(n.template, n.type.name, t, n.preserveWhitespaces ?? !1, n.interpolation, n.deferBlockDependencies), a = [];
    if (n.dependencies)
...
function ed(n, e, t, s, r, i) {
    let a = r ? ga.fromArray(r) : ot, o = jf(n, t, { preserveWhitespaces: s, interpolationConfig: a });
    if (o.errors !== null) {
        let h = o.errors.map(p => p.toString()).join(", ");
        throw new Error(`Errors during JIT compilation of template for ${e}: ${h}`);
    }
    let c = new Ja(null).bind({ template: o.nodes });
    return { template: o, interpolation: a, defer: dC(c, i) };
}
function ws(n, e) {
...
function yC(n) {
    return n.reduce((e, t) => {
        if (typeof t == "string") {
            ...
            e[t.name] = { bindingPropertyName: t.alias || t.name, classPropertyName: t.name, required: t.required || !1, isSignal: !1, transformFunction: t.transform != null ? new H(t.transform) : null };
        return e;
    }, {});
}
...
var hc = class {
    ...
    visitExpansionCase(e, t) {
        let s = P(this, e.expression, t);
        if (this._mode === Pt.Merge)
    ...
    _visitElementLike(e, t) {
        ...
        let s = this._inI18nNode, r = this._inImplicitNode, i = [], a, o = e instanceof Ce ? e.tagName : e.name, l = LC(e), c = l ? l.value : "", h = this._implicitTags.some(g => o === g) && !this._inIcu && !this._isInTranslatableSection, p = !r && h;
        if (this._inImplicitNode = r || h, !this._isInTranslatableSection && !this._inIcu) {
            if (l || p) {
                this._inI18nNode = !0;
    ...
    _addMessage(e, t) {
        if (e.length == 0 || this._isEmptyAttributeValue(e) || this._isPlaceholderOnlyAttributeValue(e) || this._isPlaceholderOnlyMessage(e))
            return null;
        let { meaning: s, description: r, id: i } = Gh(t), a = this._createI18nMessage(e, s, r, i);
        return this._messages.push(a), a;
    }
    ...
    _translateAttributes(e) {
        let t = {}, s = [];
        return e.attrs.forEach(r => { r.name.startsWith(ur) && (t[r.name.slice(ur.length)] = Gh(r.value)); }), e.attrs.forEach(r => {
            if (!(r.name === rd || r.name.startsWith(ur)))
    ...
    _closeTranslatableSection(e, t) {
        ...
        if (t.reduce((i, a) => i + (a instanceof Nn ? 0 : 1), 0) == 1)
...
function Gh(n) {
    ...
    let e = n.indexOf(bC), t = n.indexOf(TC), [s, r] = e > -1 ? [n.slice(0, e), n.slice(e + 2)] : [n, ""], [i, a] = t > -1 ? [s.slice(0, t), s.slice(t + 1)] : ["", s];
    return { meaning: i, description: a, id: r.trim() };
}
...
`)}`);
    ...
    visitTagPlaceholder(e, t) {
        let s = XC(e.tag);
        if (e.isVoid)
            return [new M(zt, { id: e.startName, ctype: s, "equiv-text": `<${e.tag}/>` })];
        let r = new M(zt, { id: e.startName, ctype: s, "equiv-text": `<${e.tag}>` }), i = new M(zt, { id: e.closeName, ctype: s, "equiv-text": `</${e.tag}>` });
...
`)}`);
    ...
    visitTagPlaceholder(e, t) {
        let s = tA(e.tag);
        if (e.isVoid)
            return [new M(jn, { id: (this._nextPlaceholderId++).toString(), equiv: e.startName, type: s, disp: `<${e.tag}/>` })];
        let r = new M(gc, { id: (this._nextPlaceholderId++).toString(), equivStart: e.startName, equivEnd: e.closeName, type: s, dispStart: `<${e.tag}>`, dispEnd: `</${e.tag}>` }), i = [].concat(...e.children.map(a => a.visit(this)));
        return i.length ? i.forEach(a => r.children.push(a)) : r.children.push(new Q("")), [r];
    }
...
`));
    ...
    visitTagPlaceholder(e, t) {
        let s = `${e.tag}`, r = Object.keys(e.attrs).map(a => `${a}="${e.attrs[a]}"`).join(" ");
        if (e.isVoid)
            return `<${s} ${r}/>`;
        let i = e.children.map(a => a.visit(this)).join("");
        return `<${s} ${r}>${i}</${s}>`;
    }
    ...
    _convertToText(e) {
        ...
        let i = r.map(o => o.visit(this)).join(""), a = this._contextStack.pop();
        return this._srcMsg = a.msg, this._mapper = a.mapper, i;
    }
    _addError(e, t) { this._errors.push(new N(e.sourceSpan, t)); }
}, Kh = class {
    _htmlParser;
    getTagDefinition;
    _translationBundle;
    constructor(e, t, s, r = Ns.Warning, i) {
...
var ep = class {
    ...
    updateFromTemplate(e, t, s) {
        ...
        if (r.errors.length)
            return r.errors;
        let i = this._preserveWhitespace ? r.rootNodes : wt(new fi(!1), r.rootNodes), a = IC(i, s, this._implicitTags, this._implicitAttrs, this._preserveWhitespace);
        return a.errors.length ? a.errors : (this._messages.push(...a.messages), []);
    }
...
function s_(n, e) {
    if (e === null || e.length === 0)
        return oA(n);
    let t = new ae, s = new ae;
    return s.set("decorators", n.decorators), s.set("ctorParameters", n.ctorParameters ?? d(null)), s.set("propDecorators", n.propDecorators ?? d(null)), t.set("minVersion", d(aA)), t.set("version", d("20.3.7")), t.set("ngImport", y(f.core)), t.set("type", n.type), t.set("resolveDeferredDeps", ud(e)), t.set("resolveMetadata", ie(e.map(r => new J(r.symbolName, He)), s.toLiteralMap())), y(f.declareClassMetadataAsync).callFn([t.toLiteralMap()]);
}
...
function fA(n) {
    ...
    return e.length === 0 ? null : he(e.map(t => {
        let s = n[t], r = s.bindingPropertyName, i = r !== t, a;
        if (i || s.transformFunction !== null) {
            ...
            a = Me(r);
        return { key: t, quoted: Rc.test(t), value: a };
    }));
}
...
function dA(n, e, t) {
    let s = pd(n), r = new kc;
    if (z(r, e.nodes), s.set("template", mA(e, t)), t.isInline && s.set("isInline", d(!0)), r.hasBlocks && s.set("minVersion", d("17.0.0")), s.set("styles", gr(n.styles, d)), s.set("dependencies", vA(n)), s.set("viewProviders", n.viewProviders), s.set("animations", n.animations), n.changeDetection !== null) {
...
function mA(n, e) {
    ...
    let t = e.content, s = new ei(t, e.sourceUrl), r = new os(s, 0, 0, 0), i = gA(s, t), a = new L(r, i);
    return d(t, null, a);
}
function gA(n, e) {
...
function SA(n) {
    let e = new ae;
    if (e.set("minVersion", d(EA)), e.set("version", d("20.3.7")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.providedIn !== void 0) {
...
function AA(n) {
    ...
    return e.set("minVersion", d(CA)), e.set("version", d("20.3.7")), e.set("ngImport", y(f.core)), e.set("type", n.type.value), n.bootstrap.length > 0 && e.set("bootstrap", Ct(n.bootstrap, n.containsForwardDecls)), n.declarations.length > 0 && e.set("declarations", Ct(n.declarations, n.containsForwardDecls)), n.imports.length > 0 && e.set("imports", Ct(n.imports, n.containsForwardDecls)), n.exports.length > 0 && e.set("exports", Ct(n.exports, n.containsForwardDecls)), n.schemas !== null && n.schemas.length > 0 && e.set("schemas", R(n.schemas.map(t => t.value))), n.id !== null && e.set("id", n.id), e;
}
var _A = "14.0.0";
...
function f_(n, e, t) {
    let s = "\u0275\u0275namespaces", r = [t.className, s].map(a => new J(a, He)), i = [];
    for (let a of t.localDependencies)
        r.push(new J(a.name));
    for (let a = 0; a < t.namespaceDependencies.length; a++)
        i.push(new ce(t.namespaceDependencies[a].assignedName, D(s).key(d(a)), He, le.Final));
    i.push(...e);
    for (let a of n)
