...
import { b as c, i as m, n as g } from "@nf-internal/chunk-IR6MR6UK";
...
var p = new l("MAT_ACCORDION"), w = new l("MAT_EXPANSION_PANEL"), ae = (() => {
    class a {
        _template = o(P);
    ...
    return a;
})(), E = new l("MAT_EXPANSION_PANEL_DEFAULT_OPTIONS"), ie = (() => {
    class a extends O {
        ...
        static \u0275fac = function (n) { return new (n || a); };
        static \u0275cmp = e.\u0275\u0275defineComponent({ type: a, selectors: [["mat-expansion-panel"]], contentQueries: function (n, i, s) {
                if (n & 1 && e.\u0275\u0275contentQuery(s, ae, 5), n & 2) {
                    let r;
                    e.\u0275\u0275queryRefresh(r = e.\u0275\u0275loadQuery()) && (i._lazyContent = r.first);
                }
            }, viewQuery: function (n, i) {
                if (n & 1 && (e.\u0275\u0275viewQuery(U, 5), e.\u0275\u0275viewQuery(G, 5)), n & 2) {
                    let s;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class a extends N {
        ...
        static \u0275dir = e.\u0275\u0275defineDirective({ type: a, selectors: [["mat-accordion"]], contentQueries: function (n, i, s) {
                if (n & 1 && e.\u0275\u0275contentQuery(s, oe, 5), n & 2) {
                    let r;
