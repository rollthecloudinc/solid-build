...
import { f as m } from "@nf-internal/chunk-U56RZWEM";
...
var z = ["button"], U = ["*"];
function H(l, b) {
    if (l & 1 && (a.\u0275\u0275elementStart(0, "div", 2), a.\u0275\u0275element(1, "mat-pseudo-checkbox", 6), a.\u0275\u0275elementEnd()), l & 2) {
...
var T = new y("MatButtonToggleGroup"), j = { provide: P, useExisting: V(() => W), multi: !0 }, d = class {
    ...
    class l {
        ...
        _keydown(t) {
            if (this.multiple || this.disabled || G(t))
                return;
            let e = t.target.id, n = this._buttonToggles.toArray().findIndex(g => g.buttonId === e), i = null;
            switch (t.keyCode) {
                case O:
                case E:
        ...
        _initializeTabIndex() {
            if (this._buttonToggles.forEach(t => { t.tabIndex = -1; }), this.selected)
        ...
        _setSelectionByValue(t) {
            if (this._rawValue = t, !this._buttonToggles)
                return;
            let o = this._buttonToggles.toArray();
            if (this.multiple && t ? (Array.isArray(t), this._clearSelection(), t.forEach(e => this._selectValue(e, o))) : (this._clearSelection(), this._selectValue(t, o)), !this.multiple && o.every(e => e.tabIndex === -1)) {
                for (let e of o)
                    if (!e.disabled) {
                        e.tabIndex = 0;
                        break;
        ...
        static \u0275dir = a.\u0275\u0275defineDirective({ type: l, selectors: [["mat-button-toggle-group"]], contentQueries: function (o, e, n) {
                if (o & 1 && a.\u0275\u0275contentQuery(n, I, 5), o & 2) {
                    let i;
    ...
    class l {
        ...
        _onButtonClick() {
            if (this.disabled)
                return;
            let t = this.isSingleSelector() ? !0 : !this._checked;
            if (t !== this._checked && (this._checked = t, this.buttonToggleGroup && (this.buttonToggleGroup._syncButtonToggle(this, this._checked, !0), this.buttonToggleGroup._onTouched())), this.isSingleSelector()) {
