import { A as $, B as R, C as B, D as G, E as V, F as q, G as z, H, I as J, J as K, K as Q, L as X, a as i, b, c as v, d, e as E, f as p, g as k, h as D, i as N, j as P, k as j, l as m, m as w, n as g, o as T, p as y, q as O, r as F, s as h, t as x, u as I, v as L, w as W, x as M, y as U, z as _ } from "@nf-internal/chunk-EYXY3V65";
import { a, b as l } from "@nf-internal/chunk-6MDQTQU3";
var c = { header: (e, o) => {
        if (!u(e) || o?.ngSkipFormatting)
            return null;
        let n;
        try {
            n = e();
        ...
        let r = "computation" in e[i] ? "Computed" : "Signal", s = n === null || !Array.isArray(n) && typeof n != "object";
        return ["span", {}, ["span", {}, `${r}(`], u(n) ? c.header(n, o) : s && n !== void 0 && typeof n != "function" ? ["object", { object: n }] : Y(n), ["span", {}, ")"]];
    }, hasBody: (e, o) => {
        if (!u(e))
            return !1;
        try {
...
function ne(e, o, n) {
    let r = Object.create(Z);
    n && (r.consumerAllowSignalWrites = !0), r.fn = e, r.schedule = o;
    let s = t => { r.cleanupFn = t; };
    function S(t) { return t.fn === null && t.schedule === null; }
    function C(t) { S(t) || (h(t), t.cleanupFn(), t.fn = null, t.schedule = null, t.cleanupFn = f); }
    let A = () => {
        if (r.fn === null)
            return;
        if (d())
            throw new Error("");
        if (r.dirty = !1, r.version > 0 && !F(r))
            return;
        r.version++;
        let t = g(r);
        try {
