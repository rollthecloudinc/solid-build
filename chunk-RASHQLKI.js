...
import { a as I, c as R, d as L } from "@nf-internal/chunk-IOPJEBHZ";
import { b as M } from "@nf-internal/chunk-ZBGE3AVM";
import { a as E, b as V, c as T } from "@nf-internal/chunk-C2A5IV4Z";
import { b as O, d as w, i as u, w as S } from "@nf-internal/chunk-IR6MR6UK";
...
var He = (() => {
    ...
    class r {
        ...
        _scrollableContainsElement(e, t) {
            let i = F(t), n = e.getElementRef().nativeElement;
            do
                if (i == n)
                    return !0;
    ...
    class r {
        ...
        _document = s(U);
        constructor() {
            let e = s(v), t = s(j).createRenderer(null, null);
            e.runOutsideAngular(() => {
    ...
    class r extends z {
        ...
        _doChangeDetection() {
            this._isDestroyed || this.ngZone.run(() => {
                this._changeDetectorRef.markForCheck(), this._contentWrapper.nativeElement.style.transform = this._renderedContentTransform, te(() => {
