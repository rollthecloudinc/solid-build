...
var _e = class {
    ...
    get(t, n = Yt, o) {
        if (Go(this), t.hasOwnProperty(Xp))
            return t[Xp](this);
        let r = Kt(o), i, s = Ke(this), a = Ee(void 0);
        try {
            if (!(r & 4)) {
    ...
    resolveInjectorInitializers() {
        let t = An(null), n = Ke(this), o = Ee(void 0), r;
        try {
    ...
    processProvider(t) {
        t = x(t);
        let n = Jt(t) ? t : x(t && t.provide), o = bM(t);
        if (!Jt(t) && t.multi === !0) {
...
function Oc(e) {
    let t = Xo(e), n = t !== null ? t.factory : Pt(e);
    if (n !== null)
        return n;
    if (e instanceof C)
        throw new T(204, !1);
...
function Hi(e, t) {
    let n;
    e instanceof Xt ? (Go(e), n = e) : n = new Rc(e);
    let o, r = Ke(n), i = Ee(void 0);
    try {
        return t();
    }
    finally {
...
function Vt(e) {
    e[Ge].changeDetectionScheduler?.notify(0);
    let t = ft(e);
    for (; t !== null && !(t[M] & 8192 || (t[M] |= 8192, !$i(t)));)
        t = ft(t);
}
function ur(e, t) {
    if (nt(e))
...
}, st = new C("", { providedIn: "root", factory: () => { let e = E(_e), t; return n => { e.destroyed && !t ? setTimeout(() => { throw n; }) : (t ??= e.get(Xe), t.handleError(n)); }; } }), wl = { provide: Pe, useValue: () => void E(Xe), multi: !0 }, FM = new C("", { providedIn: "root", factory: () => {
        if (typeof ngServerMode < "u" && ngServerMode)
            return;
        let e = E(Sh).defaultView;
        if (!e)
            return;
        let t = E(st), n = i => { t(i.reason), i.preventDefault(); }, o = i => { i.error ? t(i.error) : t(new Error(i.message, { cause: i })), i.preventDefault(); }, r = () => { e.addEventListener("unhandledrejection", n), e.addEventListener("error", o); };
        typeof Zone < "u" ? Zone.root.run(r) : r(), E(Fe).onDestroy(() => { e.removeEventListener("error", o), e.removeEventListener("unhandledrejection", n); });
    } });
...
var gr = (() => {
    ...
    flushQueue(t) {
        let n = !1;
        for (let o of t)
            o.dirty && (this.dirtyEffectCount--, n = !0, o.run());
        return n;
    }
};
...
function zr(e, t, n, o, r) {
    return ct(() => {
        ...
        function s(...a) {
            ...
            let c = new s(...a);
            return function (u) { return r && r(u, ...a), (u.hasOwnProperty(zn) ? u[zn] : Object.defineProperty(u, zn, { value: [] })[zn]).push(c), u; };
        }
...
function Co(e, t, n) {
    return ct(() => {
        ...
        function r(...i) {
            ...
            function a(c, l, u) {
                let d = c.hasOwnProperty(Qn) ? c[Qn] : Object.defineProperty(c, Qn, { value: [] })[Qn];
                for (; d.length <= u;)
                    d.push(null);
    ...
    return ct(() => {
        ...
        function i(...s) {
            ...
            function c(l, u) {
                ...
                let d = l.constructor, f = d.hasOwnProperty(Zn) ? d[Zn] : Object.defineProperty(d, Zn, { value: {} })[Zn];
...
var Is = class {
    ...
    _zipTypesAndAnnotations(t, n) {
        let o;
        typeof t > "u" ? o = or(n.length) : o = or(t.length);
    ...
    _ownParameters(t, n) {
        ...
        let i = t.hasOwnProperty(Qn) && t[Qn], s = this._reflect && this._reflect.getOwnMetadata && this._reflect.getOwnMetadata("design:paramtypes", t);
        return s || i ? this._zipTypesAndAnnotations(s, i) : or(t.length);
    }
    parameters(t) {
        if (!vr(t))
            return [];
        let n = es(t), o = this._ownParameters(t, n);
    ...
    annotations(t) {
        if (!vr(t))
            return [];
        let n = es(t), o = this._ownAnnotations(t, n) || [];
...
function Xg(e, t, n, o) {
    let r = o !== void 0 ? e[rn] & 65535 : 0, i = o ?? -1, s = t.length - 1, a = 0;
    for (let c = r; c < s; c++)
...
function Ns(e, t) {
    ...
    if (n !== -1)
        return n;
    let o = t[m];
    o.firstCreatePass && (e.injectorIndex = t.length, Ol(o.data, e), Ol(t, null), Ol(o.blueprint, null));
    let r = id(e, t), i = e.injectorIndex;
    if (nm(r)) {
...
function lN(e) {
    ...
    return typeof t == "number" ? t >= 0 ? t & om : uN : t;
}
...
function um(e) {
    return ct(() => {
        let t = e.prototype.constructor, n = t[Je] || ru(t), o = Object.prototype, r = Object.getPrototypeOf(e.prototype).constructor;
        for (; r && r !== o;) {
            let i = r[Je] || ru(r);
            if (i && i !== n)
                return i;
...
function dN(e, t, n, o, r) {
    let i = e, s = t;
    for (; i !== null && s !== null && s[M] & 2048 && !tt(s);) {
...
function pN(e, t) {
    let n = null, o = null;
    e.hasOwnProperty(xn) || Object.defineProperty(e, xn, { get: () => (n === null && (n = ne({ usage: 0, kind: "injectable", type: e }).compileInjectable(Rh, `ng:///${e.name}/\u0275prov.js`, vN(e, t))), n) }), e.hasOwnProperty(Je) || Object.defineProperty(e, Je, { get: () => {
            if (o === null) {
...
function xN(e) {
    let t = we(e), n = t ? t.lView : null;
    if (n === null)
        return null;
    let o;
    for (; n[m].type === 2 && (o = ft(n));)
        n = o;
    return tt(n) ? null : n[H];
}
function kN(e) {
    let t = we(e), n = t ? t.lView : null;
    if (n === null)
        return ie.NULL;
    let o = n[m].data[t.nodeIndex];
    return new $t(o, n);
}
function PN(e) {
    let t = we(e), n = t ? t.lView : null;
    if (n === null)
        return [];
    let o = n[m], r = o.data[t.nodeIndex], i = [], s = r.providerIndexes & 1048575, a = r.directiveEnd;
    for (let c = s; c < a; c++) {
        let l = o.data[c];
...
function LN(e) {
    ...
    if (n === null)
        return [];
    let o = n[m], r = t.nodeIndex;
    return o?.data[r] ? (t.directives === void 0 && (t.directives = Im(r, n)), t.directives === null ? [] : [...t.directives]) : [];
}
...
function VN(e) {
    let t = we(e), n = t === null ? null : t.lView;
    if (n === null)
        return [];
    let o = n[m], r = n[Lt], i = o.cleanup, s = [];
    if (i && r)
...
var bo = "ngb";
function md(e, t, n = null) {
    if (t.length === 0 || e.nodeType !== Node.ELEMENT_NODE)
        return;
    let o = e.getAttribute(qn.JSACTION), r = t.reduce((s, a) => (o?.indexOf(a) ?? -1) === -1 ? s + a + ":;" : s, "");
    e.setAttribute(qn.JSACTION, `${o ?? ""}${r}`);
    let i = n ?? "";
    i !== "" && r.length > 0 && e.setAttribute(bo, i);
}
...
function rw(e, t, n = !1) {
    ...
    return n && (l.firstChild = e, ua(l, 0, e.nextSibling)), a ? e.setAttribute(to, a) : e.removeAttribute(to), l;
}
function $m() { Um = rw; }
...
function sw(e) {
    let t = Nt(), n = t.createNodeIterator(e, NodeFilter.SHOW_COMMENT, { acceptNode(i) { let s = iw(i); return s === "ngetn" || s === "ngtns" ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_REJECT; } }), o, r = [];
    for (; o = n.nextNode();)
        r.push(o);
    for (let i of r)
...
function fw(e, t) {
    let n = t.get(_t), r = t.get(Mn).get(la, {}), i = !1, s = e, a = null, c = [];
    for (; !i && s;) {
        i = n.has(s);
...
function pw(e) {
    let t = e.body.querySelectorAll("[jsaction]"), n = new Set, o = [Rs.join(":;"), bs.join(":;")].join("|");
    for (let r of t) {
...
function ev(e) {
    for (let o of e.body.childNodes)
        if (Fl(o))
            return;
    let t = $h(e.body.previousSibling);
    if (Fl(t))
        return;
    let n = $h(e.head.lastChild);
    if (!Fl(n))
        throw new T(-507, !1);
}
function tv(e, t) {
...
function nv() {
    if (ts === void 0 && (ts = null, Se.trustedTypes))
        try {
...
var ns;
function Nd() {
    if (ns === void 0 && (ns = null, Se.trustedTypes))
        try {
...
var iv = bt("area,br,col,hr,img,wbr"), sv = bt("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"), av = bt("rp,rt"), _w = ti(av, sv), Sw = ti(sv, bt("address,article,aside,blockquote,caption,center,del,details,dialog,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,main,map,menu,nav,ol,pre,section,summary,table,ul")), bw = ti(av, bt("a,abbr,acronym,audio,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,picture,q,ruby,rp,rt,s,samp,small,source,span,strike,strong,sub,sup,time,track,tt,u,var,video")), yu = ti(iv, Sw, bw, _w), wd = bt("background,cite,href,itemtype,longdesc,poster,src,xlink:href"), Rw = bt("abbr,accesskey,align,alt,autoplay,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,controls,coords,datetime,default,dir,download,face,headers,height,hidden,hreflang,hspace,ismap,itemscope,itemprop,kind,label,lang,language,loop,media,muted,nohref,nowrap,open,preload,rel,rev,role,rows,rowspan,rules,scope,scrolling,shape,size,sizes,span,srclang,srcset,start,summary,tabindex,target,title,translate,type,usemap,valign,value,vspace,width"), Aw = bt("aria-activedescendant,aria-atomic,aria-autocomplete,aria-busy,aria-checked,aria-colcount,aria-colindex,aria-colspan,aria-controls,aria-current,aria-describedby,aria-details,aria-disabled,aria-dropeffect,aria-errormessage,aria-expanded,aria-flowto,aria-grabbed,aria-haspopup,aria-hidden,aria-invalid,aria-keyshortcuts,aria-label,aria-labelledby,aria-level,aria-live,aria-modal,aria-multiline,aria-multiselectable,aria-orientation,aria-owns,aria-placeholder,aria-posinset,aria-pressed,aria-readonly,aria-relevant,aria-required,aria-roledescription,aria-rowcount,aria-rowindex,aria-rowspan,aria-selected,aria-setsize,aria-sort,aria-valuemax,aria-valuemin,aria-valuenow,aria-valuetext"), cv = ti(wd, Rw, Aw), Ow = bt("script,style,template"), Eu = class {
    ...
    startElement(t) {
        let n = zh(t).toLowerCase();
        if (!yu.hasOwnProperty(n))
            return this.sanitizedSomething = !0, !Ow.hasOwnProperty(n);
...
function Sd(e) {
    let t = ni();
    if (t)
        return Wh(t.sanitize(wn.RESOURCE_URL, e) || "");
    if (Oo(e, "ResourceURL"))
        return Wh(St(e));
    throw new T(904, !1);
}
function pv(e) {
    let t = ni();
    if (t)
        return Gh(t.sanitize(wn.SCRIPT, e) || "");
    if (Oo(e, "Script"))
        return Gh(St(e));
    throw new T(905, !1);
}
...
function t_(e, t, n) {
    let o = 4, r = e.attrs, i = r !== null ? r_(r) : 0, s = !1;
...
function g_(e) {
    let t = no(e, "transition-property"), n = no(e, "transition-duration"), o = no(e, "transition-delay"), r = { propertyName: "", duration: 0, animationName: void 0 };
...
function m_(e) {
    let t = no(e, "animation-name"), n = no(e, "animation-delay"), o = no(e, "animation-duration"), r = { animationName: "", propertyName: void 0, duration: 0 };
    for (let i = 0; i < t.length; i++) {
        let s = Os(n[i]) + Os(o[i]);
...
function Ov(e, t, n) {
    if (!n)
        return;
    let o = e.getAnimations();
    return o.length === 0 ? v_(e, t) : y_(e, t, o);
}
function y_(e, t, n) {
    let o = { animationName: void 0, propertyName: void 0, duration: 0 };
    for (let r of n) {
...
var xv = !1, Tu = class extends Ti {
    ...
    subscribe(t, n, o) {
        ...
        return t instanceof Di && t.add(a), a;
    }
    wrapInTimeout(t) {
        return n => {
...
var Fd = "isAngularZone", xs = Fd + "_ID", E_ = 0, $ = class e {
    ...
    onError = new Et(!1);
    constructor(t) {
        let { enableLongStackTrace: n = !1, shouldCoalesceEventChangeDetection: o = !1, shouldCoalesceRunChangeDetection: r = !1, scheduleInRootZone: i = xv } = t;
        if (typeof Zone > "u")
            throw new T(908, !1);
    ...
    runTask(t, n, o, r) {
        let i = this._inner, s = i.scheduleEventTask("NgZoneEvent: " + r, t, I_, un, un);
        try {
...
function D_(e) {
    ...
    function t() { kv(() => { e.callbackScheduled = !1, Cu(e), e.isCheckStableRunning = !0, jd(e), e.isCheckStableRunning = !1; }); }
    e.scheduleInRootZone ? Zone.root.run(() => { t(); }) : e._outer.run(() => { t(); }), Cu(e);
}
function T_(e) {
    let t = () => { D_(e); }, n = E_++;
    e._inner = e._inner.fork({ name: "angular", properties: { [Fd]: !0, [xs]: n, [xs + n]: !0 }, onInvokeTask: (o, r, i, s, a, c) => {
            if (C_(c))
...
var ya = (() => {
    ...
    class e {
        ...
        execute() {
            ...
            this.deferredRegistrations.size > 0 && this.scheduler.notify(7), this.deferredRegistrations.clear(), n && V(17);
        }
...
function ii(e, t) {
    if (nt(t))
        return;
    let n = t[w];
    n.destroyNode && Da(e, t, n, 3, null, null), S_(t);
}
function jl(e, t) {
    if (nt(t))
        return;
...
function ng(e, t, n, o) {
    let r = e?.[gt];
    if (r == null || r.leave == null || !r.leave.has(t.index))
        return o(!1);
    if (r.skipLeaveAnimations)
        return r.skipLeaveAnimations = !1, o(!1);
    e && lo.add(e), Vv(n, () => {
        if (r.leave && r.leave.has(t.index)) {
...
function Wd(e, t, n, o) {
    let r = Gd(e, o, t), i = t[w], s = o.parent || t[se], a = $v(s, o, t);
    if (r != null)
        if (Array.isArray(n))
...
function Qv(e, t, n, o, r, i) {
    let s = n[J], c = s[se].projection[o.projection];
    if (Array.isArray(c))
...
function x_(e, t, n, o, r, i, s) {
    let a = o[We], c = k(o);
    a !== c && Jn(t, e, n, i, a, r, s);
    for (let l = W; l < o.length; l++) {
        let u = o[l];
        Da(u[m], u, e, t, i, a);
    }
}
function k_(e, t, n, o, r) {
    if (t)
...
function V_(e, t, n) {
    let o = n.directiveStart, r = n.directiveEnd;
    Me(n) && p_(t, n, e.data[o + n.componentOffset]), e.firstCreatePass || Ns(n, t);
...
function H_(e, t, n) {
    let o = n.directiveStart, r = n.directiveEnd, i = n.index, s = Th();
    try {
        Ht(i);
        for (let a = o; a < r; a++) {
...
var X_ = Te(q({}, Tc), { consumerIsAlwaysLive: !0, kind: "template", consumerMarkedDirty: e => {
        let t = ft(e.lView);
        for (; t && !ny(t[m]);)
            t = ft(t);
        t && qi(t);
    }, consumerOnSignalRead() { this.lView[Ae] = this; } });
...
var eS = 100;
function ry(e, t = 0) {
    let o = e[Ge].rendererFactory, r = !1;
    r || o.begin?.();
    try {
        tS(e, t);
    }
...
function iy(e, t, n, o) {
    ...
    i || (ny(e) ? (l = Q_(t), c = qo(l)) : Ci() === null ? (a = !1, l = J_(t), c = qo(l)) : t[Ae] && (kt(t[Ae]), t[Ae] = null));
    try {
...
function Nu(e, t) {
    let o = e[m], r = e[M], i = e[Ae], s = !!(t === 0 && r & 16);
    if (s ||= !!(r & 64 && t === 0), s ||= !!(r & 1024), s ||= !!(i?.dirty && wi(i)), s ||= !1, i && (i.dirty = !1), e[M] &= -9217, s)
...
function si(e, t) {
    let n = ml() ? 64 : 1088;
    for (e[Ge].changeDetectionScheduler?.notify(t); e;) {
        e[M] |= n;
        let o = ft(e);
        if (tt(e) && !o)
            return e;
...
var Gt = class {
    ...
    attachToAppRef(t) {
        if (this._attachedToViewContainer)
            throw new T(902, !1);
        this._appRef = t;
        let n = tt(this._lView), o = this._lView[pt];
        o !== null && !n && dy(o, this._lView), Gi(this._lView);
    }
};
...
function RS() {
    ...
    function t(n, o) {
        for (e.lView = o; e.stack.length;)
            e.stack.pop();
        return ef(e, n.value, o), Ls.bind(null, e);
    }
    return t;
}
...
function kS(e) {
    let t = e.match(OS), [n, o, r, i] = t, s = o ? parseInt(o, 10) : r, a = [];
...
function Dy(e, t, n) {
    ...
    for (; o !== null && (Fo(o, t) || n?.has(o.index));)
        o = o.parent;
    o === null || !(o.type & 3) ? (r = s = ld, i = t[J][U]) : (r = o.index, i = k(t[r]), s = b(r - I));
    let a = k(t[e.index]);
    if (e.type & 44) {
        let l = hn(t, e);
        l && (a = l);
...
function Ty(e, t) {
    let n = e.createNodeIterator(t, NodeFilter.SHOW_COMMENT, { acceptNode: VS }), o, r = new Map;
    for (; o = n.nextNode();) {
...
function Sy(e, t, n) {
    ...
    return Su(e, s, n, r.ast), s.caseQueue.length === 0 && s.disconnectedNodes.size === 0 && s.disjointNodes.size === 0 ? null : s;
}
function Su(e, t, n, o) {
    let r = null;
    for (let i of o) {
...
function GS(e, t, n, o) {
    let r = e[ae];
    if (!r || !Oa() || n && (mm(n) || da(r, n.index - I)))
        return;
    let i = e[m], s = i.data[t];
    function a() {
        if (vy(o)) {
            let p = ai(r, i, e, n);
    ...
    let c = a(), l = Qm(r) ?? new Set, u = r.i18nNodes ??= new Map, d = r.data[ra]?.[t - I] ?? [], f = r.dehydratedIcuData ??= new Map;
    Wn({ hydrationInfo: r, lView: e, i18nNodes: u, disconnectedNodes: l, caseQueue: d, dehydratedIcuData: f }, { currentNode: c, isConnected: !0 }, s.ast), r.disconnectedNodes = l.size === 0 ? null : l;
}
function Wn(e, t, n) {
    if (Array.isArray(n)) {
        let o = t;
...
function xa(e) {
    let t = e[Oe] ?? [], o = e[z][w], r = [];
    for (let i of t)
        i.data[ia] !== void 0 ? r.push(i) : Ay(i, o);
    e[Oe] = r;
}
function YS(e) {
    let { lContainer: t } = e, n = t[Oe];
    if (n === null)
        return;
    let r = t[z][w];
    for (let i of n)
...
function eb(e, t, n) {
    if (t.tView.ssrId === null)
        return null;
    let o = jr(e, t.tView.ssrId);
    return n[m].firstUpdatePass && o === null && tb(n, t), o;
}
...
function ib(e, t) {
    if (Ko(e) && (e = x(e), !e))
        throw new Error(`Expected forwardRef function, imported from "${be(t)}", to return a standalone entity or NgModule but got "${be(e) || e}".`);
    if (nn(e) == null) {
        let n = G(e) || Re(e) || $e(e);
        if (n != null) {
            if (!n.standalone)
...
var Ru = class {
    ...
    computeNgModuleScope(t) {
        let n = ji(t), o = { exported: { directives: new Set, pipes: new Set }, compilation: { directives: new Set, pipes: new Set } };
        for (let r of Kn(n.imports))
            if (fn(r)) {
        ...
        for (let r of Kn(n.exports))
            if (fn(r)) {
                ...
                rs(r) ? o.exported.pipes.add(r) : o.exported.directives.add(r);
        return o;
    }
...
function cb(e, t, n, o, r, i, s) {
    ...
    hb(n, e.data.length, a);
    for (let f = 0; f < a; f++) {
        let p = o[f];
        p.providersResolver && p.providersResolver(p);
    }
    let l = !1, u = !1, d = ri(e, t, a, null);
...
function cg(e, t, n) {
    ...
    if (o === null || !n && r === null || n && i === null || Rd(e)) {
...
function Uy(e, t, n, o, r, i) {
    let s = t.consts, a = pe(s, r), c = _n(t, e, n, o, a);
    if (c.mergedAttrs = co(c.mergedAttrs, c.attrs), i != null) {
        let l = pe(s, i);
        c.localNames = [];
        for (let u = 0; u < l.length; u += 2)
...
function Dr(e, t, n) {
    return function o(r) {
        let i = Me(e) ? ge(e.index, t) : t;
        si(i, 5);
        let s = t[H], a = lg(t, s, n, r), c = o.__ngNextListenerFn__;
        for (; c;)
            a = lg(t, s, c, r) && a, c = c.__ngNextListenerFn__;
        return a;
    };
}
function lg(e, t, n, o) {
...
function Gy(e, t, n, o, r, i, s, a) {
    let c = jn(e), l = !1, u = null;
    if (!o && c && (u = vb(t, n, i, e.index)), u !== null) {
...
function _b(e) {
    ...
    if (t === null)
        throw new T(407, !1);
    let n = e.get(jy, null), o = e.get(Ce, null);
...
function bb(e, t, n, o) {
    let r = e ? ["ng-version", "20.3.7"] : l_(t.selectors[0]), i = null, s = null, a = 0;
    if (n)
        for (let u of n)
            a += u[qt].requiredVars, u.create && (u.targetIdx = 0, (i ??= []).push(u)), u.update && (u.targetIdx = 0, (s ??= []).push(u));
    if (o)
...
var Bs = class extends Fy {
    ...
    setInput(t, n) {
        ...
        if (this.previousInputValues ??= new Map, this.previousInputValues.has(t) && Object.is(this.previousInputValues.get(t), n))
            return;
        let r = this._rootLView, i = wa(o, r[m], r, t, n);
...
var xb = ja, Yy = class extends xb {
    ...
    get parentInjector() {
        let t = id(this._hostTNode, this._hostLView);
        if (nm(t)) {
    ...
    createComponent(t, n, o, r, i, s, a) {
        ...
        let u = c ? t : new Wt(G(t)), d = o || this.parentInjector;
        if (!i && u.ngModule == null) {
            let D = (c ? d : this.parentInjector).get(_e, null);
            D && (i = D);
        }
        let f = G(u.componentType ?? {}), p = jr(this._lContainer, f?.id ?? null), h = p?.firstChild ?? null, v = u.create(d, r, h, i, s, a);
        return this.insertImpl(v.hostView, l, yn(this._hostTNode, p)), v;
    }
    ...
    insertImpl(t, n, o) {
        ...
        return Lo(s, r, i, o), t.attachToViewContainerRef(), Bc($l(s), i, t), t;
    }
...
function eE(e, t, n, o) {
    if (e[We])
        return;
    let r;
    n.type & 8 ? r = k(o) : r = kb(t, n), e[We] = r;
}
function Pb(e, t, n) {
    if (e[We] && e[Oe])
        return !0;
    let o = n[ae], r = t.index - I;
    if (!o || wo(t) || da(o, r))
        return !1;
    let s = lu(o, r), a = o.data[_o]?.[r], [c, l] = JS(s, a);
    return e[We] = c, e[Oe] = l, !0;
}
...
function uf(e, t, n) {
    ...
    return o = r[re], o._dirtyCounter = Bt(0), o._flatValue = void 0, r;
}
...
function $b(e, t) {
    ...
    if (n === void 0 || o === void 0 || n[M] & 4)
        return t ? void 0 : P;
    let r = cf(n, o), i = aE(n, o);
    return r.reset(i, hm), t ? r.first : r._changesDetected || e._flatValue === void 0 ? e._flatValue = r.toArray() : e._flatValue;
}
function lE(e) {
    let t = [], n = new Map;
    function o(r) {
    ...
    return ho.forEach((r, i) => {
        ...
        let c = Promise.all(s).then(() => Qb(i));
        t.push(c);
    }), dE(), Promise.all(t).then(() => { });
}
...
function SE(e, t, n, o, r, i, s, a) {
    ...
    a && (e.flags |= a), ot(e, !1);
    let c = bE(n, t, e, o);
    pr() && Wd(n, t, c, e), je(c, t);
    let l = ly(c, t, c, e);
    t[o + I] = l, Pd(t, l), Xy(l, e, t);
}
...
function In(e, t, n, o, r, i, s, a, c, l, u) {
    let d = n + I, f;
    if (t.firstCreatePass) {
        ...
        f = t.data[d];
    return SE(f, e, t, n, o, r, i, c), l != null && ko(e, f, u), f;
}
...
function Vo(e, t, n, o, r, i, s) {
    ...
    function u() {
        ...
        let d = Ie(e, t), f = d[Rt];
        if (f !== $r.Initial && f !== Q.Placeholder) {
            l.destroy();
            return;
        }
        let p = CR(e, t, o);
        if (!p || (l.destroy(), nt(p)))
            return;
        let h = MR(p, n), v = r(h, () => { c.run(() => { e !== p && Wi(p, v), i(); }); }, a);
        e !== p && ur(p, v), ui(s, d, v);
    }
    l = Fv({ read: u }, { injector: a });
}
function Ha(e, t) { let n = t.get(_R), o = () => n.remove(e); return n.add(e), o; }
var NR = () => typeof requestIdleCallback < "u" ? requestIdleCallback : setTimeout, wR = () => typeof requestIdleCallback < "u" ? cancelIdleCallback : clearTimeout, _R = (() => {
    class e {
...
var jE = (() => {
        ...
        scheduleTimer(n) {
            let o = () => {
                ...
                for (let c = 0; c < this.current.length && this.current[c] <= s; c += 2)
                    a = c + 1;
                if (a >= 0 && Uc(this.current, 0, a + 1), this.executingCallbacks = !1, this.deferred.length > 0) {
    ...
    return e;
})(), bR = new C("DEFER_BLOCK_DEPENDENCY_INTERCEPTOR"), VE = new C("");
...
function It(e, t, n, o = !1) {
    let r = n[z], i = r[m];
    if (nt(r))
        return;
    let s = Ie(r, t), a = s[Rt], c = s[vR];
    if (!(c !== null && e < c) && vg(a, e) && vg(s[ro] ?? -1, e)) {
...
function LR(e) {
    let t = Nt(), n = e.get(wt), o = Sm(t, n), r = {};
...
var Ze = (() => {
    class e {
        ...
        bootstrapImpl(n, o, r = ie.NULL) {
            return this._injector.get($).run(() => {
                V(10);
                let s = n instanceof Pa;
                if (!this._injector.get(_f).done) {
                    let h = "";
                    throw new T(405, h);
                }
                let c;
                s ? c = n : c = this._injector.get(ci).resolveComponentFactory(n), this.componentTypes.push(c.componentType);
                let l = QE(c) ? void 0 : this._injector.get(go), u = o || c.selector, d = c.create(r, [], u, l), f = d.location.nativeElement, p = d.injector.get($E, null);
                return p?.registerApplication(f), d.onDestroy(() => { this.detachView(d.hostView), Tr(this.components, d), p?.unregisterApplication(f); }), this._loadComponent(d), V(11, d), d;
            });
        }
        ...
        synchronize() {
            this._rendererFactory === null && !this._injector.destroyed && (this._rendererFactory = this._injector.get(Vr, null, { optional: !0 }));
            let n = 0;
            for (; this.dirtyFlags !== 0 && n++ < BR;)
        ...
        syncDirtyFlagsWithViews() {
            if (this.allViews.some(({ _lView: n }) => Vn(n))) {
                this.dirtyFlags |= 2;
                return;
            }
            else
...
function ZE(e) {
    ...
    if (Ho(t, n), !JE(0, t))
        return;
    let o = t[L], r = Ie(t, n), i = e(() => De(0, t, n), o);
    ui(0, r, i);
}
function YE(e) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return;
    let t = g(), n = t[L], o = _(), r = t[m], i = ue(r, o);
    if (i.loadingState === te.NOT_STARTED) {
...
function KE(e, t, n) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return;
    let o = t[L], r = Ie(t, n), i = r[Va], s = e(() => At(o, i), o);
    ui(2, r, s);
}
function pi(e, t, n) { Ua(e, t, n); }
function Ua(e, t, n) {
    let o = t[L], r = t[m];
    if (e.loadingState !== te.NOT_STARTED)
        return e.loadingPromise ?? Promise.resolve();
    let i = Ie(t, n), s = TR(r, e);
    e.loadingState = te.IN_PROGRESS, ms(1, i);
    let a = e.dependencyResolverFn, c = o.get(hr).add();
...
function De(e, t, n) {
    let o = t[m], r = t[n.index];
    if (!JE(e, t))
        return;
    let i = Ie(t, n), s = ue(o, n);
    switch (OE(i), s.loadingState) {
        case te.NOT_STARTED:
...
function At(e, t, n) {
    return xt(this, null, function* () {
        ...
        if (o.hydrating.has(t))
            return;
        let { parentBlockPromise: i, hydrationQueue: s } = fw(t, e);
        if (s.length === 0)
            return;
        i !== null && s.shift(), qR(o, s), i !== null && (yield i);
        let a = s[0];
        o.has(a) ? yield Ig(e, s, n) : o.awaitParentBlock(a, () => xt(null, null, function* () { return yield Ig(e, s, n); }));
    });
}
function Ig(e, t, n) {
    return xt(this, null, function* () {
        let o = e.get(_t), r = o.hydrating, i = e.get(vt), s = i.add();
        ...
        let a = t[t.length - 1];
        yield r.get(a)?.promise, i.remove(s), n && n(t), KS(o.get(a), t, o, e.get(Ze));
    });
}
...
function Tg(e, t) {
    let n = e[L], o = ue(e[m], t), r = ei(n), i = QR(o.flags);
    if (typeof ngServerMode < "u" && ngServerMode)
        return !r || !i;
    let a = Ie(e, t)[Va] !== null;
    return !(i && a && r);
}
...
function eI(e, t, n, o, r, i, s, a, c, l) {
    let u = g(), d = R(), f = e + I, p = In(u, d, e, null, 0, 0), h = u[L], v = ei(h);
    ...
    let he = [null, $r.Initial, null, null, null, null, O, D, null, null];
    ER(u, f, he);
    let He = null;
    O !== null && v && (He = h.get(_t), He.add(O, { lView: u, tNode: p, lContainer: y }));
    let xe = () => { OE(he), O !== null && He?.cleanup([O]); };
    ui(0, he, () => Wi(u, xe)), ur(u, xe);
}
function tI(e) {
    let t = g(), n = Le();
    if (!K(0, t, n))
...
function rI() {
    ...
    if (!K(2, e, t))
        return;
    zt(R(), t).set(7, null), typeof ngServerMode < "u" && ngServerMode && De(2, e, t);
}
...
function aI() {
    ...
    if (!K(2, e, t))
        return;
    zt(R(), t).set(0, null), typeof ngServerMode < "u" && ngServerMode ? De(2, e, t) : KE(Ha, e, t);
}
function cI() {
    let e = g(), t = _();
    if (!K(0, e, t))
        return;
    ue(e[m], t).loadingTmplIndex === null && Ho(e, t), De(0, e, t);
}
function lI() {
    let e = g(), t = _();
    if (!K(1, e, t))
        return;
    let n = e[m], o = ue(n, t);
    o.loadingState === te.NOT_STARTED && Ua(o, e, t);
}
function uI() {
    let e = g(), t = _();
    if (!K(2, e, t))
        return;
    if (zt(R(), t).set(1, null), typeof ngServerMode < "u" && ngServerMode)
        De(2, e, t);
    else {
...
function pI(e) {
    ...
    if (!K(2, t, n))
        return;
    zt(R(), n).set(5, { delay: e }), typeof ngServerMode < "u" && ngServerMode ? De(2, t, n) : KE(Ba(e), t, n);
}
...
function gI(e, t) {
    ...
    if (!K(1, n, o))
        return;
    let r = n[m], i = ue(r, o);
    i.loadingState === te.NOT_STARTED && Vo(n, o, e, t, xm, () => pi(i, n, o), 1);
}
function mI() {
    let e = g(), t = _();
    if (!K(2, e, t))
        return;
    zt(R(), t).set(4, null), typeof ngServerMode < "u" && ngServerMode && De(2, e, t);
}
...
function yI(e, t) {
    ...
    if (!K(1, n, o))
        return;
    let r = n[m], i = ue(r, o);
    i.loadingState === te.NOT_STARTED && Vo(n, o, e, t, Om, () => pi(i, n, o), 1);
}
function EI() {
    let e = g(), t = _();
    if (!K(2, e, t))
        return;
    zt(R(), t).set(3, null), typeof ngServerMode < "u" && ngServerMode && De(2, e, t);
}
...
function DI(e, t) {
    ...
    if (!K(1, n, o))
        return;
    let r = n[m], i = ue(r, o);
    i.loadingState === te.NOT_STARTED && Vo(n, o, e, t, Tf, () => pi(i, n, o), 1);
}
function TI() {
    let e = g(), t = _();
    if (!K(2, e, t))
        return;
    zt(R(), t).set(2, null), typeof ngServerMode < "u" && ngServerMode && De(2, e, t);
}
function Af(e, t) {
    let n = g(), o = ve();
    if (Z(n, o, t)) {
...
function oA(e, t) {
    if (!Sn)
        return;
    let n = yo.get(e);
    if (n && n.classList.length > 0 && rA(e, n.classList))
...
function Cr(e) {
    if (ee("NgAnimateEnter"), typeof ngServerMode < "u" && ngServerMode || !Sn)
        return Cr;
    let t = g();
    if ($a(t))
        return Cr;
    let n = _();
    return qa(n, t), Ga(qs(t), n, () => iA(t, n, e)), Ia(t[L]), $d(t[L], qs(t)), Cr;
}
function iA(e, t, n) {
    let o = ce(t, e), r = e[w], i = e[L].get($), s = wI(n), a = [], c = u => {
        if (u.target !== o)
            return;
        let d = u instanceof AnimationEvent ? "animationend" : "transitionend";
        i.runOutsideAngular(() => { r.listen(o, d, l); });
    }, l = u => { u.target === o && sA(u, o, r); };
    if (s && s.length > 0) {
...
function Mr(e) {
    ...
    if ($a(t))
        return Mr;
    let n = _();
    return qa(n, t), Ga(qs(t), n, () => aA(t, n, e)), Ia(t[L]), $d(t[L], qs(t)), Mr;
}
function aA(e, t, n) { let o = ce(t, e); n.call(e[H], { target: o, animationComplete: nA }); }
function Nr(e) {
    if (ee("NgAnimateLeave"), typeof ngServerMode < "u" && ngServerMode || !Sn)
        return Nr;
    let t = g();
    if ($a(t))
        return Nr;
    let o = _();
    return qa(o, t), Ga(Dn(t), o, () => cA(t, o, e)), Ia(t[L]), Nr;
}
...
function lA(e, t, n, o, r, i) {
    oA(e, r);
    let s = [], a = Dn(n).get(t.index)?.resolvers, c = l => {
        if (l.target === e && (l instanceof CustomEvent || _I(l, e))) {
    ...
    i.runOutsideAngular(() => { s.push(r.listen(e, "animationend", c)), s.push(r.listen(e, "transitionend", c)); }), NI(t, e);
    for (let l of o)
        r.addClass(e, l);
    i.runOutsideAngular(() => { requestAnimationFrame(() => { Ov(e, gn, Sn), gn.has(e) || (Bu(t, e), Uu(a, s), $u(n, t)); }); });
}
function Gs(e) {
    if (ee("NgAnimateLeave"), typeof ngServerMode < "u" && ngServerMode || !Sn)
        return Gs;
    let t = g(), n = _();
    return qa(n, t), lo.add(t), Ga(Dn(t), n, () => uA(t, n, e)), Ia(t[L]), Gs;
}
function uA(e, t, n) {
    let { promise: o, resolve: r } = Rf(), i = ce(t, e), s = [], a = e[w], c = $a(e), l = e[L].get($), u = e[L].get(MI);
    (Dn(e).get(t.index).resolvers ??= []).push(r);
    let d = Dn(e).get(t.index)?.resolvers;
    if (c)
        ss(e, t, i, d, s);
    else {
...
function RI(e, t) {
    ee("NgControlFlow");
    let n = g(), o = ve(), r = n[o] !== B ? n[o] : -1, i = r !== -1 ? zs(n, I + r) : void 0, s = 0;
    if (Z(n, o, e)) {
        let a = A(null);
        try {
...
function fA(e, t) {
    if (e.length <= W)
        return;
    let n = W + t, o = e[n];
    o && o[gt] && (o[gt].skipLeaveAnimations = !0);
}
...
function za(e, t, n, o) {
    let r = g(), i = r[m], s = e + I, a = i.firstCreatePass ? rf(s, r, 2, t, Yd, zi(), n, o) : i.data[s];
    if (Ma(a, r, e, t, Ff), jn(a)) {
        let c = r[m];
        Ta(c, r, a), Md(c, a, r);
    }
...
function gA(e, t, n, o, r) {
    ...
    if (ze(i), i)
        return ha(t[w], o, Ml());
    let s = t[ae], a = ai(s, e, t, n);
    return zm(s, r) && ua(s, r, a.nextSibling), s && (ad(n) || gm(a)) && Me(n) && (Eh(n), Nv(a)), a;
}
function PI() { Ff = gA; }
function Ka(e, t, n) {
    let o = g(), r = o[m], i = e + I, s = r.firstCreatePass ? rf(i, o, 8, "ng-container", Yd, zi(), t, n) : r.data[i];
    if (Ma(s, o, e, "ng-container", Bf), jn(s)) {
        let a = o[m];
        Ta(a, o, s), Md(a, s, o);
    }
...
function mA(e, t, n, o, r) {
    ...
    if (ze(s), s)
        return Od(t[w], "");
    let a = t[ae], c = ai(a, e, t, n), l = Wm(a, r);
    return ua(a, r, c), i = Aa(l, c), i;
}
function LI() { Bf = mA; }
...
function AA(e, t, n, o) {
    let r = OA(t, o);
    if (Ra(t, n) !== r && (zI(e, t, n), n[t.currentCaseLViewIndex] = r === null ? null : ~r, r !== null)) {
        let s = n[t.anchorIdx];
...
function _g(e) {
    let t, n = "", o = 0, r = !1, i;
    for (; (t = PA.exec(e)) !== null;)
        r ? t[0] === `${Sr}/*${i}${Sr}` && (o = t.index, r = !1) : (n += e.substring(o, t.index + t[0].length), i = t[1], r = !0);
...
function KI(e, t, n, o, r, i, s) {
    let a = 0, c = { type: i.type, currentCaseLViewIndex: ri(t, n, 1, null), anchorIdx: s, cases: [], create: [], remove: [], update: [] };
    zA(o, i, s), MS(t, s, c);
    let l = i.values, u = [];
    for (let d = 0; d < l.length; d++) {
        let f = l[d], p = [];
...
function qA(e) {
    let t = [], n = [], o = 1, r = 0;
    e = e.replace(QI, function (s, a, c) { return c === "select" ? o = 0 : o = 1, r = parseInt(a.slice(1), 10), ""; });
    let i = Ku(e);
...
function JI(e, t, n, o, r, i, s, a, c, l, u, d) {
...
function oO(e, t = {}) {
    ...
    if (YA.test(e)) {
        let o = {}, r = [bg];
        n = n.replace(KA, (i, s, a) => {
            let c = s || a, l = o[c] || [];
            if (l.length || (c.split("|").forEach(v => { let y = v.match(nO), D = y ? parseInt(y[1], 10) : bg, O = tO.test(v); l.push([D, O, v]); }), o[c] = l), !l.length)
    ...
    return Object.keys(t).length && (n = n.replace(JA, (o, r, i, s, a, c) => t.hasOwnProperty(i) ? `${r}${t[i]}${c}` : o), n = n.replace(XA, (o, r) => t.hasOwnProperty(r) ? t[r] : o), n = n.replace(eO, (o, r) => {
...
function Gf(e, t, n = -1) {
    let o = R(), r = g(), i = I + e, s = pe(o.consts, t), a = Hn();
    if (o.firstCreatePass && VA(o, a === null ? 0 : a.index, r, i, s, n), o.type === 2) {
        let f = r[J];
        f[M] |= 32;
    }
    else
        r[M] |= 32;
    let c = o.data[i], l = a === r[se] ? null : a, u = Uv(o, l, r), d = a && a.type & 8 ? r[a.index] : null;
    HS(r, i, a, n), RA(r, c.create, u, d), yl(!0);
}
function Wf() { yl(!1); }
...
function Kf(e, t, n, o, r, i, s) {
    let a = !0, c = null;
    if ((o.type & 3 || s) && (c ??= Dr(o, t, i), Gy(o, e, t, s, n, r, i, c) && (a = !1)), a) {
...
function cD(e) {
    ...
    fr(o + 1);
    let r = lf(n, o);
    if (e.dirty && hh(t) === ((r.metadata.flags & 2) === 2)) {
        if (r.matches === null)
            e.reset([]);
        else {
            let i = aE(t, o);
...
function lO(e, t, n, o, r, i) {
    let s = i ? t.classBindings : t.styleBindings, a = Tn(s), c = Io(s);
    e[o] = n;
    let l = !1, u;
    if (Array.isArray(n)) {
        let d = n;
    ...
    if (r)
        ...
        e[o + 1] = cs(c, 0), a === 0 ? a = o : e[c + 1] = Ql(e[c + 1], o), c = o;
    l && (e[o + 1] = Ju(e[o + 1])), Rg(e, u, o, !0), Rg(e, u, o, !1), uO(t, u, e, o, i), s = cs(a, c), i ? t.classBindings = s : t.styleBindings = s;
}
function uO(e, t, n, o, r) { let i = r ? e.residualClasses : e.residualStyles; i != null && typeof t == "string" && Pn(i, t) >= 0 && (n[o + 1] = Xu(n[o + 1])); }
function Rg(e, t, n, o) {
    let r = e[n + 1], i = t === null, s = o ? Tn(r) : Io(r), a = !1;
    for (; s !== 0 && (a === !1 || i);) {
        let c = e[s], l = e[s + 1];
...
function yO(e, t) {
    for (let n = hO(t); n >= 0; n = mD(t, n))
        MD(e, hD(t), fO(t));
}
function ED(e) { DD(NO, EO, e, !0); }
function EO(e, t) {
    for (let n = pO(t); n >= 0; n = gD(t, n))
        rr(e, hD(t), !0);
}
function ID(e, t, n, o) {
    let r = g(), i = R(), s = it(2);
    if (i.firstUpdatePass && CD(i, e, s, o), t !== B && Z(r, s, t)) {
        let a = i.data[le()];
...
function DD(e, t, n, o) {
    let r = R(), i = it(2);
    r.firstUpdatePass && CD(r, null, i, o);
    let s = g();
    if (n !== B && Z(s, i, n)) {
        let a = r.data[le()];
        if (wD(a, o) && !TD(r, i)) {
...
function IO(e, t, n, o) {
    let r = Zi(e), i = o ? t.residualClasses : t.residualStyles;
    if (r === null)
...
function Zl(e, t, n, o, r) {
    ...
    for (a === -1 ? a = n.directiveStart : a++; a < s && (i = t[a], o = Gr(o, i.hostAttrs, r), i !== e);)
        a++;
...
function ND(e, t, n, o, r, i, s, a) {
    if (!(t.type & 3))
        return;
    let c = e.data, l = c[a + 1], u = cO(l) ? xg(c, t, n, r, Io(l), s) : void 0;
    if (!Zs(u)) {
...
function $D(e, t) {
    let n = R(), o = g(), r = o[w], i = "data-ng-source-location";
...
function ls(e) {
    if (typeof e == "function")
        return e;
    let t = Ue(e);
    return t.some(Ko) ? () => t.map(x).map(kg) : t.map(kg);
}
...
function ET(e, t, n, o, r, i) {
    ...
    for (let c = 0; c < r.length; c++)
        Z(e, s++, r[c]) && (a = !0);
    return a ? lt(e, s, o.apply(i, r)) : mi(e, s);
}
function IT(e, t) {
    let n = R(), o, r = e + I;
    n.firstCreatePass ? (o = xO(t, n.pipeRegistry), n.data[r] = o, o.onDestroy && (n.destroyHooks ??= []).push(r, o.onDestroy)) : o = n.data[r];
    let i = o.factory || (o.factory = Pt(o.type, !0)), s, a = Ee(jo);
    try {
        let c = Ms(!1), l = i();
...
function RT(e, t, n, o, r = null, i = null) {
    let s = G(e);
    t.apply(null, [e, n, ...o]);
    let { newDef: a, oldDef: c } = kO(s, G(e));
    if (e[en] = a, c.tView) {
        let l = NN().values();
        for (let u of l)
...
function LO(e, t, n, o, r) {
    let i = r[H], s = r[U], a = r[z], c = r[se], l = r[L].get($, null), u = () => {
        if (o.encapsulation === Tt.ShadowDom) {
            let h = s.cloneNode(!1);
            s.replaceWith(h), s = h;
        }
        let d = _v(n), f = ga(a, d, i, kd(n), s, c, null, null, null, null, null);
        FO(a, r, f, c.index), ii(r[m], r);
        let p = r[Ge].rendererFactory;
        PO(p, o), f[w] = p.createRenderer(s, n), Hv(r[m], r), jO(c), _a(d, f, i), iy(d, f, d.template, i);
    };
    l === null ? Pg(e, t, u) : l.run(() => Pg(e, t, u));
}
function Pg(e, t, n) {
    try {
        n();
...
function FO(e, t, n, o) {
    for (let r = I; r < e[m].bindingStartIndex; r++) {
        let i = e[r];
        if ((X(i) || Y(i)) && i[fe] === t) {
            i[fe] = n;
            break;
...
function PT(e, t, n = !1) {
    ...
    let s = null;
    Object.defineProperty(e, Wo, { get: () => {
            if (s === null) {
...
function WO(e, t) {
    let n = Ue(t.declarations || P), o = pp(e);
    n.forEach(r => {
        if (r = x(r), r.hasOwnProperty(en)) {
            let s = G(r);
            fp(s, o);
        }
        else
...
function hp(e, t) {
    let n = null;
    jT(e, t || {}), Object.defineProperty(e, er, { get: () => {
            if (n === null) {
                let o = FT(e, t || {});
...
function ex(e) {
    let t = sd();
    if (XO.some(o => t.hasLifecycleHook(e, o)))
        return !0;
...
function GT(e, t) {
    ...
    Object.defineProperty(e, Je, { get: () => {
            ...
            return o;
        }, configurable: !1 }), Object.defineProperty(e, tr, { get: () => {
            if (n === null) {
                let r = jg(e, t);
    ...
    class e {
        ...
        notify(n) {
            ...
            if (this.appRef.tracingSnapshot = this.tracing?.snapshot(this.appRef.tracingSnapshot) ?? null, !this.shouldScheduleTick(o))
                return;
            let r = this.useMicrotaskScheduler ? Jh : kv;
...
var Wr = class {
    ...
    get properties() {
        let t = we(this.nativeNode), n = t ? t.lView : null;
        if (n === null)
            return {};
        let o = n[m].data, r = o[t.nodeIndex], i = {};
        return yx(this.nativeElement, i), Ix(i, r, n, o), i;
    }
    get attributes() {
        let t = {}, n = this.nativeElement;
        if (!n)
            return t;
        let o = we(n), r = o ? o.lView : null;
        if (r === null)
            return {};
        let i = r[m].data[o.nodeIndex].attrs, s = [];
        if (i) {
            let a = 0;
            for (; a < i.length;) {
                let c = i[a];
...
function Vg(e, t, n, o) {
    let r = we(e.nativeNode), i = r ? r.lView : null;
    if (i !== null) {
...
var yi = class {
    ...
    subscribe(t) {
        if (this.destroyed)
            throw new T(953, !1);
        return (this.listeners ??= []).push(t), { unsubscribe: () => { let n = this.listeners?.indexOf(t); n !== void 0 && n !== -1 && this.listeners?.splice(n, 1); } };
    }
    emit(t) {
        if (this.destroyed) {
...
var XT = Te(q({}, Yp), { cleanupFns: void 0, zone: null, onDestroyFn: un, run() {
        let e = Bn(!1);
        try {
            Kp(this);
        }
...
var Ep = class {
    ...
    destroyed = !1;
    unregisterOnDestroy;
    constructor(t, n, o, r, i, s = tC) {
        super(bn(() => {
            let a = this.state().stream?.();
            if (!a || this.state().status === "loading" && this.error())
                return o;
            if (!Ip(a)) {
                if (s)
            ...
            return a.value;
        }, { equal: r })), this.loaderFn = n, this.equal = r, this.extRequest = yp({ source: t, computation: a => ({ request: a, reload: 0 }) }), this.state = yp({ source: this.extRequest, computation: (a, c) => { let l = a.request === void 0 ? "idle" : "loading"; return c ? { extRequest: a, status: l, previousStatus: KT(c.value), stream: c.value.extRequest.request === a.request ? c.value.stream : void 0 } : { extRequest: a, status: l, previousStatus: "idle", stream: void 0 }; } }), this.effectRef = JT(this.loadEffect.bind(this), { injector: i, manualCleanup: !0 }), this.pendingTasks = i.get(hr), this.unregisterOnDestroy = i.get(Fe).onDestroy(() => this.destroy());
    }
    ...
    set(t) {
        if (this.destroyed)
            return;
        let n = Ye(this.error), o = Ye(this.state);
        if (!n) {
            let r = Ye(this.value);
    ...
    loadEffect() {
        return xt(this, null, function* () {
            let t = this.extRequest(), { status: n, previousStatus: o } = Ye(this.state);
            if (t.request === void 0)
                return;
            if (n !== "loading")
                return;
            this.abortInProgressLoad();
            let r = this.resolvePendingTask = this.pendingTasks.add(), { signal: i } = this.pendingController = new AbortController;
            try {
...
function bx(e) {
    return Rx(e) ? e.stream : t => xt(null, null, function* () {
        try {
...
var Gx = typeof navigator < "u" && /iPhone|iPad|iPod/.test(navigator.userAgent), ac = class {
    ...
    cleanUp() {
        for (let t = 0; t < this.handlerInfos.length; t++)
            Vx(this.element, this.handlerInfos[t]);
        this.handlerInfos = [];
    }
...
var Np = class e {
    ...
    populateAction(t, n) {
        let o = n;
        for (; o && o !== dC(t) && (o.nodeType === Node.ELEMENT_NODE && this.populateActionOnElement(o, t), !sc(t));)
            o = this.getParentNode(o);
        let r = sc(t);
        if (r && (this.a11yClickSupport && this.preventDefaultForA11yClick(t), this.syntheticMouseEventSupport && (Qt(t) === N.MOUSEENTER || Qt(t) === N.MOUSELEAVE || Qt(t) === N.POINTERENTER || Qt(t) === N.POINTERLEAVE)))
            if ($x(ic(t), Qt(t), rc(r))) {
                let i = qx(ic(t), rc(r));
                cC(t, i), uC(t, rc(r));
            }
    ...
    getParentNode(t) {
        ...
        if (n)
            return n;
        let o = t.parentNode;
        return o?.nodeName === "#document-fragment" ? o?.host ?? null : o;
    }
    ...
    dispatch(t) {
        ...
        let o = n.getAction();
        if (o && tk(o.element, n) && Hx(n.getEvent()), this.eventReplayer && n.getIsReplay()) {
...
var ok = "`composedPath` called during event replay.", cc = class {
    ...
    dispatchToDelegate(t) {
        for (t.getIsReplay() && sk(t), rk(t); t.getAction();) {
...
var uk = !1, IC = (() => {
    class e {
        ...
        addEvent(n, o, r) {
            if (n in this.eventHandlers || !this.containerManager || !e.MOUSE_SPECIAL_SUPPORT && kx.indexOf(n) >= 0)
                return;
            let i = (a, c, l) => { this.handleEvent(a, c, l); };
...
function GC(e) {
    let t = Ei(e) ? e.r3Injector : e.moduleRef.injector, n = t.get($);
    return n.run(() => {
        Ei(e) ? e.r3Injector.resolveInjectorInitializers() : e.moduleRef.resolveInjectorInitializers();
        let o = t.get(st), r;
        if (n.runOutsideAngular(() => { r = n.onError.subscribe({ next: o }); }), Ei(e)) {
        ...
        return Ek(o, n, () => {
            let i = t.get(vt), s = i.add(), a = t.get(_f);
            return a.runInitializers(), a.donePromise.then(() => {
                let c = t.get(gp, gi);
                if (UI(c || gi), !t.get(vk, !0))
                    return Ei(e) ? t.get(Ze) : (e.allPlatformModules.push(e.moduleRef), e.moduleRef);
                if (Ei(e)) {
                    let u = t.get(Ze);
                    return e.rootComponent !== void 0 && u.bootstrap(e.rootComponent), u;
                }
                else
                    return WC?.(e.moduleRef, e.allPlatformModules), e.moduleRef;
...
var zC = (() => {
    class e {
        ...
        destroy() {
            ...
            let n = this._injector.get(fc, null);
...
function Ik(e) {
    if (yc())
        throw new T(400, !1);
    Sf(), Uo = typeof ngServerMode > "u" || !ngServerMode ? e : null;
    let t = e.get(zC);
    return ZC(e), t;
}
function Dk(e, t, n = []) {
    let o = `Platform: ${t}`, r = new C(o);
    return (i = []) => {
        let s = yc();
        if (!s) {
...
function Ck(e = []) {
    if (Uo)
        return Uo;
    let t = QC(e);
    return (typeof ngServerMode > "u" || !ngServerMode) && (Uo = t), Sf(), ZC(t), t;
}
...
var kp = class extends Mk {
    ...
    check(t) {
        ...
        if (Array.isArray(t)) {
            ...
            r = 0, $y(t, a => { s = this._trackByFn(r, a), n === null || !Object.is(n.trackById, s) ? (n = this._mismatch(n, a, s, r), o = !0) : (o && (n = this._verifyReinsertion(n, a, s, r)), Object.is(n.item, a) || this._addIdentityChange(n, a)), n = n._next, r++; }), this.length = r;
...
var JC = (() => {
    ...
    return e;
})(), Sk = [new gc], bk = [new pc], mF = new KC(bk), vF = new JC(Sk), yF = Dk(null, "core", []), EF = (() => {
    class e {
        constructor(n) { }
...
function IF(e) {
    let { rootComponent: t, appProviders: n, platformProviders: o, platformRef: r } = e;
    if (V(8), typeof ngServerMode < "u" && ngServerMode && !r)
        throw new T(-401, !1);
    try {
...
function Rk() {
    let e = [{ provide: aa, useFactory: () => {
                let t = !0;
                if (typeof ngServerMode > "u" || !ngServerMode) {
                    let n = E(wt);
                    t = !!window._ejsas?.[n];
                }
                return t && ee("NgEventReplay"), t;
            } }];
    return (typeof ngServerMode > "u" || !ngServerMode) && e.push({ provide: Pe, useValue: () => {
            let t = E(Ze), { injector: n } = t;
            if (!uc.has(t)) {
                let o = E(Xr);
                if (PC(n)) {
                    Fm();
            ...
            return () => {
                ...
                uc.add(t);
                let o = n.get(wt);
                t.onDestroy(() => { uc.delete(t), typeof ngServerMode < "u" && !ngServerMode && Ap(o); }), t.whenStable().then(() => {
                    if (t.destroyed)
                        return;
                    let r = n.get(Ed);
                    Ak(r, n);
                    let i = n.get(Xr);
                    i.get(kC)?.forEach(yd), i.delete(kC);
                    let s = r.instance;
                    ei(n) ? t.onDestroy(() => s.cleanUp()) : s.cleanUp();
                });
            };
        }, multi: !0 }), e;
}
var Ak = (e, t) => {
    let n = t.get(wt), o = window._ejsas[n], r = e.instance = new IC(new ac(o.c));
    for (let a of o.et)
        r.addEvent(a);
    for (let a of o.etc)
        r.addEvent(a);
    let i = DC(n);
    r.replayEarlyEventInfos(i), Ap(n);
    let s = new cc(a => { xk(t, a, a.currentTarget); });
    EC(r, s);
};
function Ok(e, t, n) {
    let o = new Map, r = t[Lt], i = e.cleanup;
    if (!i || !r)
        return o;
    for (let s = 0; s < i.length;) {
        let a = i[s++], c = i[s++];
...
function nM(e, t, n) {
    let o = cr(e[U]), r = tM(o, t);
    if (r === null)
        return;
    let i = k(o[U]), s = e[z], a = mc(i, s, null, t), c = o[w], l = `${r}|${a}`;
    c.setAttribute(i, to, l);
}
function DF(e, t) {
    let n = e.injector, o = wy(n), r = ei(n), i = new Hp, s = new Map, a = e._views, c = n.get(aa, hd), l = { regular: new Set, capture: new Set }, u = new Map, d = e.injector.get(wt);
    for (let h of a) {
        let v = Dd(h);
        if (v !== null) {
    ...
    let f = i.getAll(), p = n.get(Mn);
    if (p.set(ca, f), u.size > 0) {
        let h = {};
...
function jk(e, t, n, o, r) {
    let i = [], s = "";
    for (let a = W; a < e.length; a++) {
        let c = e[a], l, u, d;
        if (tt(c) && (c = c[I], Y(c))) {
            u = Fk(c) + 1, nM(c, r);
            let p = cr(c[U]);
...
function oM(e, t = null, n) {
    let o = {}, r = e[m], i = _y(r, n), s = n.shouldReplayEvents ? Ok(r, e, n.eventTypesToReplay) : null;
...
var TF = "ngcm";
function CF() {
    let e = [{ provide: Nn, useFactory: () => { let t = !0; return (typeof ngServerMode > "u" || !ngServerMode) && (t = !!E(Mn, { optional: !0 })?.get(ca, null)), t && ee("NgHydration"), t; } }, { provide: Pe, useValue: () => { tf(!1), !(typeof ngServerMode < "u" && ngServerMode) && E(Nn) && (ev(Nt()), Gk()); }, multi: !0 }];
    return (typeof ngServerMode > "u" || !ngServerMode) && e.push({ provide: fd, useFactory: () => E(Nn) }, { provide: fi, useFactory: () => {
            if (E(Nn)) {
                let t = E(Ze);
...
function SF(e) {
    if (!Ec)
        return;
    let { startLabel: t } = rM(e);
    performance.mark(t);
}
function bF(e) {
    if (!Ec)
        return;
    let { startLabel: t, labelName: n, endLabel: o } = rM(e);
...
var HC = !1;
function RF() {
    if (!HC && (typeof performance > "u" || !performance.mark || !performance.measure)) {
...
var xp = Symbol("NOT_SET"), iM = new Set, Kk = Te(q({}, Mc), { consumerIsAlwaysLive: !0, consumerAllowSignalWrites: !0, value: xp, cleanup: null, consumerMarkedDirty() {
        ...
        if (this.sequence.lastPhase = this.phase, !this.dirty)
            return this.signal;
        if (this.dirty = !1, this.value !== xp && !wi(this))
            return this.signal;
        try {
        ...
        return (this.value === xp || !this.equal(this.value, o)) && (this.value = o, this.version++), this.signal;
    } }), Bp = class extends Pr {
    scheduler;
    lastPhase = null;
    nodes = [void 0, void 0, void 0, void 0];
    constructor(t, n, o, r, i, s = null) {
        super(t, [void 0, void 0, void 0, void 0], o, !1, i.get(Fe), s), this.scheduler = r;
        for (let a of Vd) {
            let c = n[a];
            if (c === void 0)
                continue;
...
function $F(e, t) {
    if (typeof ngServerMode < "u" && ngServerMode)
        return Ea;
    let n = t?.injector ?? E(ie), o = n.get(Ce), r = n.get(ya), i = n.get(xo, null, { optional: !0 });
    r.impl ??= n.get(Hd);
    let s = e;
    typeof s == "function" && (s = { mixedReadWrite: e });
    let a = n.get(ln, null, { optional: !0 }), c = new Bp(r.impl, [s.earlyRead, s.write, s.mixedReadWrite, s.read], a?.view, o, n, i?.snapshot(null));
