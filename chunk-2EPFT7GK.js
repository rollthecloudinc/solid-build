import { a as E } from "@nf-internal/chunk-SN3MHONI";
import { a as A } from "@nf-internal/chunk-D2J64VUP";
import { b as T } from "@nf-internal/chunk-JWKF23VO";
import { a as w, b as M, e as S, f as k, g as x, h as g } from "@nf-internal/chunk-6QNXWVCH";
import { f as D, g as I } from "@nf-internal/chunk-5ZLKIHXA";
import { e as O } from "@nf-internal/chunk-5KSFOI5Q";
import { b as _ } from "@nf-internal/chunk-RXMLTE5A";
import { d as C, g as u } from "@nf-internal/chunk-C2A5IV4Z";
import { i as m } from "@nf-internal/chunk-IR6MR6UK";
...
function we(r, c) {
    if (r & 1 && (t.\u0275\u0275elementStart(0, "span", 4), t.\u0275\u0275text(1), t.\u0275\u0275elementEnd()), r & 2) {
...
function Se(r, c) {
    if (r & 1 && (t.\u0275\u0275elementStart(0, "span", 11), t.\u0275\u0275text(1), t.\u0275\u0275elementEnd()), r & 2) {
        let e = t.\u0275\u0275nextContext(2);
        t.\u0275\u0275advance(), t.\u0275\u0275textInterpolate(e.triggerValue);
    }
}
function ke(r, c) {
    if (r & 1 && (t.\u0275\u0275elementStart(0, "span", 5), t.\u0275\u0275conditionalCreate(1, Me, 1, 0)(2, Se, 2, 1, "span", 11), t.\u0275\u0275elementEnd()), r & 2) {
        let e = t.\u0275\u0275nextContext();
    ...
    class r {
        ...
        _applyModalPanelOwnership() {
            ...
            if (!e)
                return;
            let i = `${this.id}-panel`;
            this._trackedModal && L(this._trackedModal, "aria-owns", i), ne(e, "aria-owns", i), this._trackedModal = e;
        }
        _clearFromModal() {
            if (!this._trackedModal)
                return;
            let e = `${this.id}-panel`;
            L(this._trackedModal, "aria-owns", e), this._trackedModal = null;
        }
        ...
        _exitAndDetach() {
            ...
            this._cleanupDetach?.(), this._cleanupDetach = () => { i(), clearTimeout(a), this._cleanupDetach = void 0; };
            let e = this.panel.nativeElement, i = this._renderer.listen(e, "animationend", n => { n.animationName === "_mat-select-exit" && (this._cleanupDetach?.(), this._detachOverlay()); }), a = setTimeout(() => { this._cleanupDetach?.(), this._detachOverlay(); }, 200);
        ...
        _handleClosedKeydown(e) {
            let i = e.keyCode, a = i === B || i === K || i === he || i === pe, n = i === P || i === W, l = this._keyManager;
            if (!l.isTyping() && n && !y(e) || (this.multiple || e.altKey) && a)
        ...
        _handleOpenKeydown(e) {
            let i = this._keyManager, a = e.keyCode, n = a === B || a === K, l = i.isTyping();
            if (n && e.altKey)
        ...
        _getPanelAriaLabelledby() {
            if (this.ariaLabel)
                return null;
            let e = this._parentFormField?.getLabelId() || null, i = e ? e + " " : "";
        ...
        static \u0275cmp = t.\u0275\u0275defineComponent({ type: r, selectors: [["mat-select"]], contentQueries: function (i, a, n) {
                if (i & 1 && (t.\u0275\u0275contentQuery(n, j, 5), t.\u0275\u0275contentQuery(n, S, 5), t.\u0275\u0275contentQuery(n, M, 5)), i & 2) {
                    let l;
                ...
                if (i & 1 && (t.\u0275\u0275viewQuery(ve, 5), t.\u0275\u0275viewQuery(be, 5), t.\u0275\u0275viewQuery(R, 5)), i & 2) {
                    let n;
