import { a as K } from "@nf-internal/chunk-6RF2KXDI";
import { i as X, q as Y } from "@nf-internal/chunk-RASHQLKI";
...
import { b as $, c as O, d as q } from "@nf-internal/chunk-IOPJEBHZ";
import { a as ie, b as T } from "@nf-internal/chunk-ZBGE3AVM";
import { c as U } from "@nf-internal/chunk-C2A5IV4Z";
import { i as Q, j, w as x } from "@nf-internal/chunk-IR6MR6UK";
...
var w = new H("CDK_TABLE"), me = new H("text-column-options"), F = (() => {
    class o {
        template = l(p);
        constructor() { }
    ...
    class o {
        ...
        static \u0275dir = s.\u0275\u0275defineDirective({ type: o, selectors: [["", "cdkColumnDef", ""]], contentQueries: function (t, i, n) {
                if (t & 1 && (s.\u0275\u0275contentQuery(n, F, 5), s.\u0275\u0275contentQuery(n, I, 5), s.\u0275\u0275contentQuery(n, ye, 5)), t & 2) {
                    let a;
    ...
    return o;
})(), Ke = "<ng-container cdkCellOutlet></ng-container>", P = (() => {
    class o {
        template = l(p);
        _differs = l(v);
        columns;
    ...
    return o;
})(), Z = ["top", "bottom", "left", "right"], A = class {
    _isNativeHtmlTable;
    _stickCellCss;
    _isBrowser;
    ...
    updateStickyColumns(r, e, t, i = !0, n = !0) {
        ...
        let a = r[0], c = a.children.length, d = this.direction === "rtl", u = d ? "right" : "left", h = d ? "left" : "right", m = e.lastIndexOf(!0), y = t.indexOf(!0), C, L, z;
        n && this._updateStickyColumnReplayQueue({ rows: [...r], stickyStartStates: [...e], stickyEndStates: [...t] }), E({ earlyRead: () => { C = this._getCellWidths(a, i), L = this._getStickyStartColumnPositions(C, e), z = this._getStickyEndColumnPositions(C, t); }, write: () => {
                for (let _ of r)
                    for (let f = 0; f < c; f++) {
                        let B = _.children[f];
    ...
    _removeStickyStyle(r, e) {
        ...
        Z.some(i => e.indexOf(i) === -1 && r.style[i]) ? r.style.zIndex = this._getCalculatedZIndex(r) : (r.style.zIndex = "", this._needsPositionStickyOnElement && (r.style.position = ""), r.classList.remove(this._stickCellCss));
    }
...
var G = new H("CDK_SPL"), Ge = (() => {
    ...
    class o {
        ...
        renderRows() {
            ...
            this._viewRepeater.applyChanges(e, t, (i, n, a) => this._getEmbeddedViewArgs(i.item, a), i => i.item.data, i => { i.operation === $.INSERTED && i.context && this._renderCellTemplateForItem(i.record.item.rowDef, i.context); }), this._updateRowIndexContext(), e.forEachIdentityChange(i => { let n = t.get(i.currentIndex); n.context.$implicit = i.item.data; }), this._updateNoDataRow(), this.contentChanged.next(), this.updateStickyColumnStyles();
        }
        ...
        _observeRenderChanges() {
            if (!this.dataSource)
                return;
            let e;
            T(this.dataSource) ? e = this.dataSource.connect(this) : U(this.dataSource) ? e = this.dataSource : Array.isArray(this.dataSource) && (e = x(this.dataSource)), this._renderChangeSubscription = e.pipe(N(this._onDestroy)).subscribe(t => { this._data = t || [], this.renderRows(); });
        }
        ...
        static \u0275cmp = s.\u0275\u0275defineComponent({ type: o, selectors: [["cdk-table"], ["table", "cdk-table", ""]], contentQueries: function (t, i, n) {
                if (t & 1 && (s.\u0275\u0275contentQuery(n, Re, 5), s.\u0275\u0275contentQuery(n, g, 5), s.\u0275\u0275contentQuery(n, pe, 5), s.\u0275\u0275contentQuery(n, ee, 5), s.\u0275\u0275contentQuery(n, te, 5)), t & 2) {
                    let a;
...
var Je = (() => {
    class o {
        ...
        static \u0275cmp = s.\u0275\u0275defineComponent({ type: o, selectors: [["cdk-text-column"]], viewQuery: function (t, i) {
                if (t & 1 && (s.\u0275\u0275viewQuery(g, 7), s.\u0275\u0275viewQuery(F, 7), s.\u0275\u0275viewQuery(I, 7)), t & 2) {
                    let n;
