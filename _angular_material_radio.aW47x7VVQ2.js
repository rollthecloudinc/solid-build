...
import { f as b } from "@nf-internal/chunk-U56RZWEM";
...
var j = (() => {
    class r {
        ...
        static \u0275dir = i.\u0275\u0275defineDirective({ type: r, selectors: [["mat-radio-group"]], contentQueries: function (a, t, d) {
                if (a & 1 && i.\u0275\u0275contentQuery(d, R, 5), a & 2) {
                    let n;
    ...
    class r {
        ...
        _updateTabIndex() {
            let e = this.radioGroup, a;
            if (!e || !e.selected || this.disabled ? a = this.tabIndex : a = e.selected === this ? this.tabIndex : -1, a !== this._previousTabIndex) {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-radio-button"]], viewQuery: function (a, t) {
                if (a & 1 && (i.\u0275\u0275viewQuery(P, 5), i.\u0275\u0275viewQuery(S, 7, v)), a & 2) {
                    let d;
