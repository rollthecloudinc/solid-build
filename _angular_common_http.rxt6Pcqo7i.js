...
import { d as G, v as Pe, w as z } from "@nf-internal/chunk-IR6MR6UK";
import { a as $, c as be, e as se } from "@nf-internal/chunk-6MDQTQU3";
...
var O = class e {
    ...
    cloneFrom = null;
    constructor(r = {}) {
        if (this.encoder = r.encoder || new q, r.fromString) {
            if (r.fromObject)
                throw new A(2805, !1);
...
var X = "Content-Type", Q = "Accept", he = "X-Request-URL", Ce = "text/plain", Be = "application/json", Se = `${Be}, ${Ce}, */*`, F = class e {
    ...
    constructor(r, t, n, s) {
        ...
        let i;
        if (Et(this.method) || s ? (this.body = n !== void 0 ? n : null, i = s) : i = n, i) {
...
var pe = (() => {
    class e {
        ...
        request(t, n, s = {}) {
            ...
            let o = z(i).pipe(ft(a => this.handler.handle(a)));
            if (t instanceof F || s.observe === "events")
                return o;
            let d = o.pipe(pt(a => a instanceof _));
            switch (s.observe || "body") {
                case "body": switch (i.responseType) {
                    case "arraybuffer": return d.pipe(W(a => {
                        if (a.body !== null && !(a.body instanceof ArrayBuffer))
                            throw new A(2806, !1);
                        return a.body;
                    }));
                    case "blob": return d.pipe(W(a => {
                        if (a.body !== null && !(a.body instanceof Blob))
                            throw new A(2807, !1);
                        return a.body;
                    }));
                    case "text": return d.pipe(W(a => {
    ...
    class e {
        ...
        doRequest(t, n, s) {
            return se(this, null, function* () {
                ...
                let d = new R(o.headers), a = o.statusText, f = De(o) ?? t.urlWithParams, m = o.status, p = null;
                if (t.reportProgress && s.next(new J({ headers: d, status: m, statusText: a, url: f })), o.body) {
                    let c = o.headers.get("content-length"), M = [], u = o.body.getReader(), h = 0, T, b, y = typeof Zone < "u" && Zone.current, P = !1;
                    if (yield this.ngZone.runOutsideAngular(() => se(this, null, function* () {
                        for (;;) {
                            if (this.destroyed) {
                                yield u.cancel(), P = !0;
                                break;
                ...
                m === 0 && (m = p ? fe : 0);
                let g = m >= 200 && m < 300, E = o.redirected;
                g ? (s.next(new _({ body: p, headers: d, status: m, statusText: a, url: f, redirected: E })), s.complete()) : s.error(new w({ error: p, headers: d, status: m, statusText: a, url: f, redirected: E }));
            });
        }
        parseBody(t, n, s, i) {
        ...
        createRequestInit(t) {
            let n = {}, s;
            if (s = t.credentials, t.withCredentials && (s = "include"), t.headers.forEach((i, o) => n[i] = o.join(",")), t.headers.has(Q) || (n[Q] = Se), !t.headers.has(X)) {
...
function Mt() {
    let e = null;
    return (r, t) => {
        e === null && (e = (v(ye, { optional: !0 }) ?? []).reduceRight(Pt, Je));
        let n = v(je);
        if (v(ge)) {
            let i = n.add();
...
var H = (() => {
    ...
    return e;
})(), Ot = 0, ke, At = "JSONP injected script did not invoke callback.";
var ee = class {
};
    ...
    class e {
        ...
        handle(t) {
            ...
            return new G(n => {
                ...
                o.src = i;
                let d = null, a = !1;
                this.callbackMap[s] = g => { delete this.callbackMap[s], d = g, a = !0; };
                let f = () => { o.removeEventListener("load", m), o.removeEventListener("error", p), o.remove(), delete this.callbackMap[s]; }, m = () => {
                    this.resolvedPromise.then(() => {
                        if (f(), !a) {
                            n.error(new w({ url: i, status: 0, statusText: "JSONP Error", error: new Error(At) }));
                            return;
                        }
                        n.next(new _({ body: d, status: fe, statusText: "OK", url: i })), n.complete();
                    });
                }, p = g => { f(), n.error(new w({ error: g, status: 0, statusText: "JSONP Error", url: i })); };
                return o.addEventListener("load", m), o.addEventListener("error", p), this.document.body.appendChild(o), n.next({ type: N.Sent }), () => { a || this.removeListeners(o), f(); };
            });
        }
...
var de = (() => {
    class e {
        ...
        handle(t) {
            ...
            return (typeof ngServerMode < "u" && ngServerMode && n.\u0275loadImpl ? Pe(n.\u0275loadImpl()) : z(null)).pipe(yt(() => new G(i => {
                let o = n.build();
                if (o.open(t.method, t.urlWithParams), t.withCredentials && (o.withCredentials = !0), t.headers.forEach((u, h) => o.setRequestHeader(u, h.join(","))), t.headers.has(Q) || o.setRequestHeader(Q, Se), !t.headers.has(X)) {
                ...
                let d = t.serializeBody(), a = null, f = () => {
                    if (a !== null)
                        return a;
                    let u = o.statusText || "OK", h = new R(o.getAllResponseHeaders()), T = xt(o) || t.url;
                    return a = new J({ headers: h, status: o.status, statusText: u, url: T }), a;
                }, m = () => {
                    let { headers: u, status: h, statusText: T, url: b } = f(), y = null;
                    h !== wt && (y = typeof o.response > "u" ? o.responseText : o.response), h === 0 && (h = y ? fe : 0);
                    let P = h >= 200 && h < 300;
                    ...
                    P ? (i.next(new _({ body: y, headers: u, status: h, statusText: T, url: b || void 0 })), i.complete()) : i.error(new w({ error: y, headers: u, status: h, statusText: T, url: b || void 0 }));
                }, p = u => { let { url: h } = f(), T = new w({ error: u, status: o.status || 0, statusText: o.statusText || "Unknown Error", url: h || void 0 }); i.error(T); }, g = p;
                t.timeout && (g = u => { let { url: h } = f(), T = new w({ error: new DOMException("Request timed out", "TimeoutError"), status: o.status || 0, statusText: o.statusText || "Request timeout", url: h || void 0 }); i.error(T); });
                let E = !1, c = u => { E || (i.next(f()), E = !0); let h = { type: N.DownloadProgress, loaded: u.loaded }; u.lengthComputable && (h.total = u.total), t.responseType === "text" && o.responseText && (h.partialText = o.responseText), i.next(h); }, M = u => { let h = { type: N.UploadProgress, loaded: u.loaded }; u.lengthComputable && (h.total = u.total), i.next(h); };
                return o.addEventListener("load", m), o.addEventListener("error", p), o.addEventListener("timeout", g), o.addEventListener("abort", p), t.reportProgress && (o.addEventListener("progress", c), d !== null && o.upload && o.upload.addEventListener("progress", M)), o.send(d), i.next({ type: N.Sent }), () => { o.removeEventListener("error", p), o.removeEventListener("abort", p), o.removeEventListener("load", m), o.removeEventListener("timeout", g), t.reportProgress && (o.removeEventListener("progress", c), d !== null && o.upload && o.upload.removeEventListener("progress", M)), o.readyState !== o.DONE && o.abort(); };
            })));
        }
    ...
    return e;
})(), te = new D(""), $e = "XSRF-TOKEN", Ge = new D("", { providedIn: "root", factory: () => $e }), We = "X-XSRF-TOKEN", Ke = new D("", { providedIn: "root", factory: () => We }), B = class {
}, Ye = (() => {
    class e {
        doc;
        cookieName;
        ...
        getToken() {
            ...
            return t !== this.lastCookieString && (this.parseCount++, this.lastToken = Ne(t, this.cookieName), this.lastCookieString = t), this.lastToken;
        }
...
function qe(e, r) {
    ...
    if (!v(te) || e.method === "GET" || e.method === "HEAD" || t.startsWith("http://") || t.startsWith("https://"))
        return r(e);
    let n = v(B).getToken(), s = v(Ke);
...
var xe = (() => {
    ...
    return e;
})(), k = (function (e) { return e[e.Interceptors = 0] = "Interceptors", e[e.LegacyInterceptors = 1] = "LegacyInterceptors", e[e.CustomXsrfConfiguration = 2] = "CustomXsrfConfiguration", e[e.NoXsrfProtection = 3] = "NoXsrfProtection", e[e.JsonpSupport = 4] = "JsonpSupport", e[e.RequestsMadeViaParent = 5] = "RequestsMadeViaParent", e[e.Fetch = 6] = "Fetch", e; })(k || {});
function U(e, r) { return { \u0275kind: e, \u0275providers: r }; }
function Ze(...e) {
    let r = [pe, de, H, { provide: j, useExisting: H }, { provide: L, useFactory: () => v(Xe, { optional: !0 }) ?? v(de) }, { provide: V, useValue: qe, multi: !0 }, { provide: te, useValue: !0 }, { provide: B, useClass: Ye }];
    for (let t of e)
        r.push(...t.\u0275providers);
    return ht(r);
}
...
function Zt(e, r) {
    ...
    let n = t.headers instanceof R ? t.headers : new R(t.headers), s = t.params instanceof O ? t.params : new O({ fromObject: t.params });
    return new F(t.method ?? "GET", t.url, t.body ?? null, { headers: n, params: s, reportProgress: t.reportProgress, withCredentials: t.withCredentials, keepalive: t.keepalive, cache: t.cache, priority: t.priority, mode: t.mode, redirect: t.redirect, responseType: r, context: t.context, transferCache: t.transferCache, credentials: t.credentials, referrer: t.referrer, integrity: t.integrity, timeout: t.timeout });
}
var ve = class extends zt {
    ...
    constructor(r, t, n, s, i) {
        super(t, ({ params: o, abortSignal: d }) => {
            let a, f = () => a.unsubscribe();
            d.addEventListener("abort", f);
            let m = Jt({ value: void 0 }), p, g = new Promise(c => p = c), E = c => { m.set(c), p?.(m), p = void 0; };
            return a = this.client.request(o).subscribe({ next: c => {
                    switch (c.type) {
                        case N.Response:
                ...
                }, error: c => { c instanceof w && (this._headers.set(c.headers), this._statusCode.set(c.status)), E({ error: c }), d.removeEventListener("abort", f); }, complete: () => { p && E({ error: new ct(991, !1) }), d.removeEventListener("abort", f); } }), g;
        }, n, i, r), this.client = r.get(pe);
    }
...
function er(e, r) {
    let E = S(we), { isCacheActive: t } = E, n = be(E, ["isCacheActive"]), { transferCache: s, method: i } = e;
    if (!t || s === !1 || i === "POST" && !n.includePostRequests && !s || i !== "POST" && !Ht.includes(i) || !n.includeRequestsWithAuthHeaders && tr(e) || n.filter?.(e) === !1)
        return r(e);
    let o = S(Kt), d = S(Qt, { optional: !0 });
    if (typeof ngServerMode < "u" && !ngServerMode && d)
        throw new ct(2803, !1);
    let a = typeof ngServerMode < "u" && ngServerMode && d ? or(e.url, d) : e.url, f = nr(e, a), m = o.get(f, null), p = n.includeHeaders;
    if (typeof s == "object" && s.includeHeaders && (p = s.includeHeaders), m) {
    ...
    let g = r(e);
    return typeof ngServerMode < "u" && ngServerMode ? g.pipe(qt(c => { c instanceof _ && o.set(f, { [tt]: c.body, [rt]: rr(c.headers, p), [nt]: c.status, [st]: c.statusText, [ot]: a, [it]: e.responseType }); })) : g;
}
