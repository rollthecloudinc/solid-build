...
import { d as h, w as a } from "@nf-internal/chunk-IR6MR6UK";
...
var L = (() => {
    ...
    return n;
})(), I = new f("EmbeddableComponent"), q = new f("Site Name"), U = new f("Host Name"), $ = new f("Request Protocol"), z = (() => {
    class n {
        ...
        build(e) {
            this.hostElement.innerHTML = e || "", e && this.embeddedComponentFactories.forEach((t, i) => {
                this.hostElement.querySelectorAll(i).forEach(c => {
                    let d = [Array.prototype.slice.call(c.childNodes)], l = t.create(this.injector, d, c);
                    for (let u of c.attributes)
                        l.instance[u.nodeName] = u.nodeValue;
                    this.embeddedComponents.push(l);
                });
            });
        }
    ...
    class n {
        ...
        loadModule(e) {
            return new h(t => {
                e().then(i => {
                    if (this.loadedModules.indexOf(s => s == i.name) !== -1)
                        throw "";
                    return this.loadedModules.push(i.name), i;
                }).then(i => this.compiler.compileModuleAndAllComponentsAsync(i)).then(i => { let s = i.ngModuleFactory.create(this.injector); t.next(!0), t.complete(); }).catch(() => { t.next(!0), t.complete(); });
            });
        }
    ...
    class n {
        ...
        loadStyle(e) {
            let t = this.document.getElementsByTagName("head")[0], i = this.document.getElementById("client-theme");
            if (i)
                i.href = e;
            else {
    ...
    wrap(r) {
        return new h(e => {
            let t, i = !1, s = null, c = null, d = null, l = y => {
                t = y, i = !0, s = this.delegate(r).subscribe(p => c = p, p => {
                    if (!i)
            ...
            }, u = y => { i && (i = !1, s && (s.unsubscribe(), s = null)); }, M = () => { d !== null ? e.error(d) : (e.next(c), e.complete()); }, E = Zone.current.scheduleMacroTask("ZoneMacroTaskWrapper.subscribe", M, {}, () => null, u);
            return l(E), () => { i && t && (t.zone.cancelTask(t), i = !1), s && (s.unsubscribe(), s = null); };
        });
    }
}, g = class extends v {
    constructor() { super(); }
