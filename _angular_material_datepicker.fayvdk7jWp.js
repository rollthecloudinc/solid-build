...
var Ke = (r, d) => d.id;
function Vt(r, d) {
    if (r & 1 && (i.\u0275\u0275elementStart(0, "tr", 0)(1, "td", 3), i.\u0275\u0275text(2), i.\u0275\u0275elementEnd()()), r & 2) {
...
function Et(r, d) {
    if (r & 1 && (i.\u0275\u0275elementStart(0, "td", 3), i.\u0275\u0275text(1), i.\u0275\u0275elementEnd()), r & 2) {
...
function It(r, d) {
    if (r & 1 && (i.\u0275\u0275elementStart(0, "tr", 1), i.\u0275\u0275conditionalCreate(1, Et, 2, 6, "td", 4), i.\u0275\u0275repeaterCreate(2, xt, 5, 48, "td", 5, Ke), i.\u0275\u0275elementEnd()), r & 2) {
...
function Ft(r, d) {
    if (r & 1 && (i.\u0275\u0275elementStart(0, "th", 2)(1, "span", 6), i.\u0275\u0275text(2), i.\u0275\u0275elementEnd(), i.\u0275\u0275elementStart(3, "span", 3), i.\u0275\u0275text(4), i.\u0275\u0275elementEnd()()), r & 2) {
        let e = d.$implicit;
...
var F = (() => {
    ...
    class r {
        ...
        _getDescribedby(e) {
            if (!this.isRange)
                return null;
            if (this.startValue === e && this.endValue === e)
                return `${this._startDateLabelId} ${this._endDateLabelId}`;
            if (this.startValue === e)
        ...
        _enterHandler = e => {
            if (this._skipNextFocus && e.type === "focus") {
        ...
        _touchmoveHandler = e => {
            if (!this.isRange)
                return;
            let a = Me(e), t = a ? this._getCellFromElement(a) : null;
            a !== e.target && (this._didDragSinceMouseDown = !0), te(e.target) && e.preventDefault(), this._ngZone.run(() => this.previewChange.emit({ value: t?.enabled ? t : null, event: e }));
        };
        ...
        _mousedownHandler = e => {
            ...
            let a = e.target && this._getCellFromElement(e.target);
            !a || !this._isInRange(a.compareValue) || this._ngZone.run(() => { this.dragStarted.emit({ value: a.rawValue, event: e }); });
        };
        _mouseupHandler = e => {
            if (!this.isRange)
                return;
...
var Xt = { provide: D, deps: [[new le, new ce, D], u], useFactory: Ut }, j = new Te("MAT_DATE_RANGE_SELECTION_STRATEGY"), Zt = (() => {
    class r {
        _dateAdapter;
        ...
        createDrag(e, a, t) {
            let n = a.start, s = a.end;
            if (!n || !s)
                return null;
            let l = this._dateAdapter, B = l.compareDate(n, s) !== 0, y = l.getYear(t) - l.getYear(e), C = l.getMonth(t) - l.getMonth(e), H = l.getDate(t) - l.getDate(e);
...
var ea = { provide: j, deps: [[new le, new ce, j], u], useFactory: Jt }, re = 7, ta = 0, Se = (() => {
    class r {
        ...
        _handleCalendarBodyKeydown(e) {
            let a = this._activeDate, t = this._isRtl();
            switch (e.keyCode) {
                case I:
        ...
        _createWeekCells() {
            let e = this._dateAdapter.getNumDaysInMonth(this.activeDate), a = this._dateAdapter.getDateNames(), t = [[]];
            for (let n = 0, s = this._firstWeekOffset(); n < e; n++, s++) {
                s == re && (t.push([]), s = 0);
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-month-view"]], viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(V, 5), a & 2) {
                    let n;
    ...
    class r {
        ...
        _init() {
            ...
            let a = this._dateAdapter.getYear(this._activeDate) - T(this._dateAdapter, this.activeDate, this.minDate, this.maxDate), t = [];
            for (let n = 0, s = []; n < m; n++)
                s.push(a + n), s.length == se && (t.push(s.map(l => this._createCellForYear(l))), s = []);
            this._years.set(t), this._changeDetectorRef.markForCheck();
        }
        ...
        _shouldEnableYear(e) {
            ...
            for (let t = a; this._dateAdapter.getYear(t) == e; t = this._dateAdapter.addCalendarDays(t, 1))
        ...
        _isRtl() { return this._dir && this._dir.value === "rtl"; }
        _setSelectedYear(e) {
            if (this._selectedYear.set(null), e instanceof h) {
                let a = e.start || e.end;
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-multi-year-view"]], viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(V, 5), a & 2) {
                    let n;
                    i.\u0275\u0275queryRefresh(n = i.\u0275\u0275loadQuery()) && (t._matCalendarBody = n.first);
                }
...
var Ee = (() => {
    class r {
        ...
        _shouldEnableMonth(e) {
            ...
            if (e == null || this._isYearAndMonthAfterMaxDate(a, e) || this._isYearAndMonthBeforeMinDate(a, e))
                return !1;
            if (!this.dateFilter)
                return !0;
            let t = this._dateAdapter.createDate(a, e, 1);
            for (let n = t; this._dateAdapter.getMonth(n) == e; n = this._dateAdapter.addCalendarDays(n, 1))
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-year-view"]], viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(V, 5), a & 2) {
                    let n;
                    i.\u0275\u0275queryRefresh(n = i.\u0275\u0275loadQuery()) && (t._matCalendarBody = n.first);
                }
    ...
    class r {
        ...
        ngOnChanges(e) {
            let a = e.minDate && !this._dateAdapter.sameDate(e.minDate.previousValue, e.minDate.currentValue) ? e.minDate : void 0, t = e.maxDate && !this._dateAdapter.sameDate(e.maxDate.previousValue, e.maxDate.currentValue) ? e.maxDate : void 0, n = a || t || e.dateFilter;
            if (n && !n.firstChange) {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-calendar"]], viewQuery: function (a, t) {
                if (a & 1 && (i.\u0275\u0275viewQuery(Se, 5), i.\u0275\u0275viewQuery(Ee, 5), i.\u0275\u0275viewQuery(Ve, 5)), a & 2) {
                    let n;
            ...
            }, hostAttrs: [1, "mat-calendar"], inputs: { headerComponent: "headerComponent", startAt: "startAt", startView: "startView", selected: "selected", minDate: "minDate", maxDate: "maxDate", dateFilter: "dateFilter", dateClass: "dateClass", comparisonStart: "comparisonStart", comparisonEnd: "comparisonEnd", startDateAccessibleName: "startDateAccessibleName", endDateAccessibleName: "endDateAccessibleName" }, outputs: { selectedChange: "selectedChange", yearSelected: "yearSelected", monthSelected: "monthSelected", viewChanged: "viewChanged", _userSelection: "_userSelection", _userDragDrop: "_userDragDrop" }, exportAs: ["matCalendar"], features: [i.\u0275\u0275ProvidersFeature([We]), i.\u0275\u0275NgOnChangesFeature], decls: 5, vars: 2, consts: [[3, "cdkPortalOutlet"], ["cdkMonitorSubtreeFocus", "", "tabindex", "-1", 1, "mat-calendar-content"], [3, "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "comparisonStart", "comparisonEnd", "startDateAccessibleName", "endDateAccessibleName", "activeDrag"], [3, "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass"], [3, "activeDateChange", "_userSelection", "dragStarted", "dragEnded", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass", "comparisonStart", "comparisonEnd", "startDateAccessibleName", "endDateAccessibleName", "activeDrag"], [3, "activeDateChange", "monthSelected", "selectedChange", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass"], [3, "activeDateChange", "yearSelected", "selectedChange", "activeDate", "selected", "dateFilter", "maxDate", "minDate", "dateClass"]], template: function (a, t) {
                if (a & 1 && (i.\u0275\u0275template(0, Rt, 0, 0, "ng-template", 0), i.\u0275\u0275elementStart(1, "div", 1), i.\u0275\u0275conditionalCreate(2, Tt, 1, 11, "mat-month-view", 2)(3, Ot, 1, 6, "mat-year-view", 3)(4, Yt, 1, 6, "mat-multi-year-view", 3), i.\u0275\u0275elementEnd()), a & 2) {
                    let n;
...
var na = { provide: $e, deps: [], useFactory: ia }, Ue = (() => {
    class r {
        ...
        _dialogLabelId;
        constructor() {
            if (o(G).load(me), this._closeButtonText = o(F).closeCalendarLabel, !this._animationsDisabled) {
        ...
        _handleUserSelection(e) {
            let a = this._model.selection, t = e.value, n = a instanceof h;
            if (n && this._rangeSelectionStrategy) {
                let s = this._rangeSelectionStrategy.selectionFinished(t, a, e.event);
                this._model.updateSelection(s, this);
            }
            else
                t && (n || !this._dateAdapter.sameDate(t, a)) && this._model.add(t);
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-datepicker-content"]], viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(oe, 5), a & 2) {
                    let n;
...
`], encapsulation: 2, changeDetection: 0 });
    ...
    class r {
        ...
        close() {
            if (!this._opened || this._componentRef?.instance._isAnimating)
                return;
            let e = this.restoreFocus && this._focusedElementBeforeOpen && typeof this._focusedElementBeforeOpen.focus == "function", a = () => { this._opened && (this._opened = !1, this.closedStream.emit()); };
    ...
    class r {
        ...
        _registerModel(e) {
            this._model = e, this._valueChangesSubscription.unsubscribe(), this._pendingValue && this._assignValue(this._pendingValue), this._valueChangesSubscription = this._model.selectionChanged.subscribe(a => {
...
var ra = { provide: _e, useExisting: Ye(() => Je), multi: !0 }, sa = { provide: ge, useExisting: Ye(() => Je), multi: !0 }, Je = (() => {
    class r extends Xe {
    ...
    class r {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-datepicker-toggle"]], contentQueries: function (a, t, n) {
                if (a & 1 && i.\u0275\u0275contentQuery(n, oa, 5), a & 2) {
                    let s;
                    i.\u0275\u0275queryRefresh(s = i.\u0275\u0275loadQuery()) && (t._customIcon = s.first);
                }
            }, viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(Nt, 5), a & 2) {
                    let n;
...
var et = (() => {
    ...
    class r {
        ...
        static \u0275fac = function (a) { return new (a || r); };
        static \u0275cmp = i.\u0275\u0275defineComponent({ type: r, selectors: [["mat-datepicker-actions"], ["mat-date-range-picker-actions"]], viewQuery: function (a, t) {
                if (a & 1 && i.\u0275\u0275viewQuery(it, 5), a & 2) {
                    let n;
