...
import { D as f, H as b, d as h, i as l } from "@nf-internal/chunk-IR6MR6UK";
...
var F = (() => {
    class e {
        ...
        _registerQuery(t) {
            ...
            let r = this._mediaMatcher.matchMedia(t), o = { observable: new h(s => { let n = d => this._zone.run(() => s.next(d)); return r.addListener(n), () => { r.removeListener(n); }; }).pipe(L(r), v(({ matches: s }) => ({ query: t, matches: s })), O(this._destroySubject)), mql: r };
