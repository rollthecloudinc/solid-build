import { a as b, b as Q } from "@nf-internal/chunk-6MDQTQU3";
...
var G = class extends _ {
    ...
    hostEl;
    shadowRoot;
    constructor(r, e, t, o, s, i, a, l, f) {
        super(r, s, i, l, f), this.sharedStylesHost = e, this.hostEl = t, this.shadowRoot = t.attachShadow({ mode: "open" }), this.sharedStylesHost.addHost(this.shadowRoot);
        let u = o.styles;
        u = le(o.id, u);
        for (let h of u) {
...
var B = class {
    ...
    findTestabilityInTree(r, e, t) {
        ...
        return o ?? (t ? pe().isShadowRoot(e) ? this.findTestabilityInTree(r, e.host, !0) : this.findTestabilityInTree(r, e.parentElement, !0) : null);
    }
}, nt = (() => {
    class n {
    ...
    return n;
})(), fe = ["alt", "control", "meta", "shift"], rt = { "\b": "Backspace", "	": "Tab", "\x7F": "Delete", "\x1B": "Escape", Del: "Delete", Esc: "Escape", Left: "ArrowLeft", Right: "ArrowRight", Up: "ArrowUp", Down: "ArrowDown", Menu: "ContextMenu", Scroll: "ScrollLock", Win: "OS" }, ot = { alt: n => n.altKey, control: n => n.ctrlKey, meta: n => n.metaKey, shift: n => n.shiftKey }, ge = (() => {
    class n extends v {
        constructor(e) { super(e); }
        ...
        static parseEventName(e) {
            ...
            if (a > -1 && (t.splice(a, 1), i = "code."), fe.forEach(f => { let u = t.indexOf(f); u > -1 && (t.splice(u, 1), i += f + "."); }), i += s, t.length != 0 || s.length === 0)
                return null;
            let l = {};
        ...
        static matchEventFullKeyCode(e, t) {
            ...
            return t.indexOf("code.") > -1 && (o = e.code, s = "code."), o == null || !o ? !1 : (o = o.toLowerCase(), o === " " ? o = "space" : o === "." && (o = "dot"), fe.forEach(i => {
                if (i !== o) {
                    let a = ot[i];
                    a(e) && (s += i + ".");
                }
...
var Ee = [{ provide: Y, useClass: B }, { provide: Xe, useClass: K, deps: [de, ue, Y] }, { provide: K, useClass: K, deps: [de, ue, Y] }], Se = [{ provide: We, useValue: "root" }, { provide: me, useFactory: lt }, { provide: S, useClass: w, multi: !0, deps: [U] }, { provide: S, useClass: ge, multi: !0, deps: [U] }, j, k, H, { provide: Je, useExisting: j }, { provide: Ve, useClass: nt }, []], ft = (() => {
    class n {
        constructor() { }
        static \u0275fac = function (t) { return new (t || n); };
...
var Ot = { pan: !0, panstart: !0, panmove: !0, panend: !0, pancancel: !0, panleft: !0, panright: !0, panup: !0, pandown: !0, pinch: !0, pinchstart: !0, pinchmove: !0, pinchend: !0, pinchcancel: !0, pinchin: !0, pinchout: !0, press: !0, pressup: !0, rotate: !0, rotatestart: !0, rotatemove: !0, rotateend: !0, rotatecancel: !0, swipe: !0, swipeleft: !0, swiperight: !0, swipeup: !0, swipedown: !0, tap: !0, doubletap: !0 }, q = new Te(""), Ie = new Te(""), Nt = (() => {
    class n {
        events = [];
        overrides = {};
        options;
...
function Cn(...n) {
    ...
    return Rt([[], [], Ct(), e.has(m.NoHttpTransferCache) || t ? [] : De({}), r]);
}
