import { a as f } from "@nf-internal/chunk-ZBGE3AVM";
import { c as d } from "@nf-internal/chunk-C2A5IV4Z";
...
var w = class extends f {
    ...
    viewCacheSize = 20;
    _viewCache = [];
    applyChanges(t, c, s, E, h) {
        t.forEachOperation((e, _, n) => {
            let a, l;
            if (e.previousIndex == null) {
                ...
                n == null ? (this._detachAndCacheView(_, c), l = o.REMOVED) : (a = this._moveView(_, n, c, E(e)), l = o.MOVED);
            h && h({ context: a?.context, operation: l, record: e });
        });
    }
    detach() {
    ...
    _insertView(t, c, s, E) {
        let h = this._insertViewFromCache(c, s);
        if (h) {
            h.context.$implicit = E;
            return;
        }
        let e = t();
        return s.createEmbeddedView(e.templateRef, e.context, e.index);
    }
